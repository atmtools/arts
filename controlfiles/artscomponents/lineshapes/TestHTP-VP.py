...
ws.ReadXML(ws.abs_lines, "testdata/htp-vp-line.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat.xml")
# WriteXML("ascii", dpropmat_clearsky_dx, "testdata/test-htp-vp/dpropmat.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/dpropmat.xml")
...
ws.propmat_clearskyAddOnTheFly()
ws.NumericSet(ws.rtp_temperature, 250.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-dT.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-dT.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorNLinSpace(ws.f_grid, 101, 90000000000.0, 110000000000.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-df.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-ds0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-ds0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-df0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-df0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-G0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-G0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-G0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-G0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-D0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-D0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-vp/propmat-D0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-vp/propmat-D0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
