...
ws.ReadXML(ws.abs_lines, "testdata/htp-line.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat.xml")
# WriteXML("ascii", dpropmat_clearsky_dx, "testdata/test-htp/dpropmat.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
ws.ReadXML(ws.testdata, "testdata/test-htp/dpropmat.xml")
...
ws.propmat_clearskyAddOnTheFly()
ws.NumericSet(ws.rtp_temperature, 250.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-dT.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-dT.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorNLinSpace(ws.f_grid, 101, 90000000000.0, 110000000000.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-df.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-df.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorSet(ws.rtp_vmr, array([0.21]))
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-dvmr.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-dvmr.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-ds0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-ds0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-df0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-df0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-G0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-G0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-G0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-G0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-D0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-D0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-D0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-D0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-G2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-G2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-G2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-G2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-D2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-D2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-D2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-D2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-FVC-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-FVC-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-FVC-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-FVC-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-ETA-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-ETA-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp/propmat-ETA-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp/propmat-ETA-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
