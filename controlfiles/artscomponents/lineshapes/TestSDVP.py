...
ws.ReadXML(ws.abs_lines, "testdata/htp-sdvp-line.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat.xml")
# WriteXML("ascii", dpropmat_clearsky_dx, "testdata/test-htp-sdvp/dpropmat.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/dpropmat.xml")
ws.CompareRelative(ws.testdata, ws.dpropmat_clearsky_dx, 0.002)
...
ws.propmat_clearskyAddOnTheFly()
ws.NumericSet(ws.rtp_temperature, 250.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-dT.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-dT.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorNLinSpace(ws.f_grid, 101, 90000000000.0, 110000000000.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-df.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-df.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorSet(ws.rtp_vmr, np.array([0.21]))
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-dvmr.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-dvmr.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-ds0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-ds0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-df0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-df0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-G0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-G0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-G0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-G0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-D0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-D0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-D0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-D0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-G2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-G2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-G2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-G2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-D2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-D2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-htp-sdvp/propmat-D2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-htp-sdvp/propmat-D2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
