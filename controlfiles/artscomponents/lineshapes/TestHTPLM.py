...
ws.ReadXML(ws.abs_lines, "testdata/lm-htp-line.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat.xml")
# WriteXML("ascii", dpropmat_clearsky_dx, "testdata/test-lm-htp/dpropmat.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/dpropmat.xml")
ws.CompareRelative(ws.testdata, ws.dpropmat_clearsky_dx, 0.2)
...
ws.propmat_clearskyAddOnTheFly()
ws.NumericSet(ws.rtp_temperature, 250.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-dT.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-dT.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorNLinSpace(ws.f_grid, 101, 90000000000.0, 110000000000.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-df.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-df.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorSet(ws.rtp_vmr, np.array([0.21]))
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-dvmr.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-dvmr.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-ds0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-ds0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-df0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-df0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-D0-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-D0-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-D0-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-D0-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-D2-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-D2-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-D2-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-D2-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-FVC-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-FVC-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-FVC-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-FVC-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-ETA-X0 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="ETA", coefficient="X0", species="AIR", change=1e-06, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-ETA-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-ETA-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-ETA-X1 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="ETA", coefficient="X1", species="AIR", change=1e-08, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-ETA-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-ETA-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-Y-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-Y-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-Y-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-Y-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-Y-X2 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="Y", coefficient="X2", species="AIR", change=0.0008, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-Y-X2.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-Y-X2.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-G-X2 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="G", coefficient="X2", species="AIR", change=0.0008, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-G-X2.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-G-X2.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-DV-X0 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="DV", coefficient="X0", species="AIR", change=0.01, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-DV-X0.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-DV-X0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-DV-X1 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="DV", coefficient="X1", species="AIR", change=0.0001, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-DV-X1.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-DV-X1.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
# Perform calculations for perturbed AIR-DV-X2 derivative
ws.abs_linesChangeLineShapeModelParameterForMatchingLines(
    QI=ws.QI, parameter="DV", coefficient="X2", species="AIR", change=0.0008, relative=0
)
ws.abs_lines_per_speciesCreateFromLines()
ws.abs_xsec_agenda_checkedCalc()
ws.propmat_clearskyInit()
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-lm-htp/propmat-DV-X2.xml")
ws.ReadXML(ws.testdata, "testdata/test-lm-htp/propmat-DV-X2.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
