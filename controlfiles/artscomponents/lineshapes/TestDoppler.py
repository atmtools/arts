...
ws.ReadXML(ws.abs_lines, "testdata/dp-line.xml")
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat.xml")
# WriteXML("ascii", dpropmat_clearsky_dx, "testdata/test-dp/dpropmat.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
ws.ReadXML(ws.testdata, "testdata/test-dp/dpropmat.xml")
...
ws.propmat_clearskyAddOnTheFly()
ws.NumericSet(ws.rtp_temperature, 250.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat-dT.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat-dT.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorNLinSpace(ws.f_grid, 101, 99990000000.0, 100010000000.0)
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat-df.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat-df.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.VectorSet(ws.rtp_vmr, np.array([0.21]))
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat-dvmr.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat-dvmr.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat-ds0.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat-ds0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
...
ws.propmat_clearskyAddOnTheFly()
ws.Copy(ws.abs_lines, ws.aolr)
# WriteXML("ascii", propmat_clearsky, "testdata/test-dp/propmat-df0.xml")
ws.ReadXML(ws.testdata, "testdata/test-dp/propmat-df0.xml")
ws.CompareRelative(ws.testdata, ws.propmat_clearsky, 1e-06)
