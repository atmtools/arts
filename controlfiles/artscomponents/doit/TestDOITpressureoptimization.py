...
ws.execute_controlfile("artscomponents/doit/doit_setup_pressureoptimization.arts")
...
ws.ReadXML(ws.yREFERENCE, "artscomponents/doit/yREFERENCE_DOITpressureoptimization.xml")
