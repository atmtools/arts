...
ws.VectorSet(ws.rtp_mag, array([2.5e-05, 6.0e-05, 1.0e-05]))
ws.VectorSet(ws.rtp_los, array([60.0, 50.0]))
# Test variables
...
ws.jacobianInit()
ws.jacobianAddTemperature(g1=array([150.0]), g2=array([0.0]), g3=array([0.0]))
...
ws.jacobianAddWind(g1=array([150.0]), g2=array([0.0]), g3=array([0.0]), dfrequency=0.1)
ws.jacobianAddMagField(
    g1=array([150.0]), g2=array([0.0]), g3=array([0.0]), component="u"
)
ws.jacobianAddMagField(
    g1=array([150.0]), g2=array([0.0]), g3=array([0.0]), component="v"
)
ws.jacobianAddMagField(
    g1=array([150.0]), g2=array([0.0]), g3=array([0.0]), component="w"
)
ws.jacobianAddMagField(
    g1=array([150.0]), g2=array([0.0]), g3=array([0.0]), component="strength"
)
ws.jacobianClose()
...
ws.CompareRelative(ws.test, ws.propmat_clearsky, 1e-06)
ws.NumericSet(ws.rtp_temperature, 215.0)
ws.VectorSet(ws.rtp_vmr, array([0.21001]))
ws.propmat_clearskyInit()
ws.propmat_clearskyAddZeeman()
