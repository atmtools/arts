...
ws.Print(ws.sensor_pos, 1)
ws.Matrix1RowFromVector(ws.sensor_los, ws.rte_los)
ws.Print(ws.sensor_los, 1)
...
ws.Compare(ws.y_0, ws.y_ref, ws.mc_error_0, "Total radiance should be close to 198.7 K")
# Polarization test
...
ws.VectorSetConstant(ws.y_ref, 1, 7.9)
ws.Compare(
    ws.y_1, ws.y_ref, ws.mc_error_1, "Polarization difference should be close to 7.9 K"
)
