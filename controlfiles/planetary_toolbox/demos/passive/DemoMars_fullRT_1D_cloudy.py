...
###
ws.execute_controlfile("planetary_toolbox/demos/common/DemoMarsAtmo1D.arts")
ws.WriteXML(ws.output_file_format, ws.abs_species, "", 0)
# The particulate matter (clouds, aerosols, dust, haze) part
###
ws.execute_controlfile("planetary_toolbox/demos/common/DemoMarsClouds1D.arts")
# ---
...
#####
ws.execute_controlfile("planetary_toolbox/demos/common/DemoMarsSurface1D.arts")
# ---
