...
O.gps_movement = 'none';
O.frequency    = 2.3e9;     % These rae the tow frequencies of Mars-Express
...
A.Necase       = 4;               % Free electron case. Note that 4 needs
%                                 % day=1, while 0-3 to needs day=0
