...
ws.ReadARTSCAT(ws.abs_lines, "testdata/abs_lines_IR.xml.gz")
...
ws.StringJoin(ws.f_grid_file, ws.satellite, "_HIRS.f_grid_fast.xml")
# Weights associated with each frequency
ws.StringCreate("weights_file")
ws.StringJoin(ws.weights_file, ws.satellite, "_HIRS.W_fast.xml")
# Spectrometer
