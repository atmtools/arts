...
# ---
ws.ReadXML(ws.sensor_los, "instruments/avhrr/avhrr.sensor_los.xml")
...
ws.StringSet(ws.f_backend_file, "instruments/avhrr/")
ws.Append(ws.f_backend_file, ws.satellite)
ws.StringCreate("dummy")
ws.StringSet(ws.dummy, "_AVHRR.f_backend.xml")
