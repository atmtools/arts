...
# Test batch calculations for MVIRI.
...
# ---
ws.StringSet(ws.satellite, "MET2")
...
ws.ArrayOfIndexSet(ws.channels, [0, 1])
# ArrayOfIndexSet(channels, [0])
...
ws.NumericSet(ws.f_grid_spacing, 600000000.0)
# default 5e8
# StringSet(f_grid_spacing_str,"6e8")
ws.StringSet(ws.f_grid_spacing_str, "6e8_fast")
...
ws.execute_controlfile("mviri_fast.arts")
# INCLUDE "mviri_reference.arts"
# Set up absorption
# =================
...
ws.StringSet(ws.out_file_name_sensor_response, "TestMVIRI.sensor_response_")
ws.StringSet(ws.out_file_name_ybatch, "TestMVIRI.ybatch_")
ws.StringSet(ws.out_file_name_f_grid, "TestMVIRI.f_grid_")
...
ws.ReadXML(ws.ybatch_ref, "TestMVIRI.ybatch_MET2_6e8_fastREFERENCE.xml")
ws.Compare(
