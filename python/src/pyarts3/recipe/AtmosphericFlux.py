...
class AtmosphericFlux:
    ...
    def __call__(
        ...
        Returns:
            tuple[pyarts3.recipe.AtmosphericFlux.Flux, pyarts3.recipe.AtmosphericFlux.Flux, numpy.ndarray]: The solar and thermal fluxes and the center altitudes of the layers.
        """
