"""Editor for SubsurfacePoint struct type."""
...
def edit(value, parent=None):
    """
    Edit a SubsurfacePoint object with inline keys table.

    Core fields: temperature [K], density [kg/m^3]
    Keys: SubsurfaceKey and SubsurfacePropertyTag -> Numeric values
    """
    ...
    dialog.setWindowTitle("Edit SubsurfacePoint")
    ...
    core_fields = ["temperature", "density"]
    ...
    # Keys section
    keys_group = QGroupBox("Subsurface Keys")
