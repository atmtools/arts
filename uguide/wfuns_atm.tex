...
%  \levelc{...}
%
\levela{Basic atmospheric weighting functions}
 \label{sec:wfuns}
...
% The effect of a ground intersection is included in $I_n$ when the iteration
% starts. For the point where the ground intersection takes place, the 
% intensity and the transmission are changed as (compare to Equations
% \ref{eq:rte:ground} and \ref{eq:rte:tground})
% \begin{eqnarray}
%   I_q &\gets& \frac{I_q-eB(\f,T_{ground}}{1-e} \\
%   \Theta_1^{q} &\gets& \Theta_1^{q}(1-e)
% \end{eqnarray}
