...
def ARTS_clearsky(f_grid, sensor_pos, sensor_los, sun_longitude_pos,
                  surface_reflectivity, npres=81, nlat=3, nlon=5, stokes_dim=1):
    '''
    ...
    ws.surface_reflectivity = surface_reflectivity
...
if __name__ == "__main__":
    ...
    # xml.save(y, 'yREFERENCE_Test_iySurfaceFlatReflectivity.xml',precision='.14e')

    # Load reference data
    yREFERENCE = xml.load('yREFERENCE_Test_iySurfaceFlatReflectivity.xml')
