...
if __name__ == "__main__":
    ...
    # xml.save(y, 'yREFERENCE_TestClearsky_StarGasScatteringIsotropic.xml',precision='.14e')

    # Load reference data
    yREFERENCE = xml.load('yREFERENCE_TestClearsky_StarGasScatteringIsotropic.xml')
