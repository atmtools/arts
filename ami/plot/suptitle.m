...
%       given by YPOS (in relative units of the figure). Default is 0.97
%
%      SUPTITLE('text',ypos,fsize) sets the fontsize to FSIZE
% Drea Thomas 6/15/95 drea@mathworks.com
%
% Changed by Patrick Eriksson 990922
...
plotregion = .95;         % Now not used PE 990922

% Y position of title in normalized coordinates
if ~exist('titleypos')    % PE 990922
  titleypos  = .96;
end

% Fontsize for supertitle
if exist('fsize')         % PE 990922
  fs = fsize;
else
