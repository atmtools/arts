...
However, if we are just interested in :attr:`~pyarts3.workspace.Workspace.spectral_rad`
...
- There are methods that set an agenda to a named option, such as :func:`~pyarts3.workspace.Workspace.spectral_rad_space_agendaSet`.  These are default generated by using the enum-variables.
