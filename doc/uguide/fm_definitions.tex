...
\wsaindex{surface\_agenda}. This agenda sets the workspace
variables \wsvindex{surface\_emission}, \wsvindex{surface\_los} and
\wsvindex{surface\_refl\_coeffs}. These three variables define
...
\artsstyle{surface\_refl\_coeffs}. The slope of the surface is
