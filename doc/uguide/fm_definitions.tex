...
\quad allocate memory for the vector \aMpiVct{b}
...
\quad\quad copy \MpiVct\ to correct part of \aMpiVct{b}

\quad put the product \aSnsMtr{b}\aMpiVct{b} in correct part of \MsrVct \\
