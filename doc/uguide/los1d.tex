...
\levelb{Geometrical calculations}
 ...
 \levelb{With refraction}
  ...
  Refraction is so far not implemented in ARTS. A possible scheme for 
  the refraction calculations is found in \citet{eriksson:97a}.
  
  (I have now a new, very nice, idea that should make, at least, the
  1D calculations very simple. I should implement this ASAP Patrick 000908)
