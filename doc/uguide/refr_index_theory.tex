...
\subsection{Microwave general method (\shortcode{refr\_indexMWgeneral)}}
...
\subsection{Microwave refractive index for Earth (\shortcode{refr\_indexThayer})}
...
\subsection{Infrared refractive index for Earth (\shortcode{refr\_indexIR})}
 \label{sec:rindex:IR}
...
\wsmindex{refr\_indexFreeElectrons}. The method demands that the radiative
