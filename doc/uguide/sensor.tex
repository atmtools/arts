...
\levelb{Forward matrix set-up}
Describe the two options, with and with out sensor.

\levelc{No sensor}
\artsstyle{sensor\_off}

\levelc{Initialisation}
\artsstyle{sensor\_responseInit}

\levelc{Antenna 1D}
\artsstyle{sensor\_responseAntenna1D} and connected WSM.

\levelc{Mixer and sideband filter}
\artsstyle{sensor\_responseMixer}

\levelc{Backend}
\artsstyle{sensor\_responseBackend}

\levelc{Auxiliary functions}
...
\levelb{FIXME old stuff}

\textbf{\artsstyle{antenna\_diagram}}
