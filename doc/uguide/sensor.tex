...
represented by the WSV \artsstyle{sensor_response}. To denote 
...
\artsstyle{antenna_diagram}. This variable is of the type 
...
To explain the definition of \artsstyle{antenna_diagram}, we will go through it backwards, starting with the \typeindex{Matrix}. The \textit{single or complete} concept applies to this matrix in the way that it describes the angle dependence of the antenna characteristics.
In \textit{single} setup, the matrix must consist of two columns, the first column contains a relative grid of angles \ldots
