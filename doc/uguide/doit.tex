...
either completely randomly oriented ("macroscopically\_isotropic") or azimuthally randomly
oriented ("horizontally\_aligned") (cf. \user, Section \ref{U-sec:clouds:particle_types}).
The top panels of
