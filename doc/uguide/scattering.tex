...
\wsmindex{doit\_i\_field\_monoIterate}, which includes
\begin{itemize}
...
\subsection{Agendas used in \wsmindex{doit\_i\_field\_monoIterate}}
\label{sec:scattering:doit_iterate_agendas}
There are several methods which can be used in
\wsmindex{doit\_i\_field\_monoIterate}, for instance for the calculation of
...
is executed before \wsmindex{doit\_i\_field\_monoIterate} (see
