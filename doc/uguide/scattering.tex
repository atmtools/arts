...
\begin{figure}[t!]
  \fbox{
  \includegraphics[width=.95\hsize]{scattering/iteration_scheme}}
...
\begin{figure}[t!]
  \centering\includegraphics[width=.8\hsize]{scattering/average}
...
\begin{figure}[htbp]
\centering
  \includegraphics[width=.8\hsize]{scattering/seq_update_bw}
...
\begin{figure}[htbp]
\centering
  \includegraphics[width=0.8\hsize]{scattering/i_field}
...
\begin{figure}[t]
\centering
  \includegraphics[width=.9\hsize]{scattering/grid_acc}
...
\begin{figure}[htbp]
\centering
  \includegraphics[width=.9\hsize]{scattering/interp}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.9\hsize]{scattering/interp_err}
...
\wsmindex{DoitAngularGridsSet} by the keywords \artsstyle{Nza} and
...
keyword \artsstyle{epsilon} which specifies the convergence limit. A limit
