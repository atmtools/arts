...
either completely randomly oriented ("macroscopically\_isotropic") or
azimuthally randomly oriented ("horizontally\_aligned")
(cf. Section \ref{sec:clouds:particle_types}).  The top panels of
