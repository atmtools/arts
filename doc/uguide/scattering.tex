...
\subsection{Control file example}
...
DoitInit{}
\end{verbatim}
The main agenda for a DOIT calculation in
...
To calculate the scattering integral the phase matrix \wsmindex{pha\_mat} is required. How
...
the hoptimized method \wsmindex{DoitScatteringDataPrepare} is used we
...
\FIXME{Comments for following parts}
