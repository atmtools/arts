...
function defined in Section \zref{sec:vector_views}:
...
argument\footnote{Using just \artsstyle{joker} is equivalent to using
  ...
  \zref{sec:matpack:matrices}.} for any of the dimensions. The
...
Chapter \zref{sec:interpolation}.


\section{Arrays}
%-------------------------------------------------------------------------
\zlabel{sec:matpack:arrays}
...
\subsubsection{Transpose:} The function \artsstyle{transpose} works a bit
