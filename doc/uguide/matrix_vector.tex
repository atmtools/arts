...
There is also a file \fileindex{matpackII.h}, which contains the draft of a sparse
matrix class, but this is at the moment not used. The template class
\artsstyle{Array} (also described below) is implemented in the files:
\begin{itemize}
...
return the type \artsstyle{VectorView}. This means, they can be used
...
that you can use either an \artsstyle{Index} or a \artsstyle{Range} argument for
