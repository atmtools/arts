...
origination through hydrostatic equilibrium shall be included in the WFs or not
is selected by an argument denoted as \verb|hse|. A full account of hydrostatic
equilibrium is possibile for perturbation calculations, while the analytical
approach only treats the local effect (see further below).
...
of the temperature perturbation. If set to ``off'', there is no change
of \builtindoc{z\_field}. That is, you must make an actibe choice regarding
hydrostatic equilibrium, while others effects are included automatically.
