...
(scalar) variable. See further Section~\ref{T-sec:formalism:wfuns} of \theory.
...
\end{equation}
where $\MsrVct'$ is the ``baseline free'' spectrum, and $x_i$ and
...
For a given set of retrieved $x_i$, the simplest way to determine the estimated
baseline is to perform a muliplication between the relevant parts of the
Jacobian and the state vector:
\begin{equation}
  \aWfnMtr{p}\aSttVct{p},
