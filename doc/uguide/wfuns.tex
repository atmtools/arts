...
As mentioned, this section deals only with WFs for clear-sky calculations. In
principle, perturbation calculations can be applied also with scattering, but
the high calculation burden (of both perturbations and scattering) causes that
the option can only be used for a few test calculations.
