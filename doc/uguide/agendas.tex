...
\item \fileindex{auto\_md.h}, \fileindex{auto\_md.cc}:\\
  Generated from \artsstyle{auto\_workspace.h},
  \artsstyle{agendas.cc}, \artsstyle{groups.cc}, and \artsstyle{methods.cc}.
\end{itemize}
...
above belongs in this category. It sets the WSV \artsstyle{p\_grid}, using
the WSV \artsstyle{abs\_lookup} as input.

To call this method in the controlfile, you just have to write
\artsstyle{p\_gridFromGasAbsLookup}.
...
The \artsstyle{iyEmissionStandardClearsky} method for example calculates
