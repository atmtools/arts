...
\section{The sensor transfer matrix} 
 ...
 \begin{equation}
  ...
  \zlabel{eq:formalism:H}
 \end{equation}
 where \SnsMtr\ is here denoted as the \textindex{sensor transfer
...
% detail in Sections \zref{sec:wfuns} and \zref{sec:wfuns_sens}.
