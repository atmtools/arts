...
\newcommand{\aExtMat}[1]{\ensuremath{{\bf K}^{#1}}}

% Total absorption vector
\newcommand{\AbsVec}    {\ensuremath{{\bf a}}}
\newcommand{\aAbsVec}[1]{\ensuremath{{\bf a}^{#1}}}     
...
\newcommand{\aStoVec}[1]{\ensuremath{{\bf I}^{#1}}}

% Propagation direction
\newcommand{\PDir}      {\ensuremath{{\bf n}}}
...
% Single absorption vector
\newcommand{\SAbVec}    {\ensuremath{{\bf b}}}
\newcommand{\aSAbVec}[1]{\ensuremath{{\bf b}^{#1}}}
...
\newcommand{\secref}[1]    {Section \zref{#1}} 
\newcommand{\eqref}[1]     {(\zref{#1})}
\newcommand{\eqnref}[1]    {Equation (\zref{#1})}
\newcommand{\figref}[1]    {Figure \zref{#1}}
\newcommand{\tabref}[1]    {Table \zref{#1}}
\newcommand{\charef}[1]    {Chapter \zref{#1}}
