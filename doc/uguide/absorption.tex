...
file \fileindex{hitran\_cia2012\_adapted.xml.gz} that is included with
...
Radiative Transfer Simulator ARTS}. %FIXME: Proper source when accepted.

In order to calculate Zeeman splitting, additional line parameters that are not readily
