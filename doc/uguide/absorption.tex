...
\wsmindex{propmat\_clearskyAddZeemanFromPreCalc} (see Sec.~\ref{sec:absorption:zeeman}), \newline
...
The Zeeman effect is calculated in the method \wsmindex{propmat\_clearskyAddZeemanFromPreCalc}.
...
presented in \citet{larsson14:_treatment_jqsrt}.
...
relative Land\'{e} factor, the Lambda-state ($\Sigma:=0$, $\Pi:=1$, ...), the molecular total spin $S$,
and the Hund case (case a is 0 and case b is 1). These
...
<arts format="ascii" version="1">
  <SpeciesAuxData version="1" nelem="1" nparam="4">
