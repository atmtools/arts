...
model. An example of the third is \verb|"CFC11-HXSEC"|, which identifies the
...
The empirical absorption cross sections are calculated in the method \wsmindex{propmat\_clearskyAddHitranXsec}.
If this method is included in the \builtindoc{propmat\_clearsky\_agenda}, then species with the
tag "\verb|-HXSEC|" will be calculated as empirical cross section model species. 
...
Section \ref{sec:abs_theory:Absorption_cross_section_model}. 
