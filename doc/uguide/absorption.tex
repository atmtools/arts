...
\begin{equation}
S(T)=S(T_0)\frac{T_0}{T}\frac{Q(T_0)}{Q(T)}~~exp~\left[\frac{E_f+E_i}{2kT_0}\left(1-\frac{T_0}{T}\right)\right]
\label{}
\end{equation}
...
energy states and their statistical distribution of during the
radiation process. 
...
research, is the $local thermodynamic equilibrium$ or $LTE$. According to it,
