...
The method \wsmindex{propmat\_clearsky\_agendaAuto} constructs
...
\wsmindex{propmat\_clearsky\_agendaAuto} can also constructs a
...
\wsmindex{abs\_linesMirroring} (see \theory,
Chapter \ref{T-sec:abs_theory}). \\
%---------------------------------------------------------------------
...
As an example, \wsmindex{abs\_linesLinemixingLimit} sets the line mixing limit for all lines in \wsvindex{abs\_lines}.
