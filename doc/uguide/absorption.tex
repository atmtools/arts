...
There are two \verb|line_mixing_tag| supported at this point:
\verb|"LL"| and \verb|"L2"|.  These refer to LBLRTM, and second order line mixing.
...
Example of correct input data for using the LBLRTM approach ("LL"):
\begin{code}
<?xml version="1.0"?>
<arts format="ascii" version="1">
<Array type="LineMixingRecord" nelem="38">
...
the following four values are the first order
...
ARTS will use linear interpolation to get line mixing coefficients between and outside grid points.
