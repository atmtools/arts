...
\item{{\verb Voigt_Kuntz4 }~:} Kuntz approximation to the Voigt line
  shape with relative acc uracy better than $ 2 \times 10^{-4} $;
...
An important difference comparing the arts implementation to the
original MPM93 source code is the incorporation of the isotopic 
ratio in the line strength of the $\hzo$-lines at 547.676 
($_{1}^{1}$H$_{~\,8}^{18}$O, abundance=0.00199983) and 
552.021\,GHz ($_{1}^{1}$H$_{~\,8}^{17}$O, abundance=0.00037200).
Since these two lines are newly added in MPM93, the older versions of
MPM are not affected from this change. 
%
%
%\begin{landscape}
%\setlength{\LTcapwidth}{200mm} % with of the caption in longtable
...
% --------------------- only end of table ------------------------------
 ...
 \caption{List of used H$_2$O spectral lines and their spectroscopic 
   ...
   line catalog. The line intensities at 547.676 and 552.021\,GHz are 
   multiplied with the respective isotopic ratio and are therefore
   different from the original values (see text).}
...
19$^+$ & 547.676440 & 0.00194 & 0.114 & 2.600 & 4.50 & 0.70 & 1.00 \\
20$^+$ & 552.020960 & 0.00055 & 0.114 & 2.600 & 4.50 & 0.70 & 1.00 \\
