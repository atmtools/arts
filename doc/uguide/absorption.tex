...
is \wsmindex{propmat\_clearskyAddPredefined}. Users normally do not have to
...
RT methods via \wsvindex{propmat\_clearsky\_agenda}, which is easiest
set using \wsmindex{propmat\_clearsky\_agendaAuto}.
