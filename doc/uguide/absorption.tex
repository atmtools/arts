...
taken from HITRAN96, even for such ones given by JPL00 and HITRAN96.
For species not present in HITRAN96 the values were extracted from
JPL00. The isotopic ratios are normalized for some species in JPL00 to
1, for these cases, the HITRAN96 values of the major isotope is used
