...
\wsmindex{abs\_xsec\_per\_speciesAddLines} and \wsmindex{abs\_lines\_per\_speciesSetMirroring}),\newline
\wsmindex{abs\_xsec\_per\_speciesAddLines} (another core method for the
