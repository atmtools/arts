...
In the following all the valid possibilities for the
tag {\tt "O2-SelfContStandardType"} are listed (the values for the 
model user are just example values): 
\begin{verbatim}
cont_descriptionAppend{
...
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cont_description_page1.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cont_description_page2.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cont_description_page3.ps}
\end{flushleft}
...
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{fullmodel_description_page1.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{fullmodel_description_page2.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{fullmodel_description_page3.ps}
\end{flushleft}
...
%
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cloud_description_page1.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cloud_description_page2.ps}
\end{flushleft}
\begin{flushleft}
 \includegraphics[scale=0.65, angle=0]{cloud_description_page3.ps}
\end{flushleft}
