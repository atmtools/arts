...
conditions that are given.  \wsaindex{abs\_mat\_per\_speciesAddLBL} calculates
absorption for all non-Zeeman species which is why \wsaindex{abs\_mat\_per\_speciesAddZeemanLBL}
follows.
...
Each of \wsmindex{abs\_mat\_per\_speciesAddLBL}, 
...
the implementation: For \wsmindex{abs\_mat\_per\_speciesAddLBL} and \wsmindex{abs\_mat\_per\_speciesAddZeemanLBL} the shift
...
Methods: \wsmindex{abs\_mat\_per\_speciesAddLBL} and \wsmindex{abs\_mat\_per\_speciesAddZeemanLBL}. Alternative:
...
\builtindoc{abs\_mat\_per\_speciesAddFromLookup} can calculate absorption
