...
conditions that are given.  \wsmindex{abs\_mat\_per\_speciesAddOnTheFly} calculates
absorption for all non-Zeeman species which is why \wsmindex{abs\_mat\_per\_speciesAddZeeman}
follows.
...
\wsmindex{abs\_mat\_per\_speciesAddZeeman} and
...
the implementation: For \wsmindex{abs\_mat\_per\_speciesAddOnTheFly} and \wsmindex{abs\_mat\_per\_speciesAddZeeman} the shift
...
Methods: \wsmindex{abs\_mat\_per\_speciesAddOnTheFly} and \wsmindex{abs\_mat\_per\_speciesAddZeeman}. Alternative:
