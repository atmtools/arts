...
\begin{figure}[t]
 \begin{center}
   \includegraphics*[width=0.6\hsize]{./Figs/rte_theory/coordinate_system}
...
\begin{figure}[t]
 \begin{center}
   \includegraphics*[width=0.6\hsize]{../Figs/rte_theory/part_ensemble}
...
\begin{eqnarray}\label{eq:rtetheory:VRTE}
