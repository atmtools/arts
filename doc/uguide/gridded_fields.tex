...
The data of a \artsstyle{GriddedFieldX} can be accessed through its \artsstyle{data} member.
For a \artsstyle{GriddedField1} \artsstyle{data} is a \artsstyle{Vector}, for a \artsstyle{GriddedField2} a \artsstyle{Matrix}, for a \artsstyle{GriddedField3} a \artsstyle{Tensor3}, and so on.
