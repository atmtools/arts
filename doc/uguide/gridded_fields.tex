...
The \artsstyle{GriddedFieldX} classes use indirect inheritance to combine a
...
The data of a \artsstyle{GriddedFieldX} can be accessed through its \artsstyle{data()} function.
For a \artsstyle{GriddedField1} the \artsstyle{data()} function returns a \artsstyle{Vector} reference, for a \artsstyle{GriddedField2} a \artsstyle{Matrix} reference, for a \artsstyle{GriddedField3} a \artsstyle{Tensor3} reference, and so on.
