...
%=====================================================================
\zlabel{sec:polarization:directions}
...
the $x$-axis:
\begin{equation}
  \zlabel{eq:polarization:propdir}
...
Figure~\zref{fig:polarization:directions}. 
\begin{figure}[!ht]
 \begin{center}
  ...
  \begin{minipage}[c]{0.9\textwidth}
   ...
   \zlabel{fig:polarization:directions}
  \end{minipage}
 \end{center}
\end{figure}   
%
...
\begin{eqnarray}
  ...
  \sqrt{\frac{\epsilon}{\mu}}\left(
   ...
   \right)
  \zlabel{eq:polarization:intensity}
\end{eqnarray}
...
\begin{equation}
  \zlabel{eq:polarization:intensity2}
 F = 
...
(Eq.~\zref{eq:polarization:e_field}).
\begin{eqnarray}
  \zlabel{eq:polarization:intensity_from_complex}
...
\begin{eqnarray}
  \zlabel{eq:polarization:stokesparam_I}
  I &=& \half\InvImp ( E_v E_v^\ast + E_h E_h^\ast ) \\
  \zlabel{eq:polarization:stokesparam_Q}
  Q &=&  \half\InvImp (  E_v E_v^\ast - E_h E_h^\ast ) \\
  \zlabel{eq:polarization:stokesparam_U}
  U &=& - \half\InvImp (  E_v E_h^\ast + E_h E_v^\ast ) \\
  \zlabel{eq:polarization:stokesparam_V}
...
Eq.~(\zref{eq:polarization:compl_ampl}),
we can rewrite the Stokes parameters as 
\begin{eqnarray}
  \zlabel{eq:polarization:stokesparam_alt_I}
 I &=&  \half\InvImp (a_v^2 + a_h^2)\\
  \zlabel{eq:polarization:stokesparam_alt_Q}
 Q &=& \half\InvImp (a_v^2 - a_h^2)\\
  \zlabel{eq:polarization:stokesparam_alt_U}
 U &=&  - \InvImp a_v a_h \cos(\delta_v-\delta_h)\\
  \zlabel{eq:polarization:stokesparam_alt_V}
...
\begin{eqnarray}
  \zlabel{eq:polarization:tip_of_fieldvec1}
  \tilde{E}_v (t) &=&   a_v \cos\Delta_v \cos(\omega t)
                      + a_v \sin\Delta_v \sin(\omega t)\\
  \zlabel{eq:polarization:tip_of_fieldvec2}
...
\begin{eqnarray}
  \zlabel{eq:polarization:ellipse_parallel}
...
Figure~\zref{fig:polarization:ellipse_aligned}). The sense of rotation
...
angle.\zlabel{def:ellipticity-angle}
\begin{figure}[!ht]
 \begin{center}
  \begin{minipage}[c]{0.9\textwidth}
   \begin{center}
  ...
  \begin{minipage}[c]{0.9\textwidth}
   ...
   \zlabel{fig:polarization:ellipse_aligned}
  \end{minipage}
 \end{center}
\end{figure}   
...
Figure~\zref{fig:polarization:ellipse_arbitrary})\zlabel{def:orientation-angle}:
\begin{eqnarray}
  \zlabel{eq:polarization:ellipse_rotated1}
 \tilde{E}_v (t) &=&  a_0(  \sin\beta \cos(\omega t) \cos\zeta
                           +\cos\beta \sin(\omega t) \sin\zeta )\\
  \zlabel{eq:polarization:ellipse_rotated2}
...
\begin{figure}[!ht]
 \begin{center}
  ...
  \begin{minipage}[c]{0.9\textwidth}
   ...
   \zlabel{fig:polarization:ellipse_arbitrary}
  \end{minipage}
 \end{center}
\end{figure}   
...
Eqs.~(\zref{eq:polarization:ellipse_rotated1})%
-(\zref{eq:polarization:ellipse_rotated2}) with the corresponding terms
in Eqs.~(\zref{eq:polarization:tip_of_fieldvec1})%
-(\zref{eq:polarization:tip_of_fieldvec2}), we get:
\begin{eqnarray}
  \zlabel{eq:polarization:corresp1a}
 a_v \cos\Delta_v &=& a_0 \sin\beta \cos\zeta\\
  \zlabel{eq:polarization:corresp1b}
 a_v \sin\Delta_v &=& a_0 \cos\beta \sin\zeta
\end{eqnarray}
and 
\begin{eqnarray}
  \zlabel{eq:polarization:corresp2a}
 a_h \cos\Delta_h &=& -a_0 \sin\beta \sin\zeta\\
  \zlabel{eq:polarization:corresp2b}
 a_h \sin\Delta_h &=&  a_0 \cos\beta \cos\zeta
\end{eqnarray}
Multiplying Eq.~(\zref{eq:polarization:corresp1a}) with
Eq.~(\zref{eq:polarization:corresp2a}), and
Eq.~(\zref{eq:polarization:corresp1b}) with
Eq.~(\zref{eq:polarization:corresp2b}) and adding up the results, we get
\begin{equation}
...
\begin{equation}
  \zlabel{eq:polarization:sinzetacosbeta}
  \frac{a_v a_h}{a_0^2} \cos(\delta_v-\delta_h)
  = \half\sin(2\zeta)\cos(2\beta)
\end{equation}
In a similar way, subtracting the product of
Eq.~(\zref{eq:polarization:corresp1b}) with
Eq.~(\zref{eq:polarization:corresp2a}) from the product of
Eq.~(\zref{eq:polarization:corresp1a}) with
Eq.~(\zref{eq:polarization:corresp2b}) and adding up the results, we get
\begin{equation}
  \zlabel{eq:polarization:sinbeta}
...
the squares of Eq.~(\zref{eq:polarization:corresp2a}) and
Eq.~(\zref{eq:polarization:corresp2b}) from the sum of the squares of
Eq.~(\zref{eq:polarization:corresp1a}) and
Eq.~(\zref{eq:polarization:corresp1b}):
\begin{equation}
  \zlabel{eq:polarization:cosbetazeta}
 a_v^2 - a_h^2 =  -a_0^2 \cos(2\zeta)\cos(2\beta)
\end{equation}
Finally, we use the above 3 equations
(\zref{eq:polarization:sinzetacosbeta}), 
(\zref{eq:polarization:sinbeta}) and 
(\zref{eq:polarization:cosbetazeta}) to rewrite the Stokes parameters
(Eqs.~\zref{eq:polarization:stokesparam_alt_I}%
-\zref{eq:polarization:stokesparam_alt_V}) 
as
\begin{eqnarray}
  \zlabel{eq:polarization:stokesparam_alt2_I}
 I &=&  \half\InvImp a_0^2\\
  \zlabel{eq:polarization:stokesparam_alt2_Q}
 Q &=&  - \half\InvImp a_0^2 \cos(2\zeta)\cos(2\beta)\\ 
  \zlabel{eq:polarization:stokesparam_alt2_U}
 U &=& -\half\InvImp a_0^2 \sin(2\zeta)\cos(2\beta)\\
  \zlabel{eq:polarization:stokesparam_alt2_V}
...
\begin{equation}
  \zlabel{eq:polarization:tan2zeta}
 \tan(2\zeta) = \frac{U}{Q}
\end{equation}
...
Eq.~\zref{eq:polarization:stokesparam_alt2_Q}, taking into account that
...
\begin{equation}
  \zlabel{eq:polarization:tan2beta}
...
(cf. section~\zref{sec:polarization:measuring}, i.e., next section).
...
cosines
(Eqs. \zref{eq:polarization:stokesparam_alt2_Q}-%
\zref{eq:polarization:stokesparam_alt2_V}). 
Note also that the 4 Stokes parameters are not independent, since the
following equality applies:
\begin{equation}
  \zlabel{eq:polarization:Isquare}
  I^2 = Q^2 + U^2 + V^2
\end{equation}
...
%=====================================================================
\zlabel{sec:polarization:measuring}
The three different ways given so far to write the Stokes parameters
(Eqs.~\zref{eq:polarization:stokesparam_I}ff.,
Eqs.~\zref{eq:polarization:stokesparam_alt_I}ff.,
Eqs.~\zref{eq:polarization:stokesparam_alt2_I}ff.)  are not very
...
(Eq.~\zref{eq:polarization:stokesparam_Q},
or~\zref{eq:polarization:stokesparam_alt_Q})
\begin{equation}
  \zlabel{eq:polarization:Q_Idiff}
  Q = I_v - I_h
\end{equation}
where
\begin{eqnarray}
  \zlabel{eq:polarization:Iv}
  I_v &=&  \half\InvImp E_v E_v^\ast\\
  \zlabel{eq:polarization:Ih}
...
We recall Eq.~(\zref{eq:polarization:e_field}), omitting the
oscillatory term:
\begin{equation}
  \zlabel{eq:polarization:E_linbase}
...
thus (cf.\ Figure~\zref{fig:polarization:e45})
\begin{eqnarray}
  \zlabel{eq:polarization:e_p45}
  \ePls &=& \sqrt{\half} \left( \eHor - \eVrt \right) \\
  \zlabel{eq:polarization:e_m45}
  \eMin &=& \sqrt{\half} \left( \eHor + \eVrt \right) 
\end{eqnarray}
and we get the field vector in this modified linear basis:
\begin{equation}
  \zlabel{eq:polarization:E_lin45base}
  \VctStl{E} = \underbrace{
...
\begin{eqnarray}
  \zlabel{eq:polarization:Im45}
  I_{-45\degree} &=& \half\InvImp E_{-45\degree} E_{-45\degree}^\ast\\
  \zlabel{eq:polarization:Ip45}
  I_{+45\degree} &=& \half\InvImp E_{+45\degree} E_{+45\degree}^\ast
\end{eqnarray}
...
\begin{eqnarray}
  ...
  \zlabel{eq:polarization:Idiff_lin45base}
\end{eqnarray}
Therefore (cf. Eq.~\zref{eq:polarization:stokesparam_U})
\begin{equation}
  \zlabel{eq:polarization:U_Idiff}
...
Basis vectors
\begin{eqnarray}
  \zlabel{eq:polarization:e_Lh}
  \eLh &=& \sqrt{\half} \left( \eVrt + i\eHor \right) \\
  \zlabel{eq:polarization:e_Rh}
...
\begin{equation}
  \zlabel{eq:polarization:E_circbase}
  \VctStl{E} = \underbrace{
...
\begin{eqnarray}
  \zlabel{eq:polarization:ILH}
  I_{LH} &=& \half\InvImp E_{LH} E_{LH}^\ast\\
  \zlabel{eq:polarization:IRH}
...
\begin{eqnarray}
  ...
  \zlabel{eq:polarization:Idiff_circbase}
\end{eqnarray}
Therefore (cf. Eq.~\zref{eq:polarization:stokesparam_V}):
\begin{equation}
  \zlabel{eq:polarization:V_Idiff}
  V =   I_{RH} -  I_{LH}
\end{equation}
%
...
\begin{equation}
  \zlabel{eq:polarization:E_retarded}
...
\begin{equation}
  \zlabel{eq:polarization:E_retarded_polarized}
...
\begin{eqnarray}
  I^{\prime\prime} 
   ...
   &=& \half ( I + V )
  \zlabel{eq:polarization:I_retarded_polarized}
\end{eqnarray}
...
\begin{eqnarray}
  \zlabel{eq:polarization:stokesparam_Idiff_I}
  I &=& I_v + I_h = I_{-45\degree} + I_{+45\degree} = I_{RH} + I_{LH}\\
  \zlabel{eq:polarization:stokesparam_Idiff_Q}
  Q &=&   I_v - I_h \\
  \zlabel{eq:polarization:stokesparam_Idiff_U}
  U &=&  I_{+45\degree} - I_{-45\degree} \\
  \zlabel{eq:polarization:stokesparam_Idiff_V}
  V &=&  I_{RH} - I_{LH}
\end{eqnarray}
...
%=====================================================================
\zlabel{sec:polarization:part_pol}
The equality   $I^2 = Q^2 + U^2 + V^2$
(Eq.~\zref{eq:polarization:Isquare}) 
%and in fact all of section~\zref{sec:polarization:monochrom} 
...
\begin{equation}
  \zlabel{eq:polarization:summed_stokes}
  I = \sum_i I_i \: \mbox{, }\; 
  Q = \sum_i Q_i \: \mbox{, }\; 
  U = \sum_i U_i \: \mbox{, }\; 
  V = \sum_i V_i
...
(cf.~Eq.~\zref{eq:polarization:Isquare}) still holds for each
contribution $i$, but for the resulting $I,Q,U,V$, we have in general the
inequality
\begin{equation}
 \zlabel{eq:polarization:stokes_inequality}
  I^2 \geq Q^2 + U^2 + V^2
\end{equation}
...
notation (Eqs.~\zref{eq:polarization:stokesparam_alt_I}ff.), also
...
We get
\begin{eqnarray}
\zlabel{eq:polarization:square-difference}  
I^2 - Q^2 - U^2 - V^2 &=& 
...
\end{eqnarray}
Putting this into Eq.~\zref{eq:polarization:square-difference} (and
dividing by 4), the sums over just $i$ cancel and we get:
\begin{eqnarray}
\zlabel{eq:polarization:square-difference2}  
(I^2 - Q^2 - U^2 - V^2)/4 &=&
  \sum_{{i,j}\atop{i\not=j}} \left(a_v^{(i)}a_h^{(j)}\right)^2\\ \nonumber
 &&- \sum_{{i,j}\atop{i\not=j}} a_v^{(i)} a_h^{(i)} a_v^{(j)} a_h^{(j)} 
    \cos(\delta^{(i)}-\delta^{(j)}) 
...
\begin{eqnarray}
\zlabel{eq:polarization:square-difference3}  
(I^2 - Q^2 - U^2 - V^2)/4 &=&
...
\begin{eqnarray}
  \zlabel{eq:polarization:stokesparam_I_general}
  I &=& \half\InvImp  \EnsAvr{E_v E_v^\ast + E_h E_h^\ast} \\
  \zlabel{eq:polarization:stokesparam_Q_general}
  Q &=&  \half\InvImp \EnsAvr{  E_v E_v^\ast - E_h E_h^\ast} \\
  \zlabel{eq:polarization:stokesparam_U_general}
  U &=& - \half\InvImp \EnsAvr{  E_v E_h^\ast - E_h E_v^\ast} \\
  \zlabel{eq:polarization:stokesparam_V_general}
...
(Eqs.~\zref{eq:polarization:stokesparam_I}
to~\zref{eq:polarization:stokesparam_V}).The same applies to the second
and third definitions of the Stokes parameters (Eqs.~\zref{eq:polarization:stokesparam_alt_I}
to~\zref{eq:polarization:stokesparam_alt_V} and  
Eqs.~\zref{eq:polarization:stokesparam_alt2_I}
to~\zref{eq:polarization:stokesparam_alt2_V}, respectively).
Note that the fourth definition (Eqs.~\zref{eq:polarization:stokesparam_Idiff_I}
to~\zref{eq:polarization:stokesparam_Idiff_V}) which uses sums and
...
\begin{equation}
  \zlabel{eq:polarization:pol_degree}
...
\begin{equation}
  \zlabel{eq:polarization:pol_component}
  I_p^2 = Q^2 + U^2 + V^2
\end{equation}
and the unpolarized component as
\begin{equation}
  \zlabel{eq:polarization:unpol_component}
  I_u = I - I_p
\end{equation}
...
Recalling Eqs.~(\zref{eq:polarization:stokesparam_Idiff_U})%
~and~(\zref{eq:polarization:stokesparam_Idiff_V}),
we can define the degree of linear polarization, $p_{lin}$, as
\begin{equation}
  \zlabel{eq:polarization:p_lin}
 p_{lin} = \frac{\sqrt{Q^2 + U^2}}{I} 
\end{equation}
and the the degree of circular polarization, $p_{circ}$, as
\begin{equation}
  \zlabel{eq:polarization:p_circ}
 p_{circ} = \frac{V}{I} 
\end{equation}
%(Stephens p.61)
...
\zlabel{sec:polarization:atmosphere}
...
\zlabel{sec:polarization:antenna}
...
Eq.~\zref{eq:polarization:tan2zeta} to \zref{eq:polarization:tan2beta}).
\end{enumerate}
...
\item the
  ...
  Eq.~\zref{eq:polarization:stokesparam_alt2_I}
  to~\zref{eq:polarization:stokesparam_alt2_V}, we have:
\begin{eqnarray}
  \zlabel{eq:polarization:antenna-q}
 q &=&  - \cos(2\zeta)\cos(2\beta)\\ 
  \zlabel{eq:polarization:antenna-u}
 u &=& - \sin(2\zeta)\cos(2\beta)\\
  \zlabel{eq:polarization:antenna-v}
 v &=& - \sin(2\beta)
\end{eqnarray}
\end{enumerate}
...
from Eq.~\zref{eq:polarization:stokesparam_I}
to~\zref{eq:polarization:stokesparam_V} ) this can be rewritten in
...
\begin{equation}
  \zlabel{eq:polarization:antenna:intensity-stokes}
...
%=====================================================================
\zlabel{sec:polarization:ampmatrix}
The electric field, $[E_v,E_h]^T$, originating from a single
scattering event of an incident electric field $[E_v^0,E_h^0]^T$ may
in the far field be written as (c.f.\ Eq.~\zref{eq:rtetheory:amplitude_matrix})
\begin{equation}
  \zlabel{eq:polarisation:ampmatrix1}
...
\begin{equation}
  \zlabel{eq:polarisation:ampmatrix2}
...
\begin{equation}
  \zlabel{eq:polarisation:Fmatrix}
