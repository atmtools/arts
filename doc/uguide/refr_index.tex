...
\wsmindex{refr\_indexThayer} and \wsmindex{refr\_indexIR}. All of them are
...
\wsmindex{refr\_indexMWgeneral} provides refractivity due to different gas
...
\wsmindex{refr\_indexThayer} calculates the microwave ``air'' refractivity
...
\wsmindex{refr\_indexIR} derives the infrared ``air'' refractivity in the
...
\wsmindex{refr\_indexFreeElectrons} derives this contribution of free electrons
