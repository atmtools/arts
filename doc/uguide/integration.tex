...
of observation.  For example from \secref{sec:scattering:VRTE_sol} it
...
%------------------------------------------------------------------------
\zlabel{sec:integration:trapezoidal}
...
If we use eq. \zref{eq:trapezoidal_rule} $N - 1$ times, to do the
...
\begin{eqnarray}
\zlabel{eq:ext_trapezoidal_rule}
...
%------------------------------------------------------------------------
\zlabel{sec:integration:solid_angle}
...
\zref{sec:scattering}).  One way to achieve
