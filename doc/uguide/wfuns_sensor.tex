...
\section{Calibration weighting functions}
 ...
 \end{equation}
 See Equation \zref{eq:formalism:datared} for definition of the variables.
 ...
 \zref{sec:wfuns_sens:loadcal}. For example, we have that \citep{eriksson:97a}
 \begin{equation}
...
% \zref{eq:wfuns:Hpert} was instead selected for the calculation of the
% pointing WFs.
%
