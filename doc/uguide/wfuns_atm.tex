...
\levelb{Calculation approaches}
 \label{sec:wfuns:approaches}
  ...
  \ref{sec:wfuns:absloswfs2}. These terms are treated seperately as
...
\levelb{Absorption LOS WFs for optical thicknesses}
 ...
 can neglected. For these pure absorption calculations the output
 of ARTS is optical thicknesses (instead of e.g. transmisions) and
