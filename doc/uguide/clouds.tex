...
That is, \shortcode{aa\_grid} from 0\degree{} to 180\degree{}, and
\shortcode{za\_inc} from 0\degree{} to 90\degree{}. The latter requires that the
data's zenith angle grid includes a grid point at 90\degree{} and that
\shortcode{za\_grid} is symmetric with respect to 90\degree{} (i.e.,
