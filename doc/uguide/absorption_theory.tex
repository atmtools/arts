...
the ARTS community for applications of this type of line shape so
many small bugs might be present and not rooted out.

\begin{equation}
 F(\Gamma_D, \Gamma_0, \Delta_0, \Gamma_2, \Delta_2, \eta, \nu_{FVC}, \nu, \nu_0, \nu_z, \delta\nu) = \frac{1}{\pi}\frac{A}{\left[\left(C_0 - \left.3C_2\middle/2\right.\right)\eta - \nu_{FVC}\right] A + \eta C_2 B + 1}
\end{equation}
where
\begin{equation}
