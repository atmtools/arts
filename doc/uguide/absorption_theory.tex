...
\starthistory
  2011-06-22 & Revised for ARTS2 by Stefan Buehler.\\
...
\subsection{Line Shape Functions} So far, there is no way to calculate
...
\subsection{Line Catalogs} 

FIXME: Continue below...
...
% --------------------- only end of table ------------------------------
 K & K & K & K & K & K\kill
 \hline
 \caption[ARTS partition function data.]{Partition function (PF) within ARTS, comparison with HTRAN96
