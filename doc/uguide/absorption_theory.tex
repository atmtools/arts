...
\begin{equation}
  \gamma_L = x_\mathrm{self} \; p \; \mathrm{SGAM} \; \frac{\mathrm{T\_GAM}}{T}^{\mathrm{NSELF}}
             + (1-x_\mathrm{self}) \; p \; \mathrm{AGAM} \; \frac{\mathrm{T\_GAM}}{T}^{\mathrm{NAIR}} \;,
\end{equation}
and the pressure shift is calculated as
\begin{equation}
  \Delta \nu = p \; \mathrm{PSF} \; \frac{\mathrm{T\_GAM}}{T}^{(0.25 + 1.5 * \mathrm{NAIR})} \;,
\end{equation}
...
\begin{equation}
  \gamma_L = x_\mathrm{self} \; p \; \mathrm{SGAM} \; \frac{\mathrm{T\_I0}}{T}^{\mathrm{NSELF}}
             + (1-x_\mathrm{self}) \; p \; \frac{\sum_i \left[ x_i \; \mathrm{GAMMA}_i \;
               \frac{\mathrm{T\_I0}}{T}^{\mathrm{N}_i} \right ] }
             {\sum_i x_i} \;,
\end{equation}
...
\begin{equation}
\Delta \nu = p \; \frac{\sum_i \left[ x_i \; \mathrm{DELTA}_i \;
               \frac{\mathrm{T\_I0}}{T}^{(0.25 + 1.5 * \mathrm{N}_i} \right ] }
             {\sum_i x_i} \;.
\end{equation}
