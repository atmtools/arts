...
The problem of describing the line shape
function is discussed in the following subsection. Then another
subsection discusses partition functions and their calculation.
...
of line intensities (Equation \ref{eq:abs_theory:line_intensity} on
...
\subsection{Spectral-line-specific data and line catalogues} 
...
below. But ARTS can read also several other catalogue formats, in
...
isotopic ratio are specific and constant for each species.  Here is a
...
It is planned to change this in the not too far future, at least for
the isotopic ratios, in order to allow calculations for other
planets. The data will then be read from include files instead.

\citet{buehler:artst:05} contains an explicit list of species that
were implemented at the time of writing and their data.  We do not
have such a list here, because it is too hard to maintain.  Currently,
the best is to look directly in file \shortcode{species\_data.cc}.
The different data sources are also documented there.
...
$|\Delta\,J|=$0,2 (see \citet{pwr:93} for details). In a similar way exhibits 
carbon dioxide a collision induced absorption band (maximum around 1.5\,THz, 
Figure 5.10 of \citet{goodyandyung:89}). Characteristic for collision induced 
...
tags. Why this is so can be seen from Eq. \ref{eq:abs_theory:abs_cont} and 
...
as described in Eq. (\ref{eq:abs_theory:abs_cont}) is divided up into 
...
\item[$\bullet$] The general water vapor continuum function
as described in Equation (\ref{eq:abs_theory:abs_cont}) is divided up into 
two separate tags in arts. The term proportional 
...
function of Eq. \ref{eq:abs_theory:abs_cont} is therefore not valid. In MPM93 
...
\item[$\bullet$] The oxygen continuum models of Rosenkranz
  ...
  (\ref{eq:abs_theory:abs_cont_pwr_o2}) and (\ref{eq:abs_theory:o2_cont_gamma_general}).
  The units of these parameters are: $[$1/(m$\cdot$Pa$\cdot$Hz)$]$,
  $[$Hz/Pa$]$, $[$1$]$, $[$1$]$, $[$1$]$, $[$1$]$. For a description
  of these parameters see Eqs. (\ref{eq:abs_theory:abs_cont_pwr_o2}),
  (\ref{eq:abs_theory:o2cont_const_vmr_1}), and (\ref{eq:abs_theory:o2_cont_gamma_general}).
...
Eq. \ref{eq:abs_theory:abs_cont_MPM89_n2}. To be able to use this referenced model, one 
...
\item[$\bullet$] The \citet{pwr:93} $\coz$-$\coz$ continuum term is
  according to Equation (\ref{eq:abs_theory:abs_cont_pwr_co2}) of
...
\item[$\bullet$] The \citet{pwr:93} $\coz$-$\nz$ continuum term is
  according to as explained in Equation (\ref{eq:abs_theory:abs_cont_pwr_co2}) of
...
% --------------------------------------------------------------
 Rosenkranz     & tagname &=& {\small \tt "H2O-SelfContStandardType"}     & 
                  {\small \citet{pwr:98}}  & {\small Standard\_H2O\_self\_continuum}\\
...
% --------------------------------------------------------------
 ...
 \hline
 Rosenkranz & tagname &=& {\small \tt "SelfContStandardType"} & {\small \citet{pwr:93}} & 
              {\small Standard\_O2\_continuum}\\
$\oz-$air   & model &=& "Rosenkranz" & {\small Sec. \ref{levelc:o2cont}} &  \\  
            & userparameters &=& [ ] &   & \\
% --------------------------------------------------------------
 MPM93      & tagname &=& {\small \tt "O2-SelfContStandardType"} & {\small \citet{liebeetal:93}} & 
              {\small Standard\_O2\_continuum}\\
$\oz-$air   & model &=& "MPM93"  & {\small Sec. \ref{levelc:o2cont}}  &  \\
 ...
 \hline
 Rosenkranz & tagname &=& {\small \tt "N2-SelfContStandardType"} & {\small \citet{pwr:93}} & 
              {\small Standard\_N2\_self\_continuum}\\
$\nz-\nz$   & model &=& "Rosenkranz" & {\small Sec. \ref{levelc:n2cont}}  &  \\  
            & userparameters &=& [ ] &   & \\
% --------------------------------------------------------------
 MPM93      & tagname &=& {\small \tt "N2-SelfContMPM93"} & {\small \citet{liebeetal:93}} & 
...
\item[$\bullet$] The water vapor model of MPM87 \citep{liebeandlayton:87} 
     ...
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:mpm87:strength})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:mpm87:gamma})). 
     The continuum absorption, $\alphampmoc$, 
     (see Eq. (\ref{eq:abs_theory:mpm87:cont})) also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The full water vapor absorption model MPM89 \citep{liebe:89} 
     ...
     $CC$, $CL$, and $CW$, with the input variable {\it userparameters}, 
     {\it userparameters}\,=\,$[$$CC$, $CL$, $CW$$]$. 
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:mpm89:strength})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:mpm89:gamma})). 
     The continuum absorption, $\alphampmmc$, 
     (see Eq. (\ref{eq:abs_theory:mpm89:cont})) also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The water vapor model of MPM93 \citep{liebeetal:93}
     ...
     $CC$, $CL$, and $CW$, with the input variable {\it userparameters}, 
     {\it userparameters}\,=\,$[$$CC$, $CL$, $CW$$]$. 
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:mpm93:strength})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:mpm93:gamma})). 
     The continuum absorption, $\alphampmnc$, 
     (see Eq. (\ref{eq:abs_theory:mpm93:strength})) also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The water vapor model of CP98 \citep{cruzpol:98}
     ...
     $CC$, $CL$, and $CW$, with the input variable {\it userparameters}, 
     {\it userparameters}\,=\,$[$$CC$, $CL$, $CW$$]$. 
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:cp98:inten})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:cp98:width})). 
     The continuum absorption, $\alphacpc$, 
     (see Eq. (\ref{eq:abs_theory:cp98_cont_scaling})) also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The water vapor model of PWR98 \citep{pwr:98}
     ...
     $CC$, $CL$, and $CW$, with the input variable {\it userparameters}, 
     {\it userparameters}\,=\,$[$$CC$, $CL$, $CW$$]$. 
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:pwr98absline})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:pwr98gamma})). 
     The continuum absorption, $\alphapwrc$, 
     (see Eq. (\ref{eq:abs_theory:pwr98:abscont})) also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The MPM93 full absorption model for oxygen \citep{liebeetal:93}
     ...
     oxygen absorption model are described in Section \ref{sec:abs_theory:O2_mpm93}. 
     ...
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:MPM93:O2_inten})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:MPM93:O2_gamma})) and 
     $CO$ the line coupling parameter (see Eq. (\ref{eq:abs_theory:MPM93:O2_coupling})). 
     The continuum absorption, (see Eq. (\ref{eq:abs_theory:mpm93_o2cont})) 
     also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\item[$\bullet$] The PWR93 full absorption model for oxygen \citep{pwr:93}
     ...
     $CC$, $CL$, $CW$, and $CO$, with the input variable {\it userparameters}, 
     e. g. {\it userparameters}\,=\,$[$$CC$, $CL$, $CW$, $CO$$]$. 
     Each line intensity $\inten$ (see Eq. (\ref{eq:abs_theory:PWR93:O2_abs_inten})) 
     is multiplied with the scaling factor $CL$, while $CW$ scales 
     each line width, $\gamk$, (see Eq. (\ref{eq:abs_theory:PWR93:O2_gamma})) and 
     $CO$ the line coupling parameter (see Eq. \ref{eq:abs_theory:PWR93:O2_coupling})). 
     The continuum absorption, (see Eq. (\ref{eq:abs_theory:pwr_o2cont})) 
     also scales with $CC$.\\
     In the following all the valid possibilities for the
...
\label{sec:abs_theory:WV_sat_in_cloud}
%--------------------------------------------------------
...
%    models of \citet{liebeetal:91} and \citet{ray:72} (calculated with 
...
\section{ARTS workspace variables and methods}
\label{sec:abs_theory:ArtsImplementationCloudAbsorption}
% ----------------------------------------------
...
\item[$\bullet$] The liquid water cloud absorption model of 
     ...
     (see Eq. \ref{eq:abs_theory:abs_cloud}) while $CG$ scales the first 
     relaxation frequency, $\gamma_1$, (see Eq. 
     (\ref{eq:abs_theory:comp_perm_lwc_gamma_1})) and  $CE$ scales $\epsilon_o$ 
     (see Eq. \ref{eq:abs_theory:comp_perm_lwc_epsilon_0})
\begin{code}
cont_descriptionAppend{
...
\item[$\bullet$] The ice water cloud absorption model of 
     ...
     (see Eq. \ref{eq:abs_theory:abs_cloud}) while $CA$ scales $a$, (see Eq. 
     (\ref{eq:abs_theory:comp_perm_iwc_a})) and $CB$ scales $b$ 
     (see Eq. \ref{eq:abs_theory:comp_perm_iwc_b})
\begin{code}
...
% --------------------- only end of table ------------------------------
 K & K & K & K & K & K \kill 
 \hline
 \caption[Cloud absorption models.]{This table gives an overview of the implemented referenced 
...
% --------------------- body of table  ----------------------------------  
 ...
 \hline
% --------------------------------------------------------------
 MPM93       & tagname &=& {\tt "liquidcloud-MPM93"} & \citet{liebeetal:93} & 
             MPM93WaterDropletAbs\\
             & model   &=& "MPM93"    &   &  \\ 
             & userparameters &=& [ ] &   & \\
 \hline
% --------------------------------------------------------------
 MPM93       & tagname &=& {\tt "icecloud-MPM93"} & \citet{liebeetal:93} & 
               MPM93IceCrystalAbs\\
             & model   &=& "MPM93"    &   &  \\ 
             & userparameters &=& [ ] &   & \\
 \hline
