...
%- Since LaTeX2e 2024-11-01 the kernel already provides \theHalgorithm
%- (together with the counter), so don't redefine it unconditionally.
\providecommand{\theHalgorithm}{\theHchapter.\arabic{algorithm}}
...
\newcommand{\artsdocserver}{https://atmtools.github.io/arts-docs-2.6/}
