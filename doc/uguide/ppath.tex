...
all path steps that together make up \builtindoc{ppath}. 
...
\begin{description}
  ...
  \item[dim] [Index] The atmospheric dimensionality. This field shall always 
   ...
   \item[l\_space] [Numeric] Propagation length through free space above the
...
%===================
The implementation and the numerical expressions used are discussed in
Chapter~\ref{T-sec:ppaththeory} of \theory.
