...
% Introduction
%
Following Equation \zref{eq:formalism:fm},
\begin{eqnarray}
   \y = \fm + \merr, \nonumber
\end{eqnarray}
...
\section{General}
 ...
 fact can also be understood by Equation \zref{eq:formalism:datared}:
 \begin{eqnarray}
 ...
 (Eq. \zref{eq:formalism:kx2}).



\section{Thermal noise}
 \zlabel{sec:measerr:tn}
 ...
 \subsection{Measurement thermal noise}
 \zlabel{sec:measerr:mtn}
 ...
 the middle frequency of channel $i$ (Fig. \zref{fig:measerr:cfuns}).
 ...
 \begin{figure}
  \begin{center}
   \begin{minipage}[c]{0.65\textwidth}
    \centering
    \includegraphics*[width=0.99\hsize]{fig_corrfuns}
   \end{minipage}%
 ...
 Data reduction is considered by Equation \zref{eq:measerr:HSH}.
 


%\section{Sinusoidal baseline ripple}
% \zlabel{sec:measerr:sin}
% 
...
% Equation \zref{eq:measerr:fmean}.
% 
% Using Equation \zref{eq:measerr:kx}, the
...
% effect of the spectrometer and Equation \zref{eq:measerr:sines} assumes
...
\section{Polynomial baseline ripple}
 \zlabel{sec:measerr:pol}
 
 \begin{figure}
  \begin{center}
   \begin{minipage}[c]{0.62\textwidth}
    \centering
    \includegraphics*[width=0.99\hsize]{kpol}
   \end{minipage}%
   \hspace{0.03\textwidth}%
 ...
 \zref{fig:measerr:kpol}.



\section{Piecewise polynomial baseline ripple}
 \zlabel{sec:measerr:ppol}
 ...
 \zref{fig:wfuns:baselinefit} shows an example on such a spectrum.
 ...
 given by Equation \zref{eq:measerr:kpol}, while for remaining
 frequencies the WFs are 0.  

 \begin{figure}[t]
  \begin{center}
   \includegraphics*[width=0.72\hsize]{fig_baselinefit}
