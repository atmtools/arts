...
To consider Faraday rotation and Zeeman splitting (see \theory,
\ref{T-sec:at:zeeman}), also the \textindex{magnetic field} must be specified.
This vector field is broken down into three scalar fields:
