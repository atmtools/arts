...
\fileindex{gridded\_fields.cc}.  The \typeindex{GriddedField3} is used
for all atmospheric field: \wsvindex{z\_field}, \wsvindex{t\_field},
\wsvindex{vmr\_field} and \wsvindex{pnd\_field}.\\
