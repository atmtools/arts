...
(\builtindoc{vmr\_field}).  The fields are assumed to be piece-wise
...
(\builtindoc{z\_field}). Fields are rank-3 tensors. For example, the
...
is a matrix of same size as \builtindoc{r\_geoid}.
