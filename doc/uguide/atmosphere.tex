...
\item[\textindex{1D}\,\,\,] A 1D atmosphere can be described as being
  ...
  sensor is considered to be placed at latitude and lonitude zero
...
\item[\textindex{2D}\,\,\,] In contrast to the 1D and 3D cases, a 2D atmosphere
  ...
  the longitude equals 0\degree\ or 180\degree. A polar system\index{polar
    coordinate system}, consisting of a radial and an angular coordinate, is
