...
\url{http://arts.mi.uni-hamburg.de/docserver-stable}. Alternatively, start ARTS with
\begin{code}
  arts -s
\end{code}
or
...
\caption{Built-in documentation for variable \builtindoc{f\_grid}, obtained by
  ...
  \url{http://arts.mi.uni-hamburg.de/docserver-stable/variables/f_grid}.} 
\label{fig:f_grid}
\end{figure}
...
\caption{Built-in documentation for method \builtindoc{WriteXML}, obtained by
  ...
  \url{http://arts.mi.uni-hamburg.de/docserver-stable/methods/WriteXML}.}
\label{fig:WriteXML}
\end{figure}
...
\caption{Top: Built-in documentation for variable
  ...
  \url{http://arts.mi.uni-hamburg.de/docserver-stable/agendas/propmat_clearsky_agenda}. Bottom
