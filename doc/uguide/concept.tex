...
\href{\docserver}. Alternatively, start ARTS with
\begin{code}
  arts -s
\end{code}
or
...
\caption{Built-in documentation for variable \builtindoc{f\_grid}, obtained by
  ...
  \href{\docserver variables/f\_grid}.}
\label{fig:f_grid}
\end{figure}
...
\caption{Built-in documentation for method \builtindoc{WriteXML}, obtained by
  ...
  \href{\docserver methods/WriteXML}.}
\label{fig:WriteXML}
\end{figure}
...
\caption{Top: Built-in documentation for variable
  ...
  \href{\docserver agendas/propmat\_clearsky\_agenda}. Bottom
