d bu\chapter{Surface emission and reflections}
 \label{sec:surface}
...
\end{equation}
The reflectivity is the half-sphere integral of the BRDF \citep{rees:01}
\begin{equation}
  \label{eq:surface:brdf:r}
  r(\theta_1,\phi_1) = \int_0^{\pi/2} \! \int_0^{2\pi} 
  f(\theta,\phi,\theta_1,\phi_1) \cos(\theta)
  \sin(\theta) \, \DiffD\phi \, \DiffD\theta.
\end{equation}
