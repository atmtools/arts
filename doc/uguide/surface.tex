...
\section{Specular reflections}
 ...
 \FIXME{One text book gives opposite sign for $R_v$. Different definitions? 
     Anyhow put in a reference. (PE 041021)}
 \begin{eqnarray}
...
\FIXME{Check that definitions are consistent between Liou and Mischenko
(PE 041021)}
\begin{equation}
