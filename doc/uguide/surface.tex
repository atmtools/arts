...
relevant workspace variables should then be set as follows:
 ...
 \wsvindex{surface\_refl\_coeffs}: Each reflection matrix is a diagonal
...
% The workspace variable \artsstyle{surface\_los} shall here
% of course be set to have the length 1. The specular direction is
% calculated by the internal function \funcindex{surface\_specular\_los}.
...
% [* Can we relate \artsstyle{surafce\_refl\_coeffs} and
