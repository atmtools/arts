...
\artsstyle{batch\_post\_agenda} is intended to modify \wsvindex{ybatch}.
...
\artsstyle{batch\_update\_agenda}, where \wsvindex{ybatch\_i}, set by
...
In the following 1D example, the five atmospheric scenarios (Fascod)
