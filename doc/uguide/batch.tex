...
The WSV \builtindoc{ybatch\_start} is set to a default of 0 in
\shortcode{general.arts}, so you do not have to set this variable
...
\builtindoc{Array}, a row from a \builtindoc{Matrix}, a
