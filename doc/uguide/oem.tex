...
\wsmindex{retrievalDefClose}, also the a priori covariance matrix
 \wsvindex{covmat\_sx} must be set. This is done using the
\wsvindex{covmat\_sxAddBlock} WSM. More details on the handling of
...
and \wsmindex{jacobianSetFuncTrasformation} WSMs.
