macro (ARTS_TEST_RUN_CTLFILE TESTNAME CTLFILE)
  ...
  set_tests_properties(
    ...
    ENVIRONMENT "ARTS_INCLUDE_PATH=${ARTS_DEFAULT_INCLUDE_DIR};ARTS_DATA_PATH=${ARTS_DATA_DIR}"
  )
  ...
  set_tests_properties(
    ...
    ENVIRONMENT "PYTHONPATH=${ARTS_BINARY_DIR}/python;ARTS_INCLUDE_PATH=${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}:${ARTS_DEFAULT_INCLUDE_DIR};ARTS_DATA_PATH=${ARTS_DATA_DIR}"
...
macro (ARTS_TEST_RUN_PYFILE TESTNAME PYFILE)
  ...
  set_tests_properties(
    ${TESTNAME_LONG} PROPERTIES
    ENVIRONMENT "PYTHONPATH=${ARTS_BINARY_DIR}/python;ARTS_INCLUDE_PATH=${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}:${ARTS_DEFAULT_INCLUDE_DIR};ARTS_DATA_PATh=${ARTS_DATA_DIR};ARTS_CAT_DATA_DIR=${ARTS_CAT_DATA_DIR};ARTS_XML_DATA_DIR=${ARTS_XML_DATA_DIR}"
    DEPENDS python_tests
  )
endmacro()
