macro (ARTS_TEST_RUN_CTLFILE TESTNAME CTLFILE)
  set(ARTS_TEST_INCLUDE_PATH "${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}:${ARTS_SOURCE_DIR}/controlfiles:${ARTS_DATA_DIR}:${ARTS_BINARY_DIR}/tests/testdata/arts-xml-data:${ARTS_BINARY_DIR}/tests/testdata/arts-cat-data")
  ...
  set_tests_properties(
    ...
    ENVIRONMENT "ARTS_HEADLESS=1;ARTS_INCLUDE_PATH=${ARTS_TEST_INCLUDE_PATH}"
  )
  ...
  set_tests_properties(
    ...
    ENVIRONMENT "PYTHONPATH=${ARTS_BINARY_DIR}/python;ARTS_HEADLESS=1;ARTS_INCLUDE_PATH=${ARTS_TEST_INCLUDE_PATH}"
