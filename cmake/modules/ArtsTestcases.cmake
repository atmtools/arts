macro (ARTS_TEST_RUN_CTLFILE TESTNAME CTLFILE)
  ...
  if (ARTS_CAT_DATA_DIR)
    set(ARTS ${ARTS} -D${ARTS_CAT_DATA_DIR})
  endif()
  add_test(
    NAME ${TESTNAME_LONG}
  ...
  set_tests_properties(
    ...
    ENVIRONMENT "PYTHONPATH=${ARTS_BINARY_DIR}/python;ARTS_HEADLESS=1;ARTS_INCLUDE_PATH=${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}:${ARTS_SOURCE_DIR}/controlfiles:${ARTS_DATA_DIR}"
...
macro (ARTS_TEST_RUN_PYFILE TESTNAME PYFILE)
  ...
  set_tests_properties(
    ${TESTNAME_LONG} PROPERTIES
    ENVIRONMENT "PYTHONPATH=${ARTS_BINARY_DIR}/python;ARTS_HEADLESS=1;ARTS_INCLUDE_PATH=${CMAKE_CURRENT_SOURCE_DIR}/${CFILESUBDIR}:${ARTS_SOURCE_DIR}/controlfiles:${ARTS_DATA_DIR};ARTS_CAT_DATA_DIR=${ARTS_CAT_DATA_DIR};ARTS_XML_DATA_DIR=${ARTS_XML_DATA_DIR}"
    DEPENDS python_tests
  )
endmacro()
