...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2O", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CO2", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("O3", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("N2O", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CO", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CH4", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("O2", ISOT)] = VAL
  set_isot_val("66", .995262E+00);
  set_isot_val("68", 3.99141E-03);
  set_isot_val("67", 7.42235E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("NO", ISOT)] = VAL
  set_isot_val("46", .993974E+00);
  set_isot_val("56", 3.65431E-03);
  set_isot_val("48", 1.99312E-03);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("SO2", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("NO2", ISOT)] = VAL
  set_isot_val("646", .991616E+00);
  set_isot_val("656", 3.64564E-030);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("NH3", ISOT)] = VAL
  set_isot_val("4111", .995872E+00);
  set_isot_val("5111", 3.66129E-03);
  set_isot_val("4112", 0.00044792294);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HNO3", ISOT)] = VAL
  set_isot_val("146", .989110E+00);
  set_isot_val("156", 3.63600E-03);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("OH", ISOT)] = VAL
  set_isot_val("61", .997473E+00);
  set_isot_val("81", 2.00014E-03);
  set_isot_val("62", 1.55371E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HF", ISOT)] = VAL
  set_isot_val("19", .999844E+00);
  set_isot_val("29", 1.55741E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HCl", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HBr", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HI", ISOT)] = VAL
  set_isot_val("17", .999844E+00);
  set_isot_val("27", 1.55741E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("ClO", ISOT)] = VAL
  set_isot_val("56", .755908E+00);
  set_isot_val("76", .241720E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("OCS", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2CO", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HOCl", ISOT)] = VAL
  set_isot_val("165", .755790E+00);
  set_isot_val("167", .241683E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("N2", ISOT)] = VAL
  set_isot_val("44", .992687E+00);
  set_isot_val("45", 7.47809E-03);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HCN", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CH3Cl", ISOT)] = VAL
  set_isot_val("215", .748937E+00);
  set_isot_val("217", .239491E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2O2", ISOT)] = VAL
  set_isot_val("1661", .994952E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C2H2", ISOT)] = VAL
  set_isot_val("1221", .977599E+00);
  set_isot_val("1231", 2.19663E-02);
  set_isot_val("1222", 3.04550E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C2H6", ISOT)] = VAL
  set_isot_val("1221", .976990E+00);
  set_isot_val("1231", 2.19526E-02);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("PH3", ISOT)] = VAL
  set_isot_val("1111", .999533E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("COF2", ISOT)] = VAL
  set_isot_val("269", .986544E+00);
  set_isot_val("369", 1.10834E-02);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("SF6", ISOT)] = VAL
  set_isot_val("29", .950180E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2S", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HCOOH", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HO2", ISOT)] = VAL
  set_isot_val("166", .995107E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("O", ISOT)] = VAL
  set_isot_val("6", .997628E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("ClONO2", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("OClO", ISOT)] = VAL
  set_isot_val("656", 0.75509223);
  set_isot_val("676", 0.24490632);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("BrO", ISOT)] = VAL
  set_isot_val("96", 0.50582466);
  set_isot_val("16", 0.49431069);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2SO4", ISOT)] = VAL
  set_isot_val("126", 0.95060479);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("Cl2O2", ISOT)] = VAL
  set_isot_val("565", 0.57016427);
  set_isot_val("765", 0.36982818);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HOBr", ISOT)] = VAL
  set_isot_val("169", .505579E+00);
  set_isot_val("161", .491894E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C2H4", ISOT)] = VAL
  set_isot_val("221", .977294E+00);
  set_isot_val("231", .219595E-01);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CH3OH", ISOT)] = VAL
  set_isot_val("2161", .985930E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CH3Br", ISOT)] = VAL
  set_isot_val("219", .500995E+00);
  set_isot_val("211", .487433E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CH3CN", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CF4", ISOT)] = VAL
  set_isot_val("29", .988890E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HC3N", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CS", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("HNC", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("SO", ISOT)] = VAL
  set_isot_val("26", .950605e+00);
  set_isot_val("46", .420727e-01);
  set_isot_val("28", .194089e-02);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C3H8", ISOT)] = VAL
  set_isot_val("21", 9.66290e-01);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H2", ISOT)] = VAL
  set_isot_val("11", .999688E+00);
  set_isot_val("12", 3.11432E-04);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("H", ISOT)] = VAL
  set_isot_val("1", 1.00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("He", ISOT)] = VAL
  set_isot_val("4", 1.00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("Ar", ISOT)] = VAL
  set_isot_val("8", 1.00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C4H2", ISOT)] = VAL
  set_isot_val("2211", .955998E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("SO3", ISOT)] = VAL
  set_isot_val("26", .943400E+00);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("CS2", ISOT)] = VAL
...
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("C2N2", ISOT)] = VAL
  set_isot_val("4224", 9.70752E-01);
#undef set_isot_val
  
#define set_isot_val(ISOT, VAL) isotopologue_ratios.data[Species::find_species_index("COCl2", ISOT)] = VAL
