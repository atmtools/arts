...
void spectral_radiance_jacobianAddPathPropagation(
  ...
  ARTS_USER_ERROR_IF(
      ...
      "ppath.pos must have same number of rows as the size of spectral_radiance_path_jacobian")
...
void spectral_radiance_jacobianAddPathPropagation2(
    StokvecMatrix &spectral_radiance_jacobian,
    const ArrayOfStokvecMatrix &spectral_radiance_path_jacobian,
    const JacobianTargets &jacobian_targets,
    const AtmField &atm_field,
...
void spectral_radianceStandardEmission(
  ...
  spectral_radiance_backgroundFromPath(ws,
                                       spectral_radiance,
...
void spectral_radianceStandardEmission2(
    const Workspace &ws,
    StokvecVector &spectral_radiance,
    StokvecMatrix &spectral_radiance_jacobian,
    const Vector &f_grid,
  ...
  ArrayOfAtmPoint ppvar_atm;
  ppvar_atmFromPath2(ppvar_atm, propagation_path, atm_field);

  ArrayOfVector ppvar_f;
  ppvar_fFromPath2(
      ppvar_f, f_grid, propagation_path, ppvar_atm, rte_alonglos_v);
  ...
  spectral_radiance_jacobianAddPathPropagation2(spectral_radiance_jacobian,
                                                spectral_radiance_path_jacobian,
                                                jacobian_targets,
                                                atm_field,
                                                propagation_path);
