...
iso(it_isotopologue,	"181" ,	Qcoeff(-7.220624e+00,  2.945347e-01,  1.250362e-03,  -5.554638e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"171" ,	Qcoeff(-4.668105e+01,  1.819186e+00,  7.137470e-03,  -2.670352e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"162" ,	Qcoeff(-4.084466e+01,  1.484533e+00,  5.953330e-03,  -2.359695e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"182" ,	Qcoeff(-3.529770e+01,  1.503267e+00,  6.020059e-03,  -2.389284e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"172" ,	Qcoeff(-2.098457e+02,  8.959286e+00,  3.593721e-02,  -1.428880e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"262" ,	Qcoeff(-3.572493e+01,  1.652500e+00,  7.633309e-03,  -3.770940e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
  iso(it_isotopologue,       "SelfContStandardType",      Qcoeff( 0  ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "ForeignContStandardType",   Qcoeff( 0  ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "ForeignContMaTippingType",  Qcoeff( 0  ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF); 
  ...
  iso(it_isotopologue,       "SelfContCKDMT252",        Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "ForeignContCKDMT252",     Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  ...
  iso(it_isotopologue,       "ForeignContCKD242",       Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "SelfContCKD24",           Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "ForeignContCKD24",        Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "ForeignContATM01",        Qcoeff( 0    ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "CP98", Qcoeff( 0       ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  ...
  iso(it_isotopologue,       "PWR98",Qcoeff( 0       ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"636" ,	Qcoeff(-1.850250e+00,  1.912107e+00,  -1.599677e-03,  5.955462e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"628" ,	Qcoeff(-2.989446e+00,  2.041095e+00,  -1.732748e-03,  6.174831e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"627" ,	Qcoeff(-2.256240e+01,  1.197737e+01,  -1.036863e-02,  3.618820e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"638" ,	Qcoeff(-1.882095e+00,  4.025528e+00,  -3.299047e-03,  1.266725e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"668" ,	Qcoeff(-5.978029e+02,  1.759117e+01,  1.353516e-02,  6.440030e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"686" ,	Qcoeff(-3.005190e+02,  8.726453e+00,  5.976672e-03,  3.241643e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"667" ,	Qcoeff(-3.454638e+03,  1.018144e+02,  8.249751e-02,  3.631247e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"676" ,	Qcoeff(-1.735693e+03,  5.072998e+01,  3.877763e-02,  1.821985e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"456" ,	Qcoeff(3.479618e+01,  1.002537e+01,  -6.789834e-03,  3.681093e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"546" ,	Qcoeff(2.435117e+01,  1.055152e+01,  -7.756090e-03,  3.819981e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"448" ,	Qcoeff(4.066999e+01,  1.615921e+01,  -1.180945e-02,  5.883212e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"447" ,	Qcoeff(2.050163e+02,  9.473303e+01,  -7.029656e-02,  3.426216e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"36" ,	Qcoeff(4.632274e-01,  7.560062e-01,  -8.390593e-06,  2.229242e-08 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"28" ,	Qcoeff(2.874382e-01,  3.786605e-01,  -5.551926e-07,  5.629838e-09 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"27" ,	Qcoeff(1.697400e+00,  2.220079e+00,  -4.074631e-06,  3.291954e-08 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"38" ,	Qcoeff(6.558005e-01,  7.928532e-01,  4.443750e-06,  3.520833e-09 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"37" ,	Qcoeff(3.990599e+00,  4.641927e+00,  2.855732e-05,  1.499385e-08 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"311" ,	Qcoeff(-7.385939e+01,  2.419567e+00,  5.941999e-03,  6.864449e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"212" ,	Qcoeff(-3.003903e+02,  9.769371e+00,  2.411804e-02,  2.704667e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"312" , Qcoeff(-6.843285e+02,  2.100812e+01,  3.970636e-02,  2.256428e-05 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"68" ,	Qcoeff(-3.922253e+00,  1.551651e+00,  -8.580045e-05,  1.716056e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"67" ,	Qcoeff(-2.757545e+01,  9.118689e+00,  -7.483006e-04,  1.332269e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
  ...
  iso(it_isotopologue,       "visCKDMT252",   Qcoeff( 0     ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "SelfContStandardType",   Qcoeff( 0     ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  ...
  iso(it_isotopologue,       "MPM89",          Qcoeff( 0     ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "MPM87",          Qcoeff( 0     ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "MPM85",          Qcoeff( 0     ,0              ,0              ,0          ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"56" ,	Qcoeff(-4.036081e+01,  2.091668e+00,  3.435242e-03,  -3.490987e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"48" ,	Qcoeff(-6.255837e+01,  3.205744e+00,  5.176248e-03,  -5.223151e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"646" ,	Qcoeff(-3.389056e+02,  1.215747e+01,  2.023113e-02,  5.153272e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,  "636" , Qcoeff(   5.8740E+02,    1.2472E+01,    2.9113E-01,   -1.6236E-04 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,  "628" , Qcoeff(   3.1299E+02,    6.6372E+00,    1.5485E-01,   -8.6343E-05 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"5111" ,	Qcoeff(-6.520038e+01,  2.279068e+00,  5.958356e-03,  8.170489e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,  "4112" ,	Qcoeff( 9.278991e+00,  4.053839e+00,  3.148529e-02, -8.153125e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,  "156" ,  Qcoeff(-3.402033e+04,  7.965238e+02,  -2.403160e+00,  8.593868e-03 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"81" ,	Qcoeff(6.173190e+00,  1.884492e-01,  3.126020e-04,  -3.263942e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"62" ,	Qcoeff(4.103720e+00,  5.095633e-01,  8.899807e-04,  -9.103002e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"29" ,	Qcoeff(3.375585e-01,  6.403473e-02,  3.134983e-07,  -3.970786e-11 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"17" ,	Qcoeff(2.719350e+00,  5.335676e-01,  2.054102e-06,  2.061213e-09 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"25" ,	Qcoeff(1.355208e+00,  5.155418e-01,  3.328246e-06,  1.718278e-12 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,	"27" ,	Qcoeff(1.359929e+00,  5.170804e-01,  3.358101e-06, -1.087936e-11 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,  "11" ,	Qcoeff(2.875136e+00,  6.637710e-01,  1.449833e-05,  -1.498201e-08 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,  "29" ,	Qcoeff(2.936148e+00,  6.629899e-01,  1.604872e-05,  -1.593934e-08 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,  "21" ,	Qcoeff(2.875136e+00,  6.637710e-01,  1.449833e-05,  -1.498201e-08 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,  "27" ,  Qcoeff(4.226561e+00,  1.295818e+00,  1.611346e-05,  -7.882228e-09 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"76" ,	Qcoeff(1.306461e+02,  6.492672e+00,  1.457301e-02,  1.142879e-07 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"624" ,	Qcoeff(1.055761e+01,  3.598837e+00,  -3.406838e-03,  1.836238e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"632" ,	Qcoeff(3.246621e+01,  6.852374e+00,  -5.819381e-03,  3.599002e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"623" ,	Qcoeff(4.848356e+01,  1.411918e+01,  -1.292079e-02,  7.151233e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"822" ,	Qcoeff(1.444298e+01,  3.686311e+00,  -3.307686e-03,  1.920205e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"1136" ,	Qcoeff(-3.529337e+02,  1.160844e+01,  3.109193e-02,  1.153082e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"1128" ,	Qcoeff(-1.781662e+02,  5.905635e+00,  1.604851e-02,  3.936717e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"1226" ,	Qcoeff(-5.332528e+01,  2.914098e+00,  1.444437e-02, -6.565213e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,	"2226" ,	Qcoeff(-2.847116e+02,  1.672849e+01,  8.661739e-02, -3.736935e-05 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"167" ,	Qcoeff(-1.215084e+03,  4.025848e+01,  7.807742e-02,  7.992701e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,  "45" ,  Qcoeff(1.704255e+00,  1.562748e+00,  2.437406e-05,  -1.677703e-08 ), IsotopologueRecord::PF_FROMCOEFF);  
  iso(it_isotopologue,       "SelfContMPM93",        Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "SelfContPWR93",        Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "SelfContStandardType", Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
  ...
  iso(it_isotopologue,       "CIAfunCKDMT100",       Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "CIArotCKDMT252",       Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
  iso(it_isotopologue,       "CIAfunCKDMT252",       Qcoeff( 0       ,0              ,0              ,0   ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"134" ,	Qcoeff(-1.010578e+01,  6.290094e+00,  -4.988065e-03,  1.641309e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"125" ,	Qcoeff(-3.253498e+00,  2.118761e+00,  -1.680616e-03,  5.582555e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"224" ,	Qcoeff( 6.626957e+01,  8.670873e-01,   3.148000e-03, -2.052228e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"217" ,	Qcoeff(-1.159736e+04,  3.123035e+02,  4.438509e-02,  1.269305e-03 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"1231" ,	Qcoeff(-3.468599e+01,  5.815575e+00,  -1.039390e-02,  3.393990e-05 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,	"1222" ,  Qcoeff(-2.311093e+01,  4.993367e+00,  -9.428896e-03,  3.674804e-05 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"1231" ,  Qcoeff(-4.632309e+03,  1.062931e+02,  -2.234063e-01,  1.115322e-03 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,  "369" , Qcoeff(-8.322642e+03,  2.144407e+02,  -3.498616e-01,  1.755888e-03 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"121" ,	Qcoeff(-2.308888e+01,  9.052647e-01,  3.237531e-03,  -9.823621e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"141" ,	Qcoeff(-2.333981e+01,  9.102537e-01,  3.233485e-03,  -9.665574e-07 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"131" ,	Qcoeff(-9.329309e+01,  3.636877e+00,  1.291822e-02,  -3.864368e-06 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"122" ,	Qcoeff(-1.512671e+01,  6.851018e-01,  3.158080e-03,  -1.563931e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"1361" ,	Qcoeff(-4.910213e+03,  5.115094e+01,  3.433096e-02, -1.340898e-04 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,	"2261" ,	Qcoeff( 3.823001e+02,  5.455419e+00,  1.108040e-01, -5.086754e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
iso(it_isotopologue,	"1262" ,	Qcoeff( 8.193393e+02,  2.222546e+00,  1.070970e-01,  3.255965e-06 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"7646" ,	Qcoeff(-2.104484e+06,  3.729925e+04,  -2.045781e+02,  5.357327e-01 ), IsotopologueRecord::PF_FROMCOEFF); 
...
iso(it_isotopologue,	"676" ,	Qcoeff( 7.964396e+02,  4.768587e+01,  5.283347e-01,  -8.232128e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"16" ,	Qcoeff(-4.118468e+01,  1.434034e+01,  -1.016302e-02,  2.795965e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"765" ,	Qcoeff(6.399192e+05,  -7.332314e+03,  2.866224e+01,  2.210953e-02 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"161" ,	Qcoeff(-1.631140e+03,  5.625451e+01,  1.012339e-01,  1.676169e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"231" ,	Qcoeff(-5.653328e+03,  1.396050e+02,  -9.531910e-02,  6.891171e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
...
//iso(it_isotopologue,	"2261" ,  Qcoeff( ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"211" , Qcoeff(-8.174189e+03,  2.222574e+02,  -5.242739e-02,  1.170863e-03 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"211124" ,  Qcoeff(-9.623882e+03,  2.374695e+02, -6.173187e-01,  3.164639e-03 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"311124" ,	Qcoeff(-1.172596e+03,  4.973615e+01,  2.285735e-01, -1.135942e-04 ), IsotopologueRecord::PF_FROMCOEFF);  
//iso(it_isotopologue,	"311124" ,  Qcoeff(-2.049829e+04,  5.010426e+02, -1.338276e+00,  6.673269e-03 ), IsotopologueRecord::PF_FROMCOEFF);// !HITRAN!
iso(it_isotopologue,	"211134" ,	Qcoeff(-1.139329e+03,  4.832504e+01,  2.220882e-01, -1.103713e-04 ), IsotopologueRecord::PF_FROMCOEFF);
//iso(it_isotopologue,	"211134" ,  Qcoeff(-1.968877e+04,  4.826701e+02, -1.286793e+00,  6.573412e-03 ), IsotopologueRecord::PF_FROMCOEFF);// !HITRAN!
iso(it_isotopologue,	"211125" ,	Qcoeff(-3.861117e+02,  1.654635e+01,  7.638250e-02, -3.776153e-05 ), IsotopologueRecord::PF_FROMCOEFF);   
iso(it_isotopologue,	"211224" ,	Qcoeff(-3.483734e+02,  1.464417e+01,  6.717486e-02, -3.345710e-05 ), IsotopologueRecord::PF_FROMCOEFF);  
//iso(it_isotopologue,	"311134" ,  Qcoeff(-4.172614e+04,  1.014830e+03, -2.761288e+00,  1.377871e-02 ), IsotopologueRecord::PF_FROMCOEFF);// !HITRAN!
...
iso(it_isotopologue,	"12234" , Qcoeff(-1.227602e+04,  2.649297e+02,  -1.305621e+00,  3.782952e-03 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"12324" , Qcoeff(-1.206417e+04,  2.614248e+02,  -1.285701e+00,  3.740976e-03 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"13224" , Qcoeff(-1.289278e+04,  2.770457e+02,  -1.369981e+00,  3.949587e-03 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"12225" , Qcoeff(-4.185427e+03,  9.035734e+01,  -4.449410e-01,  1.289787e-03 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"22224" , Qcoeff(-1.403953e+04,  2.856169e+02,  -1.492360e+00,  4.092496e-03 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"24" ,  Qcoeff(-1.268076e+00,  8.916788e-01,  -1.426045e-04,  2.926318e-07 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"32" ,  Qcoeff(-2.829388e+00,  1.861746e+00,  -3.157562e-04,  6.522683e-07 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"23" ,  Qcoeff(-4.804427e+00,  3.534610e+00,  -5.409610e-04,  1.115080e-06 ), IsotopologueRecord::PF_FROMCOEFF);
...
iso(it_isotopologue,	"143" ,	Qcoeff(7.032558e-02,  4.813463e-01, -6.651923e-06, -1.954964e-11 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"152" ,	Qcoeff(1.589700e-01,  4.708129e-01, -3.866420e-06,  4.006830e-11 ), IsotopologueRecord::PF_FROMCOEFF);  
iso(it_isotopologue,	"242" ,	Qcoeff(2.865158e-01,  5.465990e-01,  2.142689e-07,  1.733211e-11 ), IsotopologueRecord::PF_FROMCOEFF);  
...
iso(it_isotopologue,	"46" ,  Qcoeff(-2.691191e+01,  3.076825e+00,  -7.096949e-04,  1.474163e-06 ), IsotopologueRecord::PF_FROMCOEFF);
iso(it_isotopologue,	"28" ,  Qcoeff(-2.913675e+01,  3.263819e+00,  -8.018822e-04,  1.695761e-06 ), IsotopologueRecord::PF_FROMCOEFF);
...
//iso(it_isotopologue,	"21" ,  Qcoeff(-1.509682e+05,  8.184783e+03, -8.819316e+01,  3.778885e-01), IsotopologueRecord::PF_FROMCOEFF); // with vib
...
iso(it_isotopologue,	"12" ,  Qcoeff( 2.575211e+00,  8.914624e-02,  1.491752e-05, -1.505173e-08 ), IsotopologueRecord::PF_FROMCOEFF);
         ...
         const Index& coefftype)
{
  ...
  ii->SetPartitionFctCoeff(coeff,coefftype);
