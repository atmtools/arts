  ...
  if( atmosphere_dim == 1 )
    {
      i_fieldUpdate1D(//Output:
                      i_field, ppath_step, stokes_vec, ext_mat, abs_vec, 
                      pha_mat_part,
                      sca_vec, planck_function, l_step, pha_mat_spt, 
                      abs_vec_spt, abs_vec_part, ext_mat_spt, ext_mat_part,
                      //Input:
		      ...
		      pnd_field, stokes_dim, atmosphere_dim);
    }
