...
struct Noshape {
  ...
  static constexpr Complex dFdY(Numeric) noexcept { return 0; }
  static constexpr Complex dFdG(Numeric) noexcept { return 0; }
...
class Lorentz {
 ...
 public:
  ...
  constexpr Complex dFdVMR(Output d) const noexcept { return Complex(d.G0, d.D0 + d.DV) * dF; }
  constexpr Complex dFdT(Output d, Numeric) const noexcept {
    return dFdVMR(d);
  }
  ...
  constexpr Complex operator()(Numeric f) noexcept {
    reinterpret_cast<Numeric(&)[2]>(z)[1] = Constant::pi * (mF0 - f);
    F = 1.0 / z;
    dF = -Constant::pi * Constant::pow2(F);
    return F;
  }
...
class SpeedDependentVoigt {
 ...
 public:
  ...
  SpeedDependentVoigt(Numeric F0_noshift, Output ls, Numeric GD_div_F0, Numeric dZ) noexcept;
...
public:
  ...
  HartmannTran(Numeric F0_noshift, Output ls, Numeric GD_div_F0, Numeric dZ) noexcept;
...
typedef std::variant <Noshape,
                      Doppler,
                      Lorentz,
                      Voigt,
                      SpeedDependentVoigt,
                      HartmannTran> Calculator;
