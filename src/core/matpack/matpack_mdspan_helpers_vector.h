...
void gaussian_grid(Vector &y, const Vector &x, const Numeric &x0, const Numeric &si, const Numeric &fwhm);

Vector gaussian_grid(Vector x, const Numeric &x0, const Numeric &si, const Numeric &fwhm);
}  // namespace matpack
