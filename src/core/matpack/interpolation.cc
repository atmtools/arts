...
void interpweights(StridedTensor4View itw,
  ...
  assert(same_shape({np, nr, nc, 8}, itw));
...
void interpweights(StridedTensor5View itw,
  ...
  assert(same_shape({nb, np, nr, nc, 16}, itw));
...
void interpweights(StridedTensor6View itw,
  ...
  assert(same_shape({ns, nb, np, nr, nc, 32}, itw));
...
void interpweights(StridedTensor7View itw,
  ...
  assert(same_shape({nv, ns, nb, np, nr, nc, 64}, itw));
...
void interp(StridedMatrixView ia,
  ...
  assert(same_shape({nr, nc, 4}, itw));  // We need 4 interpolation
                                         // weights for each position.
...
void interp(StridedTensor4View ia,
  ...
  Index nr = rgp.size();
  Index nc = cgp.size();
  assert(same_shape({nb, np, nr, nc}, ia));
  assert(same_shape({nb, np, nr, nc, 16}, itw));
...
void interp(StridedTensor5View ia,
  ...
  Index nr = rgp.size();
  Index nc = cgp.size();
  assert(same_shape({ns, nb, np, nr, nc}, ia));
  assert(same_shape({ns, nb, np, nr, nc, 32}, itw));
