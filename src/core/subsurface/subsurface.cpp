...
template <>
const Subsurface::Data &
FieldMap::Map<Subsurface::Data, SubsurfaceKey>::operator[](
    const Subsurface::KeyVal &k) const try {
  return std::visit(
      [this](auto &key) -> const Subsurface::Data & {
...
template <>
Subsurface::Data &FieldMap::Map<Subsurface::Data, SubsurfaceKey>::operator[](
    const Subsurface::KeyVal &k) try {
  return std::visit(
      [this](auto &key) -> Subsurface::Data & {
...
template <>
bool FieldMap::Map<Subsurface::Data, SubsurfaceKey>::contains(
    const Subsurface::KeyVal &key) const {
  return std::visit(
