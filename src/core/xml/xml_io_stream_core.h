...
template <> struct xml_io_stream<Numeric> {
  constexpr static std::string_view type_name = "Numeric"sv;

  static void write(std::ostream& os, const Numeric& n, bofstream* pbofs = nullptr, std::string_view name = ""sv);
...
template <> struct xml_io_stream<bool> {
  constexpr static std::string_view type_name = "Bool"sv;

  static void write(std::ostream& os, const bool& n, bofstream* pbofs = nullptr, std::string_view name = ""sv);
  static void read(std::istream& is, bool& n, bifstream* pbifs = nullptr);
};

template <> struct xml_io_stream<Index> {
  constexpr static std::string_view type_name = "Index"sv;

  static void write(std::ostream& os, const Index& n, bofstream* pbofs = nullptr, std::string_view name = ""sv);
...
template <> struct xml_io_stream<Size> {
  constexpr static std::string_view type_name = "Size"sv;

  static void write(std::ostream& os, const Size& n, bofstream* pbofs = nullptr, std::string_view name = ""sv);
...
template <> struct xml_io_stream<std::complex<Numeric>> {
  ...
  static void read(std::istream& is, std::complex<Numeric>& n, bifstream* pbifs = nullptr);
...
template <> struct xml_io_stream<String> {
  constexpr static std::string_view type_name = "String"sv;

  static void write(std::ostream& os, const String& n, bofstream* pbofs = nullptr, std::string_view name = ""sv);

  static void read(std::istream& is, String& n, bifstream* pbifs = nullptr);
};

template <> struct xml_io_stream<Any> {
  static constexpr std::string_view type_name = "Any"sv;

  static void write(std::ostream& os, const Any& x, bofstream* pbofs = nullptr, std::string_view name = ""sv);
