...
void test_problem_2() {
  ...
  run_rayleigh_case("2b", 0.2, 1.0 - 1e-6, {2.52716e-1, 2.10311e-2}, {0, 1.06123e-1}, {1.25561e-1, 0},
  ...
  run_rayleigh_case("2d", 5.0, 1.0 - 1e-6, {2.52716e-1, 0}, {0, 2.68008e-2}, {2.25915e-1, 0},
