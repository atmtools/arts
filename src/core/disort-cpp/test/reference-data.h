...
inline const std::array  problem_1{
    single_layer_case{
        ...
        .omega        = 0.2,
        .beam         = true,
        .direct       = {3.14159, 2.29844},
        .diffuse_down = {0, 0.0794108},
        .up           = {0.0799451, 0},
        .radiance     = matrix_2x6({0, 0, 0, 0.117771, 0.0264170, 0.0134041, 0.0133826, 0.0263324, 0.115898, 0, 0, 0})},
    single_layer_case{
        .name         = "1b",
        .depth        = 0.03125,
        .omega        = 1.0,
        .beam         = true,
        .direct       = {3.14159, 2.29844},
        .diffuse_down = {0, 0.420233},
        .up           = {0.422922, 0},
        .radiance     = matrix_2x6({0, 0, 0, 0.622884, 0.139763, 0.0709192, 0.0708109, 0.139337, 0.613458, 0, 0, 0})},
    single_layer_case{
        .name         = "1c",
        .depth        = 0.03125,
        .omega        = 0.99,
        .beam         = false,
        .direct       = {0, 0},
        .diffuse_down = {3.14159, 3.04897},
        .up           = {0.0906556, 0},
        .radiance     = matrix_2x6({1, 1, 1, 0.133177, 0.0299879, 0.0152233, 0.984447, 0.969363, 0.863946, 0, 0, 0})},
    single_layer_case{.name         = "1d",
                      .depth        = 32.0,
                      .omega        = 0.2,
                      .beam         = true,
                      .direct       = {3.14159, 0},
                      ...
                      .up           = {0.259686, 0},
                      .radiance     = matrix_2x6(
                          {0, 0, 0, 0.262972, 0.0906967, 0.0502853, 1.22980e-15, 1.30698e-17, 6.88840e-18, 0, 0, 0})},
    single_layer_case{
        .name         = "1e",
        .depth        = 32.0,
        .omega        = 1.0,
        .beam         = true,
        .direct       = {3.14159, 0},
        .diffuse_down = {0, 0.0676954},
        .up           = {3.07390, 0},
        .radiance     = matrix_2x6({0, 0, 0, 1.93321, 1.02732, 0.797199, 0.0271316, 0.0187805, 0.0116385, 0, 0, 0})},
    single_layer_case{
        .name         = "1f",
        .depth        = 32.0,
        .omega        = 0.99,
        .beam         = false,
        .direct       = {0, 0},
        .diffuse_down = {3.14159, 0.00460048},
        .up           = {2.49618, 0},
        .radiance = matrix_2x6({1, 1, 1, 0.877510, 0.815136, 0.752715, 0.00186840, 0.00126492, 0.000779280, 0, 0, 0})},
};
...
inline const std::array  problem_2{
    single_layer_case{
        ...
        .omega        = 0.5,
        .beam         = true,
        .direct       = {0.252716, 0.0210311},
        .diffuse_down = {0, 0.0441791},
        .up           = {0.0535063, 0},
        .radiance = matrix_2x6({0, 0, 0, 0.161796, 0.0211501, 0.00786713, 0.00771897, 0.0200778, 0.0257685, 0, 0, 0})},
    single_layer_case{
        .name         = "2b",
        .depth        = 0.2,
        .omega        = 1.0,
        .beam         = true,
        .direct       = {0.252716, 0.0210311},
        .diffuse_down = {0, 0.106123},
        .up           = {0.125561, 0},
        .radiance = matrix_2x6({0, 0, 0, 0.347678, 0.0487120, 0.0189387, 0.0186027, 0.0464061, 0.0677603, 0, 0, 0})},
    single_layer_case{.name         = "2c",
                      .depth        = 5.0,
                      .omega        = 0.5,
                      .beam         = true,
                      .direct       = {0.252716, 2.56077e-28},
                      .diffuse_down = {0, 0.000251683},
                      .up           = {0.0624730, 0},
                      .radiance     = matrix_2x6(
                          {0, 0, 0, 0.162566, 0.0245786, 0.0101498, 0.000170004, 0.0000397168, 0.0000132472, 0, 0, 0})},
    single_layer_case{
        .name         = "2d",
        .depth        = 5.0,
        .omega        = 1.0,
        .beam         = true,
        .direct       = {0.252716, 0},
        .diffuse_down = {0, 0.0268008},
        .up           = {0.225915, 0},
        .radiance = matrix_2x6({0, 0, 0, 0.364010, 0.0826993, 0.0492370, 0.0105950, 0.00769337, 0.00379276, 0, 0, 0})},
};
...
inline const std::array  problem_3{
    single_layer_case{
        ...
        .omega        = 1.0,
        .beam         = true,
        .direct       = {3.14159, 1.15573},
        .diffuse_down = {0, 1.73849},
        .up           = {0.247374, 0},
        .radiance     = matrix_2x6({0, 0, 0, 0.151159, 0.101103, 0.0395460, 3.05855, 0.266648, 0.213750, 0, 0, 0})},
    single_layer_case{
        .name         = "3b",
        .depth        = 8.0,
        .omega        = 1.0,
        .beam         = true,
        .direct       = {3.14159, 0.00105389},
        .diffuse_down = {0, 1.54958},
        .up           = {1.59096, 0},
        .radiance     = matrix_2x6({0, 0, 0, 0.379740, 0.519598, 0.493302, 0.669581, 0.422350, 0.236362, 0, 0, 0})},
};
...
inline const std::array  problem_4{
    haze_l_case{.name         = "4a",
                ...
                .beam_mu      = 1.0,
                .azimuth      = {0},
                .direct       = {3.14159, 1.90547, 1.15573},
                .diffuse_down = {0, 1.17401, 1.81264},
                .up           = {0.173223, 0.111113, 0},
                .radiance     = tensor_3x6(1,
                                           {0,
                                            0,
                                            0,
                                            0.0926837,
    ...
    haze_l_case{.name         = "4b",
                ...
                .azimuth      = {0},
                .direct       = {3.14159, 1.90547, 1.15573},
                .diffuse_down = {0, 1.01517, 1.51554},
                .up           = {0.123665, 0.0788690, 0},
                .radiance     = tensor_3x6(1,
                                           {0,
                                            0,
                                            0,
    ...
    haze_l_case{
        ...
        .omega        = 0.9,
        .beam_mu      = 0.5,
        .azimuth      = {0, Constant::pi / 2, Constant::pi},
        .direct       = {1.57080, 0.577864, 0.212584},
        .diffuse_down = {0, 0.702764, 0.803294},
        .up           = {0.225487, 0.123848, 0},
        .radiance     = tensor_3x6(
            3, {0,         0,         0,          0.870812,  0.224960,  0.0227572, 0.0477016, 3.02631,   1.41195,
...
inline const scalar_case problem_5a{.name         = "5a",
                                    .omega        = 1.0,
                                    .tau          = {0.0, 32.0, 64.0},
                                    .direct       = {3.14159, 3.97856e-14, 5.03852e-28},
                                    .diffuse_down = {0.0, 2.24768, 0.479851},
                                    .up           = {2.66174, 1.76783, 0.0},
                                    .radiance     = radiance({0,
                                                              0,
                                                              0,
                                                              0.458927,
...
inline const scalar_case problem_5b{.name         = "5b",
                                    .omega        = 0.9,
                                    .tau          = {3.2, 12.8, 48.0},
                                    .direct       = {0.128058, 8.67322e-6, 4.47729e-21},
                                    .diffuse_down = {1.74767, 0.233975, 6.38345e-5},
                                    .up           = {0.270485, 0.0374252, 1.02904e-5},
                                    .radiance     = radiance({67.9623,
                                                              0.221027,
                                                              0.136619,
                                                              0.114084,
                                                              0.0873870,
...
enum class surface_type : char { black, lambertian, hapke };
...
inline const std::array problem_6{
    thermal_source_case{.name                     = "6a",
                        ...
                        .surface                  = surface_type::black,
                        .lambertian_albedo        = 0.0,
                        .hapke_parameters         = {}},
    thermal_source_case{.name                     = "6b",
                        .optical_depth            = 1.0,
                        .output_tau               = {0.0, 0.5, 1.0},
                        .single_scattering_albedo = 0.0,
                        .beam_mu                  = 0.5,
                        .beam                     = 200.0,
                        .top_isotropic            = 0.0,
    ...
    thermal_source_case{.name                     = "6c",
                        ...
                        .bottom_temperature       = 0.0,
                        .interface_temperature    = {},
                        .surface                  = surface_type::lambertian,
                        .lambertian_albedo        = 0.5,
                        .hapke_parameters         = {}},
    thermal_source_case{.name                     = "6d",
                        .optical_depth            = 1.0,
                        .output_tau               = {0.0, 0.5, 1.0},
                        .single_scattering_albedo = 0.0,
                        .beam_mu                  = 0.5,
                        ...
                        .bottom_temperature       = 0.0,
                        .interface_temperature    = {},
                        .surface                  = surface_type::hapke,
                        .lambertian_albedo        = 0.0,
                        .hapke_parameters         = {1.0, 0.06, 0.6}},
    thermal_source_case{.name                     = "6e",
                        .optical_depth            = 1.0,
                        .output_tau               = {0.0, 0.5, 1.0},
                        .single_scattering_albedo = 0.0,
                        .beam_mu                  = 0.5,
                        ...
                        .lambertian_albedo        = 0.0,
                        .hapke_parameters         = {1.0, 0.06, 0.6}},
    thermal_source_case{.name                     = "6f",
                        .optical_depth            = 1.0,
                        .output_tau               = {0.0, 0.5, 1.0},
                        .single_scattering_albedo = 0.0,
                        .beam_mu                  = 0.5,
                        .beam                     = 200.0,
                        .top_isotropic            = 100.0 / Constant::pi,
                        .top_temperature          = 250.0,
                        .top_emissivity           = 1.0,
                        .bottom_temperature       = 300.0,
                        .interface_temperature    = {},
                        .surface                  = surface_type::hapke,
    ...
    thermal_source_case{.name                     = "6g",
                        ...
                        .top_emissivity           = 1.0,
                        .bottom_temperature       = 300.0,
                        .interface_temperature    = {250.0, 300.0},
                        .surface                  = surface_type::hapke,
                        .lambertian_albedo        = 0.0,
                        .hapke_parameters         = {1.0, 0.06, 0.6}},
    thermal_source_case{.name                     = "6h",
                        .optical_depth            = 10.0,
                        .output_tau               = {0.0, 1.0, 10.0},
                        .single_scattering_albedo = 0.0,
                        .beam_mu                  = 0.5,
                        .beam                     = 200.0,
                        .top_isotropic            = 100.0 / Constant::pi,
...
inline const std::array problem_6_flux{
    flux_reference{.direct = {100.0, 100.0}, .diffuse_down = {0.0, 0.0}, .up = {0.0, 0.0}, .dfdt = {200.0, 200.0}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {0.0, 0.0, 0.0},
                   .up           = {0.0, 0.0, 0.0},
                   .dfdt         = {200.0, 73.5759, 27.0671}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {0.0, 0.0, 0.0},
                   .up           = {1.48450, 2.99914, 6.76676},
                   .dfdt         = {202.010, 77.9962, 40.6006}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {0.0, 0.0, 0.0},
                   .up           = {0.670783, 1.39084, 3.31655},
                   .dfdt         = {200.936, 75.7187, 34.5317}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {0.0, 0.0, 0.0},
                   .up           = {94.4651, 190.616, 428.806},
                   .dfdt         = {327.710, 353.897, 878.110}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {321.497, 142.493, 70.5305},
                   .up           = {97.7110, 197.247, 441.139},
                   .dfdt         = {975.154, 573.874, 1005.98}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {321.497, 304.775, 363.632},
                   .up           = {350.211, 443.254, 513.521},
                   .dfdt         = {601.025, 173.906, -7.36023}},
    flux_reference{.direct       = {100.0, 13.5335, 2.06115e-7},
                   .diffuse_down = {321.497, 255.455, 443.444},
                   .up           = {237.351, 261.131, 528.258},
                   .dfdt         = {423.780, 61.9842, 129.477}},
};
...
inline const std::array problem_7{
    scattering_thermal_case{.name                          = "7a",
                            .streams                       = 16,
                            .optical_depth                 = 1.0,
                            .single_scattering_albedo      = 0.10,
                            .asymmetry_parameter           = 0.05,
                            .atmosphere_top_temperature    = 200.0,
                            .atmosphere_bottom_temperature = 300.0,
                            .top_boundary_temperature      = 0.0,
                            .bottom_boundary_temperature   = 0.0,
                            .wavenumber_low                = 300.0,
                            .wavenumber_high               = 800.0,
                            .beam                          = 0.0,
                            .top_isotropic                 = 0.0,
                            .surface                       = surface_type::black,
                            .lambertian_albedo             = 0.0},
    scattering_thermal_case{.name                          = "7b",
                            .streams                       = 16,
                            .optical_depth                 = 100.0,
                            ...
                            .top_boundary_temperature      = 0.0,
                            .bottom_boundary_temperature   = 0.0,
                            .wavenumber_low                = 2702.99,
                            .wavenumber_high               = 2703.01,
                            .beam                          = 0.0,
                            .top_isotropic                 = 0.0,
                            .surface                       = surface_type::black,
                            .lambertian_albedo             = 0.0},
    scattering_thermal_case{.name                          = "7c",
                            .streams                       = 12,
                            .optical_depth                 = 1.0,
                            .single_scattering_albedo      = 0.50,
                            .asymmetry_parameter           = 0.80,
                            .atmosphere_top_temperature    = 300.0,
                            .atmosphere_bottom_temperature = 200.0,
                            .top_boundary_temperature      = 100.0,
                            .bottom_boundary_temperature   = 320.0,
                            .wavenumber_low                = 0.0,
                            .wavenumber_high               = 80000.0,
                            .beam                          = 200.0,
                            .top_isotropic                 = 100.0,
                            .surface                       = surface_type::black,
                            .lambertian_albedo             = 0.0},
    scattering_thermal_case{.name                          = "7d",
                            .streams                       = 12,
                            .optical_depth                 = 1.0,
                            .single_scattering_albedo      = 0.50,
                            .asymmetry_parameter           = 0.80,
                            ...
                            .top_isotropic                 = 100.0,
                            .surface                       = surface_type::lambertian,
                            .lambertian_albedo             = 1.0},
    scattering_thermal_case{.name                          = "7e",
                            .streams                       = 12,
                            .optical_depth                 = 1.0,
                            .single_scattering_albedo      = 0.50,
                            .asymmetry_parameter           = 0.80,
...
inline const std::array problem_7_flux{
    flux_reference{
        .direct = {0.0, 0.0}, .diffuse_down = {0.0, 121.204}, .up = {86.2936, 0.0}, .dfdt = {-51.3731, -541.036}},
    flux_reference{.direct       = {0.0, 0.0},
                   .diffuse_down = {0.0, 2.07786e-5},
                   .up           = {1.10949e-6, 0.0},
                   .dfdt         = {8.23219e-8, -5.06461e-6}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {319.830, 354.099, 301.334},
                   .up           = {429.572, 447.018, 594.576},
                   .dfdt         = {-80.4270, 251.589, 715.964}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {319.830, 350.555, 292.063},
                   .up           = {312.563, 268.126, 305.596},
                   .dfdt         = {-168.356, 101.251, 409.326}},
    flux_reference{.direct       = {100.0, 36.7879, 13.5335},
                   .diffuse_down = {319.830, 354.468, 302.366},
                   .up           = {440.940, 464.624, 623.842},
                   .dfdt         = {-71.6977, 266.918, 750.170}},
};
...
inline const std::array problem_8{
    layered_isotropic_case{.name                     = "8a",
                           .cumulative_tau           = {0.25, 0.5},
                           .single_scattering_albedo = {0.5, 0.3},
                           .output_tau               = {0.0, 0.25, 0.5},
                           .direct                   = {0.0, 0.0, 0.0},
                           .diffuse_down             = {1.00000, 0.722235, 0.513132},
                           .up                       = {0.0929633, 0.0278952, 0.0},
                           .radiance                 = radiance_3x4({0.318310,
                                                                     0.318310,
                                                                     0.0562566,
                                                                     0.0194423,
                                                                     0.262711,
                                                                     ...
                                                                     0.0,
                                                                     0.0})},
    layered_isotropic_case{.name                     = "8b",
                           .cumulative_tau           = {0.25, 0.5},
                           .single_scattering_albedo = {0.8, 0.95},
                           .output_tau               = {0.0, 0.25, 0.5},
                           .direct                   = {0.0, 0.0, 0.0},
                           .diffuse_down             = {1.00000, 0.795332, 0.650417},
                           .up                       = {0.225136, 0.126349, 0.0},
                           .radiance                 = radiance_3x4({0.318310,
                                                                     0.318310,
                                                                     0.123687,
                                                                     0.0495581,
                                                                     ...
                                                                     0.0,
                                                                     0.0})},
    layered_isotropic_case{.name                     = "8c",
                           .cumulative_tau           = {1.0, 3.0},
                           .single_scattering_albedo = {0.8, 0.95},
                           .output_tau               = {0.0, 1.0, 3.0},
                           .direct                   = {0.0, 0.0, 0.0},
                           .diffuse_down             = {1.00000, 0.486157, 0.159984},
                           .up                       = {0.378578, 0.243397, 0.0},
                           .radiance                 = radiance_3x4({0.318310,
                                                                     0.318310,
                                                                     0.149335,
                                                                     0.104766,
...
enum class phase_type : char { isotropic, problem_9b, henyey_greenstein };
...
inline const std::array problem_9{
    general_multilayer_case{
        .name                     = "9a",
        .phase                    = phase_type::isotropic,
        .cumulative_tau           = problem_9_cumulative_tau,
        .single_scattering_albedo = problem_9_omega,
        .output_tau               = problem_9_output_tau,
        .azimuth                  = {Constant::pi / 3.0},
        .beam_mu                  = 0.5,
        .beam                     = 0.0,
        .top_isotropic            = Constant::inv_pi,
        .thermal                  = false,
        .top_temperature          = 0.0,
        .bottom_temperature       = 0.0,
        .interface_temperature    = {},
        ...
        .surface_albedo           = 0.0,
        .direct                   = {0, 0, 0, 0, 0},
        .diffuse_down             = {1.00000, 0.355151, 0.144265, 0.00671445, 6.16968e-7},
        .up                       = {0.227973, 0.0875098, 0.0361819, 0.00219291, 0.0},
        .radiance                 = radiance_azimuth_tau_mu(
            1, {0.318310,    0.318310,    0.0998915,  0.0591345,  0.153507,   0.0509531,  0.0367006,
                0.0231903,   0.0706614,   0.0209119,  0.0148545,  0.00972307, 0.00372784, 0.00108815,
                0.000883316, 0.000594743, 2.87656e-7, 1.05921e-7, 0.0,        0.0})},
    general_multilayer_case{.name                     = "9b",
                            .phase                    = phase_type::problem_9b,
                            .cumulative_tau           = problem_9_cumulative_tau,
                            .single_scattering_albedo = problem_9_omega,
                            .output_tau               = problem_9_output_tau,
                            .azimuth                  = {Constant::pi / 3.0},
                            ...
                            .surface_albedo           = 0.0,
                            .direct                   = {0, 0, 0, 0, 0},
                            .diffuse_down             = {1.00000, 0.452357, 0.236473, 0.0276475, 7.41853e-5},
                            .up                       = {0.100079, 0.0452014, 0.0241941, 0.00416016, 0.0},
                            .radiance                 = radiance_azimuth_tau_mu(
                                1, {0.318310,   0.318310,    0.0739198,  0.0132768,  0.196609,   0.0592369, 0.0300230,
    ...
    general_multilayer_case{
        .name                     = "9c",
        .phase                    = phase_type::henyey_greenstein,
        .cumulative_tau           = problem_9_cumulative_tau,
        .single_scattering_albedo = problem_9_omega,
        .output_tau               = problem_9_output_tau,
        .azimuth                  = {Constant::pi / 3.0, 2.0 * Constant::pi / 3.0, Constant::pi},
        .beam_mu                  = 0.5,
        .beam                     = Constant::pi,
        .top_isotropic            = 1.0,
        .thermal                  = true,
        .top_temperature          = 550.0,
        .bottom_temperature       = 700.0,
        .interface_temperature    = {600.0, 610.0, 620.0, 630.0, 640.0, 650.0, 660.0},
        .wavenumber_low           = 999.0,
        .wavenumber_high          = 1000.0,
        .surface_albedo           = 0.5,
        .direct                   = {1.57080, 0.192354, 0.0235550, 9.65131e-6, 9.03133e-19},
        .diffuse_down             = {6.09217, 4.97279, 4.46616, 4.22731, 4.73767},
        .up                       = {4.68414, 4.24381, 4.16941, 4.30667, 5.11524},
        .radiance                 = radiance_azimuth_tau_mu(
...
inline const std::array  problem_13{
    albedo_transmission_reference{.name                     = "13a/13b",
                                  .cumulative_tau           = {1.0},
                                  .single_scattering_albedo = {0.99},
                                  .albedo                   = 0.54526,
                                  .transmission             = 0.84500},
    albedo_transmission_reference{.name                     = "13c/13d",
                                  .cumulative_tau           = {0.5, 1.0},
                                  .single_scattering_albedo = {0.99, 0.50},
                                  .albedo                   = 0.27620,
                                  .transmission             = 0.50332},
};

enum class brdf_type : char { hapke, cox_munk, rpv, ross_li };
...
inline const std::array problem_14{
    transparent_brdf_case{.name         = "14a",
                          .type         = brdf_type::hapke,
                          .azimuth      = {0.0, Constant::pi / 2.0, Constant::pi},
                          .direct       = 0.866025,
                          .diffuse_down = 0.0,
                          .up           = 0.180998,
                          .dfdt         = 1.37365,
                          .radiance     = radiance_3x4_phi_mu({0.0519252,
                                                               0.0517173,
                                                               0.0500654,
                                                               0.0536730,
                                                               0.0640461,
                                                               ...
                                                               0.0693954,
                                                               0.0536730})},
    transparent_brdf_case{.name         = "14b",
                          .type         = brdf_type::cox_munk,
                          .azimuth      = {0.0, Constant::pi / 4.0, Constant::pi / 2.0},
                          .direct       = 0.866025,
                          .diffuse_down = 0.0,
                          .up           = 0.0203449,
                          .dfdt         = 1.03199,
                          .radiance     = radiance_3x4_phi_mu({0.0169062,
                                                               0.0164195,
                                                               0.0268003,
                                                               0.00985518,
                                                               0.000160887,
                                                               ...
                                                               3.22034e-5,
                                                               0.00985518})},
    transparent_brdf_case{.name         = "14c",
                          .type         = brdf_type::rpv,
                          .azimuth      = {0.0, Constant::pi / 2.0, Constant::pi},
                          .direct       = 0.866025,
                          .diffuse_down = 0.0,
                          .up           = 0.148584,
                          .dfdt         = 1.32427,
                          .radiance     = radiance_3x4_phi_mu({0.0466076,
                                                               0.0388121,
                                                               0.0333376,
                                                               0.0477098,
                                                               0.0590715,
                                                               ...
                                                               0.0614060,
                                                               0.0477098})},
    transparent_brdf_case{.name         = "14d",
                          .type         = brdf_type::ross_li,
                          .azimuth      = {0.0, Constant::pi / 2.0, Constant::pi},
                          .direct       = 0.866025,
                          .diffuse_down = 0.0,
                          .up           = 0.213718,
                          .dfdt         = 1.38147,
                          .radiance     = radiance_3x4_phi_mu({0.0142562,
                                                               0.0441596,
                                                               0.0611839,
                                                               0.0727943,
                                                               0.0385329,
...
inline const std::array problem_15{
    layered_brdf_case{
        .name         = "15a",
        .type         = brdf_type::hapke,
        .direct       = {0.866025, 0.545681, 0.413603},
        .diffuse_down = {0.0, 0.221186, 0.338138},
        .up           = {0.277760, 0.178593, 0.163465},
        .dfdt         = {1.91452e-6, 1.80279e-6, 1.74169e-6},
        .radiance     = radiance_3x3x4(
            {0.123554,  0.112727,  0.0833376, 0.0788616, 0.0978420, 0.0764028, 0.0540164, 0.0513113, 0.0555814,
             0.0530299, 0.0479406, 0.0469991, 0.113583,  0.107286,  0.0890993, 0.0788616, 0.0758666, 0.0687194,
             0.0570572, 0.0513113, 0.0641686, 0.0606886, 0.0534627, 0.0469992, 0.131842,  0.126113,  0.110240,
             0.0788616, 0.0767841, 0.0736885, 0.0689669, 0.0513113, 0.0739453, 0.0696550, 0.0610954, 0.0469991})},
    layered_brdf_case{.name         = "15b",
                      .type         = brdf_type::cox_munk,
                      .direct       = {0.866025, 0.545681, 0.413603},
                      .diffuse_down = {0.0, 0.190697, 0.302160},
                      .up           = {0.173025, 0.0433759, 0.0227533},
                      .dfdt         = {1.68943e-6, 1.38905e-6, 1.27981e-6},
                      .radiance     = radiance_3x3x4(
                          {0.105039,  0.0919789,  0.0596677,  0.0442653,  0.0728008, 0.0502279,  0.0272793,  0.0114839,
    ...
    layered_brdf_case{
        ...
        .type         = brdf_type::rpv,
        .direct       = {0.866025, 0.545681, 0.413603},
        .diffuse_down = {0.0, 0.214201, 0.330068},
        .up           = {0.254555, 0.148380, 0.132172},
        .dfdt         = {1.86327e-6, 1.70778e-6, 1.65841e-6},
        .radiance     = radiance_3x3x4(
            {0.119166,  0.107082,  0.0741418, 0.0726226, 0.0900393, 0.0659806, 0.0405345, 0.0445512, 0.0494497,
             0.0405951, 0.0333681, 0.0404333, 0.109205,  0.101727,  0.0806139, 0.0726226, 0.0684651, 0.0586094,
             0.0448932, 0.0445511, 0.0582113, 0.0482087, 0.0403103, 0.0404332, 0.127564,  0.120988,  0.103628,
             0.0726226, 0.0710388, 0.0656529, 0.0604316, 0.0445511, 0.0713241, 0.0598879, 0.0521536, 0.0404332})},
    layered_brdf_case{
        .name         = "15d",
        .type         = brdf_type::ross_li,
        .direct       = {0.866025, 0.545681, 0.413603},
        .diffuse_down = {0.0, 0.225389, 0.342092},
        .up           = {0.297775, 0.202805, 0.187433},
        .dfdt         = {1.95071e-6, 1.84998e-6, 1.77781e-6},
        .radiance     = radiance_3x3x4(
            {0.126062,  0.114608,  0.0879932, 0.0899278, 0.0934865, 0.0733495, 0.0602902, 0.0654998, 0.0278309,
             0.0454440, 0.0549975, 0.0619027, 0.116114,  0.109216,  0.0929265, 0.0899278, 0.0730116, 0.0661578,
             0.0617029, 0.0654998, 0.0454126, 0.0541580, 0.0585154, 0.0619027, 0.134402,  0.128103,  0.113285,
             0.0899278, 0.0757499, 0.0717037, 0.0720841, 0.0654998, 0.0643650, 0.0640986, 0.0642596, 0.0619027})},
};
}  // namespace disort_test::reference
