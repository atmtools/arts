...
struct real_diagonalize_workdata {
  ...
  real_diagonalize_workdata& operator=(const real_diagonalize_workdata&)     = default;
  real_diagonalize_workdata& operator=(real_diagonalize_workdata&&) noexcept = default;
};
