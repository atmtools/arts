...
/*! 
 ...
 \date   Fri May  3 08:55:51 2002
*/
void interp(StridedTensor6View ia,
            StridedConstTensor7View itw,
            StridedConstTensor6View a,
            const ArrayOfGridPos& vgp,
            const ArrayOfGridPos& sgp,
            const ArrayOfGridPos& bgp,
...
void polint(Numeric& y_int,
            Numeric& dy_int,
            StridedConstVectorView xa,
            StridedConstVectorView ya,
            const Index& n,
            const Numeric& x) {
  Index ns = 1;
...
/*! 
  ...
  \date 2004-03-17
*/
Numeric interp_poly(StridedConstVectorView x,
