    ...
    for (Index i_se = 0; i_se < N_se; i_se++) {
      ...
      if (pnd_vec[i_se_flat] != 0) {
        ...
        if (nT > 1) {
          ...
          Numeric uplim =
              scat_data_mono[i_ss][i_se].T_grid[nT - 1] +
          ...
          if (rtp_temperature < lowlim || rtp_temperature > uplim) {
            ...
            os << "Atmospheric temperature (" << rtp_temperature
               ...
               << "range of particle optical properties (" << lowlim << "-"
               << uplim << "K) of scattering element #" << i_se << ".\n";
            throw runtime_error(os.str());
          }
        }
        opt_propExtract(ext_mat_mono_spt,
                        abs_vec_mono_spt,
...
void opt_propExtract(MatrixView ext_mat_mono_spt,
                     ...
                     const Numeric za,
                     const Numeric aa
                         _U_,  // avoid warning until we use ptype=10
                     const Numeric rtp_temperature,
                     const Index stokes_dim,
                     const Verbosity& verbosity) {
  ...
  switch (scat_data_single.ptype) {
    ...
    case PTYPE_TOTAL_RND: {
      ...
      // Temperature interpolation
        ...
        ext_mat_mono_spt(0, 0) =
            interp(itw, scat_data_single.ext_mat_data(0, joker, 0, 0, 0), t_gp);
        abs_vec_mono_spt[0] =
            interp(itw, scat_data_single.abs_vec_data(0, joker, 0, 0, 0), t_gp);
      }
    ...
    case PTYPE_AZIMUTH_RND: {
      ...
      assert(scat_data_single.za_grid.nelem() ==
             scat_data_single.ext_mat_data.npages());
      ...
      if (scat_data_single.T_grid.nelem() == 1) {
        ...
        Kjj = interp(
            itw, scat_data_single.ext_mat_data(0, 0, joker, 0, 0), za_gp);
        abs_vec_mono_spt[0] = interp(
            itw, scat_data_single.abs_vec_data(0, 0, joker, 0, 0), za_gp);
      } else {
        itw.resize(4);
        interpweights(itw, t_gp, za_gp);
        Kjj = interp(itw,
                     scat_data_single.ext_mat_data(0, joker, joker, 0, 0),
                     t_gp,
                     za_gp);
        abs_vec_mono_spt[0] =
            interp(itw,
                   scat_data_single.abs_vec_data(0, joker, joker, 0, 0),
                   t_gp,
                   za_gp);
      }
      ...
      if (scat_data_single.T_grid.nelem() == 1) {
        K12 = interp(
            itw, scat_data_single.ext_mat_data(0, 0, joker, 0, 1), za_gp);
        abs_vec_mono_spt[1] = interp(
            itw, scat_data_single.abs_vec_data(0, 0, joker, 0, 1), za_gp);
      } else {
        K12 = interp(itw,
                     scat_data_single.ext_mat_data(0, joker, joker, 0, 1),
                     t_gp,
                     za_gp);
        abs_vec_mono_spt[1] =
            interp(itw,
                   scat_data_single.abs_vec_data(0, joker, joker, 0, 1),
                   t_gp,
                   za_gp);
      }
      ...
      if (scat_data_single.T_grid.nelem() == 1)
        K34 = interp(
            itw, scat_data_single.ext_mat_data(0, 0, joker, 0, 2), za_gp);
      else
        K34 = interp(itw,
                     scat_data_single.ext_mat_data(0, joker, joker, 0, 2),
                     t_gp,
                     za_gp);
...
void pha_mat_singleCalc(
  ...
  pha_mat_singleCalcScatElement(Zelem,
                                za_sca,
                                aa_sca,
                                za_inc,
                                aa_inc,
...
void pha_mat_singleExtract(MatrixView Z_spt,
  ...
  switch (scat_data_single.ptype) {
    ...
    case PTYPE_TOTAL_RND: {
      ...
      interp_scat_angle_temperature(pha_mat_int,
                                    theta_rad,
                                    scat_data_single,
                                    za_sca,
                                    aa_sca,
      ...
      pha_mat_labCalc(
          Z_spt, pha_mat_int, za_sca, aa_sca, za_inc, aa_inc, theta_rad);
    ...
    case PTYPE_AZIMUTH_RND:
      ...
      //a little.  Details elsewhere.
      {
        ...
        Numeric delta_aa = aa_sca - aa_inc + (aa_sca - aa_inc < -180) * 360 -
                           (aa_sca - aa_inc > 180) *
                               360;  //delta_aa corresponds to the "pages"
        ...
        if (scat_data_single.T_grid.nelem() == 1) {
          ...
          Z_spt(0, 0) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 0),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
        } else {
        ...
        if (scat_data_single.T_grid.nelem() == 1) {
          Z_spt(0, 1) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 1),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
          Z_spt(1, 0) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 4),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
          Z_spt(1, 1) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 5),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
        } else {
          Z_spt(0, 1) = interp(itw,
                               scat_data_single.pha_mat_data(
        ...
        if (delta_aa >= 0) {
          if (scat_data_single.T_grid.nelem() == 1) {
            Z_spt(0, 2) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 2),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(1, 2) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 6),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(2, 0) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 8),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(2, 1) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 9),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
          } else {
            Z_spt(0, 2) = interp(itw,
                                 scat_data_single.pha_mat_data(
        ...
        if (scat_data_single.T_grid.nelem() == 1)
          Z_spt(2, 2) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 10),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
        else
          Z_spt(2, 2) = interp(itw,
                               scat_data_single.pha_mat_data(
        ...
        if (delta_aa >= 0) {
          if (scat_data_single.T_grid.nelem() == 1) {
            Z_spt(0, 3) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 3),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(1, 3) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 7),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(3, 0) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 12),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
            Z_spt(3, 1) = interp(
                itw,
                scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 13),
                za_sca_gp,
                delta_aa_gp,
                za_inc_gp);
          } else {
            Z_spt(0, 3) = interp(itw,
                                 scat_data_single.pha_mat_data(
        ...
        if (scat_data_single.T_grid.nelem() == 1) {
          Z_spt(2, 3) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 11),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
          Z_spt(3, 2) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 14),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
          Z_spt(3, 3) = interp(
              itw,
              scat_data_single.pha_mat_data(0, 0, joker, joker, joker, 0, 15),
              za_sca_gp,
              delta_aa_gp,
              za_inc_gp);
        } else {
          Z_spt(2, 3) = interp(itw,
                               scat_data_single.pha_mat_data(
