...
/*!
  ...
  <dd> Generally Hitran convention, unless otherwise indicated.
       ...
       <tr>
       <td> 3: <td> jpl isotopologue ratio is multiplied with the maximum isotopologue ratio
                    of this species found in hitran. is only performed when
                    isotopologue ratios of 1 were found in the jpl catalogue.
       </table>
...
void define_basic_species_data()
{
  ...
  */
  ...
  // Isotopologue Ratios: 1 1 1 1 1 1 1 1
  species_data.push_back
    ( SpeciesRecord
      ( NAME("CO2"),
        DEGFR(2),
  ...
  // 2009-6-10 SAB Added Isotopologue 312, which is new in HITRAN08.
...
//         REC("312"      ,6.91785E-06     ,18.040830      ,-1     ,64     ,TAGS())
  ...
  // CH3CN
  // Isotopologue Ratios: 2 2 2 2 2
  // Note: Isotopologue ratio of 1.0 was found in JPL catalogue for main, 
  // isotopologue, the value given here is determinded by subtracting the other
  // isotopologue ratios found in JPL from 1.0
  species_data.push_back
    ( SpeciesRecord
      ( NAME("CH3CN"),
        DEGFR(3),
