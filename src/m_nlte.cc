...
/* Workspace method: Doxygen documentation will be auto-generated */
void ArrayOfQuantumIdentifierFromLines2(
    ArrayOfQuantumIdentifier& qid,
...
/* Workspace method: Doxygen documentation will be auto-generated */
void nlte_fieldRescalePopulationLevels2(EnergyLevelMap& nlte_field,
                                       const Numeric& scale,
                                       const Verbosity&) {
...
/* Workspace method: Doxygen documentation will be auto-generated */
void nlte_fieldForSingleSpeciesNonOverlappingLines2(
    Workspace& ws,
    ...
    const Verbosity& verbosity)
{
  ...
  while (i < iteration_limit and max_change > convergence_limit) {
    ...
    //     //Compute radiation and transmission
    line_irradianceCalcForSingleSpeciesNonOverlappingLinesPseudo2D2(
        ws,
        line_irradiance,
        line_transmission,
        abs_species,
