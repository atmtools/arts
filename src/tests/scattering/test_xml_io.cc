...
bool test_serialize_sht() {
  ...
  if (sht_other.get_l_max() != sht.get_l_max()) { return false; }
  if (sht_other.get_m_max() != sht.get_m_max()) { return false; }
  if (sht_other.get_n_azimuth_angles() != sht.get_n_azimuth_angles()) { return false; }
  if (sht_other.get_n_zenith_angles() != sht.get_n_zenith_angles()) { return false; }
  return true;
}
...
template <typename Quadrature> bool test_serialize_quadrature_grid() {
  Quadrature grid(10);
