...
#define TMPL_NC_READ_WRITE_FILE(what) \
  void nc_write_to_file (const String&, const what&);
...
TMPL_NC_READ_WRITE_FILE( GField1 )
TMPL_NC_READ_WRITE_FILE( GField2 )
TMPL_NC_READ_WRITE_FILE( GField3 )
TMPL_NC_READ_WRITE_FILE( GField4 )
...
TMPL_NC_READ_WRITE_FILE( ArrayOfArrayOfGField1 )
TMPL_NC_READ_WRITE_FILE( ArrayOfArrayOfGField3 )
...
TMPL_NC_READ_WRITE_FILE( ArrayOfGField1 )
TMPL_NC_READ_WRITE_FILE( ArrayOfGField2 )
TMPL_NC_READ_WRITE_FILE( ArrayOfGField3 )
TMPL_NC_READ_WRITE_FILE( ArrayOfGField4 )
...
#undef TMPL_NC_READ_WRITE_STREAM
