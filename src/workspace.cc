   ...
   (WsvRecord
    ( NAME( "pnd_field_raw" ),
      ...
      (
       ...
       "\n"
       "Usage: Set by the user. Input to methods *ParticleTypeAdd* and \n"
       "       *ParticleTypeAddAll*\n"
       "\n"
       "Unit:  m^-3\n"
       "\n"
     ...
     (WsvRecord
      ( NAME( "scat_meta" ),
        ...
        (
         ...
         "scattering species, e.g., by *particle_massesFromMetaDataAndScat_species*.\n"
         "\n"
   ...
   (WsvRecord
    ( NAME( "sensor_pol" ),
      ...
      (
       ...
       "   9 = Irhc, intensity of left-hand circularly polarised component.\n"
       "  10 = Ilhc, intensity of right-hand circularly polarised component.\n"
       "\n"
