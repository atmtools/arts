...
*/
  ...
  wsv_data.push_back(WsvRecord(
      NAME("aa_grid"),
      DESCRIPTION(R"--(Azimuthal angle grid.
...
Unit:       degrees
  ...
  wsv_data.push_back(WsvRecord(
      NAME("aa_index"),
      DESCRIPTION(R"--(Azimuth angle index for scattering calculations.
...
Usage:    Method output.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_cia_data"),
      DESCRIPTION(R"--(HITRAN Collision Induced Absorption (CIA) Data.
...
Units:
 ...
 - Binary absorption cross-sections: m^5*molecule^-2
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Frequency interpolation order for absorption lookup table.
...
the lookup table. This is the global default value.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(HITRAN line mixing data to compute the relaxation matrix.
...
It is used for absorption bands with these population tags:
 ...
 - ByHITRANRosenkranzRelmat
  ...
  wsv_data.push_back(WsvRecord(NAME("abs_lines"),
                               DESCRIPTION(R"--(A list of spectral line data.
)--"),
                               GROUP("ArrayOfAbsorptionLines")));

  wsv_data.push_back(WsvRecord(
      NAME("abs_lines_per_species"),
      DESCRIPTION(R"--(A list of spectral line data for each tag.
...
Dimensions: [*abs_species*.nelem()][Depends on how many bands there are in *abs_lines*]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_lookup"),
      DESCRIPTION(R"--(An absorption lookup table.
...
documentation in gas_abs_lookup.h.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_nls"),
      DESCRIPTION(R"--(Nonlinear species for absorption lookup table generation.
...
for more details and usage examples.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_nls_pert"),
      DESCRIPTION(R"--(Fractional perturbations for the nonlinear species in the absorption
lookup table.
...
(This is similar to *abs_t_pert*, but multiplicative, not additive.)
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The interpolation order to use when interpolating absorption between
...
interpolation order + 1 (e.g., two for first order interpolation).
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The interpolation order to use when interpolating absorption
...
interpolation order + 1 (e.g., two for first order interpolation).
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_t_pert"),
      DESCRIPTION(R"--(Temperature perturbations for the absorption lookup table.
...
interpolation order + 1 (e.g., two for first order interpolation).
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to indicate whether *abs_lookupAdapt* has already been
called.
...
Values:
 - 0=false - 1=true.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_p"),
      DESCRIPTION(R"--(List of pressures to be used for the calculation of absorption
coefficients.
...
Unit: Pa
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_species"),
      DESCRIPTION(R"--(Tag groups for gas absorption.
...
more detailed information how tag groups work and some examples.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_t"),
      DESCRIPTION(R"--(List of temperatures to be used for the calculation of absorption
coefficients.
...
Unit: K
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_vec"),
      DESCRIPTION(R"--(Total absorption vector.
...
Dimensions: [f_grid, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_vec_spt"),
      DESCRIPTION(R"--(Absorption vectors of the scattering elements.
...
Dimensions: [number of scattering elements, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("abs_vmrs"),
      DESCRIPTION(R"--(The VMRs (unit of absolute number) on the abs_p grid.
...
Dimensions: [tag_groups.nelem(), abs_p.nelem()]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Index of the current agenda in *ArrayOfAgenda*.
...
Unit:  Integer value.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("antenna_dim"),
      DESCRIPTION(R"--(The dimensionality of the antenna pattern (1-2).
...
Unit:  Integer value [1-2].
  ...
  wsv_data.push_back(WsvRecord(
      NAME("antenna_dlos"),
      DESCRIPTION(R"--(The relative line-of-sight of each antenna pattern.
...
Size:  [ number of antennae, 1 or 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The antenna pattern/response.
...
See *atm_field* for the data that may be available in the atmospheric point.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(OK-flag for atmospheric grids and (physical) fields.
...
WSVs. Only the value 1 is taken as OK.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(OK-flag for the geometry of the model atmosphere.
...
as OK.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(A compact set of atmospheric fields on a common set of grids.
...
- GriddedField4:
  ...
  wsv_data.push_back(WsvRecord(
      NAME("avk"),
      DESCRIPTION(R"--(Averaging kernel matrix.
...
Usage: Used and set by inversion methods.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The response of each backend channel.
...
- Array[N_ch]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(As *backend_channel_response* but describes an instrument with
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(An array of compact atmospheric states.
...
calculations. For further information see *atm_fields_compact*.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(An array of identifiers for bands.
...
line database.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(An array of *cloudbox_limits*.
...
calculations.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(An array of compact pnd states.
...
calculations.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Definition of backend frequency response, link to *f_grid*.
...
look like: [[0,5],[1,4],[2,3],[7,8],[7,8]].
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Definition of backend frequency response, weighting of *f_grid*.
...
monochromatic frequency.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(OK-flag for variables associated with the cloudbox.
...
value 1 is taken as OK.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("cloudbox_field"),
      DESCRIPTION(R"--(The spectral radiance field inside the cloudbx.
...
dimension (N_aa) are all 1.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Monochromatic radiation field inside the cloudbox.
...
always 1.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(As *cloudbox_field_mono* but from previous iteration.
...
Size:
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The limits of the cloud box.
...
Size:  [ 2 * atmosphere_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("cloudbox_on"),
      DESCRIPTION(R"--(Flag to activate the cloud box.
...
Unit:  Boolean.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Complex refractive index (n) data.
...
Dimensions: 
 ...
 - Tensor3 data[N_f][N_T][2]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("covmat_block"),
      DESCRIPTION(R"--(Holds matrices used to set blocks in *covmat_sx* and *covmat_se*.
...
Usage:   Used by the retrievalAdd functions.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Holds matrices used to set the inverse blocks in *covmat_sx* and *covmat_se*.
...
Usage:   Used by the retrievalAdd functions.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("covmat_se"),
      DESCRIPTION(R"--(Covariance matrix for observation uncertainties.
...
Dimensions: [ y, y ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("covmat_sx"),
      DESCRIPTION(R"--(Covariance matrix of a priori distribution
...
Dimensions: 
  ...
  wsv_data.push_back(WsvRecord(
      NAME("covmat_so"),
      DESCRIPTION(R"--(Covariance matrix describing the retrieval error due to uncertainties of
...
Dimensions:
  ...
  wsv_data.push_back(WsvRecord(
      NAME("covmat_ss"),
      DESCRIPTION(R"--(Covariance matrix describing the retrieval error due to smoothing.
...
Dimensions:
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Depolarization factor for the scattered gas.
...
O2=0.06, CO2=0.09 and atmospheric air=0.03.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("disort_aux"),
      DESCRIPTION(R"--(Auxilary data to the output of the cloudbox_fieldDisort-Methods.
...
Dimensions: [quantity][ f_grid, number of disort levels/layers ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Selection of quantities for *disort_aux*.
...
The possible choices vary between the Disort methods. See the WSM you select
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dlos"),
      DESCRIPTION(R"--(A set of relative angles.
...
- (-90,45) -> (0,undefined)
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(A weight associated with each direction *dlos*.
...
row in *dlos* covers.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda defining the calculations to perform for each batch case.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("dobatch_cloudbox_field"),
      DESCRIPTION(R"--(Batch of radiation fields.
...
Dimensions: Number of array elements equals number of batch cases.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Batch of radiance fields.
...
Dimensions: Number of array elements equals number of batch cases.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Batch of irradiance fields.
...
Dimensions: Number of array elements equals number of batch cases.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Batch of spectral irradiance fields.
...
Dimensions: Number of array elements equals number of batch cases.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("diy_dx"),
      DESCRIPTION(R"--(Derivative of *iy* with respect to retrieval quantities.
...
The variable is defined along the path and has size: 
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dpnd_data_dx"),
      DESCRIPTION(R"--(Partial derivates of *pnd_data*.
...
Dimensions: [ n_quantities, n_points, n_scattering_elements ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Selection of partial derivatives of *pnd_data*.
...
Dimensions: [ n_quantities ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dpnd_field_dx"),
      DESCRIPTION(R"--(Partial derivatives of *pnd_field*.
...
Unit: 1/m/jacobian_quantity
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dpsd_data_dx"),
      DESCRIPTION(R"--(Partial derivates of *psd_data*.
...
Dimensions: [ n_quantities, n_points, n_scattering_elements ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(NLTE partial derivatives output is two parts:  S * dB/dx + dS/dx * B.
...
Unit: 1/m/jacobian_quantity
  ...
  wsv_data.push_back(WsvRecord(
      NAME("doit_conv_flag"),
      DESCRIPTION(R"--(Flag for the convergence test.
...
Usage: Method output.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("doit_conv_test_agenda"),
                DESCRIPTION(R"--(Agenda executing the DOIT convergence test.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("doit_is_initialized"),
      DESCRIPTION(R"--(Flag to determine if *DoitInit* was called.
...
*DoitInit* was called before.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("doit_iteration_counter"),
                DESCRIPTION(R"--(Counter for number of iterations.
...
while solving the VRTE using the DOIT method.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda performing monochromatic DOIT calculation.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("doit_rte_agenda"),
      DESCRIPTION(R"--(Agenda performing the DOIT cloudbox radiative transfer update.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("doit_scat_field_agenda"),
      DESCRIPTION(R"--(Agenda calculating the scattering integral field in DOIT.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("doit_scat_field"),
      DESCRIPTION(R"--(Scattered field inside the cloudbox.
...
Size:
  ...
  wsv_data.push_back(
      WsvRecord(NAME("doit_za_grid_opt"),
                DESCRIPTION(R"--(Optimized zenith angle grid.
...
Unit:    degrees
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Number of equidistant grid points of the zenith angle grid.
...
Usage: Output of *DOAngularGridsSet*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("doit_za_interp"),
      DESCRIPTION(R"--(Flag for interplation method in zenith angle dimension.
...
Usage: Set by user in *doit_za_interpSet*.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The derivative of *surface_emission* with respect to quantities
...
Dimensions: [dsurface_names][f_grid, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dsurface_names"),
      DESCRIPTION(R"--(Name of surface retrieval quantities.
...
Dimensions: [retrieval quantity]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The derivative of *surface_rmatrix* with respect to quantities
listed in *dsurface_names*.
...
Dimensions: [dsurface_names][surface_los, f_grid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("dxdy"),
      DESCRIPTION(R"--(Contribution function (or gain) matrix.
...
Usage: Used and set by inversion methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ecs_data"),
      DESCRIPTION(R"--(Error corrected sudden data
...
It is used for absorption bands with these population tags:
 ...
 - ByRovibLinearDipoleLineMixing
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ext_mat"),
      DESCRIPTION(R"--(Total extinction matrix.
...
Dimensions: [f_grid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ext_mat_spt"),
      DESCRIPTION(R"--(Extinction matrix for all individual scattering elements.
...
Dimensions: [number of scattering elements, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("file_index"),
      DESCRIPTION(R"--(Index number for files.
...
Usage:   Input to *WriteXMLIndexed* and *ReadXMLIndexed*.
  ...
  wsv_data.push_back(WsvRecord(NAME("forloop_agenda"),
                               DESCRIPTION(R"--(Agenda performing a for loop.
)--"),
                               GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("forloop_index"),
      DESCRIPTION(R"--(The index for for-loops.
...
*forloop_agenda*.
  ...
  wsv_data.push_back(WsvRecord(NAME("fos_iyin_za_angles"),
                               DESCRIPTION(R"--(So far just testing of FOS ...
)--"),
                               GROUP("Vector")));
  ...
  wsv_data.push_back(WsvRecord(
      NAME("f_backend"),
      DESCRIPTION(R"--(The frequency position of each backend (spectrometer) channel.
...
Unit:  Hz
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(As *f_backend* but describes an instrument with muliple
...
Unit:  Hz
  ...
  wsv_data.push_back(WsvRecord(
      NAME("f_grid"),
      DESCRIPTION(R"--(The frequency grid for monochromatic pencil beam calculations.
...
Usage: Method output.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to activate gas scattering.
...
even if the gas_scattering_agenda is set.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to select the output of the *gas_scattering_agenda*.
...
If equals 1 *gas_scattering_fct_legendre* is output and *gas_scattering_mat* is empty.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda calculating gas scattering extinction and phase matrix.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Incoming line-of-sight for gas scattering.
...
Size:  [ 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Outgoing line-of-sight for gas scattering.
...
Size:  [ 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Spectrum of scattering coefficient matrices.
...
Size:  [fgrid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Spectrum of normalized phase matrices.
...
Size:  [fgrid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Normalized phase function as Legendre series.
...
Size:  [Number of Legendre polynomials]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("geo_pos"),
      DESCRIPTION(R"--(Geo-position of a measurement.
...
Unit:  [ m, deg, deg, deg, deg ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("g0"),
      DESCRIPTION(R"--(Gravity at zero altitude.
...
for Earth this is a value around 9.81 m/s2
  ...
  wsv_data.push_back(
      WsvRecord(NAME("g0_agenda"),
                DESCRIPTION(R"--(Agenda providing the gravity constant.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("heating_rates"),
      DESCRIPTION(R"--(The heating rates of atmospheric layers.
...
Size: [ p_grid, lat_grid, lon_grid ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("xsec_fit_data"),
      DESCRIPTION(R"--(Fitting model coefficients for cross section species.
...
are not used to apply the model and solely serve for informational purposes.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("instrument_pol"),
      DESCRIPTION(R"--(Definition of the polarisation of an instrument.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Multiple definition of instrument polarisation.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Iteration counter variable for *inversion_iterate_agenda*.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("inversion_iterate_agenda"),
      DESCRIPTION(R"--(Agenda recalculating spectra and Jacobian for iterative inversion methods.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("irradiance_field"),
      DESCRIPTION(R"--(Irradiance field also known as flux density.
...
This variable is set to the default provided by *isotopologue_ratiosInitFromBuiltin*
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy"),
      DESCRIPTION(R"--(Monochromatic pencil beam radiance spectrum.
...
Dimensions: [ f_grid, stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iyb"),
      DESCRIPTION(R"--(Monochromatic pencil beam data for one measurement block.
...
Dimensions:
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to handle recursive calls of *iy_main_agenda*
...
file (which should be a rare case).
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_aux"),
      DESCRIPTION(R"--(Data auxiliary to *iy*.
...
Dimensions: [quantity][ f_grid, stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_aux_vars"),
      DESCRIPTION(R"--(Selection of quantities for *iy_aux* and when applicable also *y_aux*.
...
along-the-path variables.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda deriving the intensity at boundary or interior of the cloudbox.
)--"),
      GROUP("Agenda")));
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_id"),
      DESCRIPTION(R"--(Identification number of *iy*.
...
or keeps its value set by *yCalc*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_main_agenda"),
      DESCRIPTION(R"--(Agenda calculating the single monochromatic pencil beam spectrum.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("iy_radar_agenda"),
      DESCRIPTION(R"--(Agenda calculating pointwise backscattering.
)--"),
      GROUP("Agenda")));
  
  wsv_data.push_back(WsvRecord(
      NAME("iy_space_agenda"),
      DESCRIPTION(R"--(Agenda providing the downwelling radiation at the top of the atmosphere.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("iy_surface_agenda"),
      DESCRIPTION(R"--(Agenda providing the upwelling radiation from the surface.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("iy_transmittance"),
      DESCRIPTION(R"--(Transmittance to be included in *iy*.
...
Dimensions: [ f_grid, stokes_dim, stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_transmitter"),
      DESCRIPTION(R"--(Monochromatic pencil beam radiance spectrum of transmitter signal.
...
Dimensions: [ f_grid, stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_unit"),
      DESCRIPTION(R"--(Selection of output unit for radiative transfer methods.
...
(e.g., ``iyEmissionStandard``, *iyMC* and the like).
  ...
  wsv_data.push_back(WsvRecord(
      NAME("iy_unit_radar"),
      DESCRIPTION(R"--(Unit for radar simulations.
...
See the radar methods for allowed options.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("jacobian"),
      DESCRIPTION(R"--(The Jacobian matrix.
...
Dimension: [ y, number of retrieval quantities and grids ]
  ...
  wsv_data.push_back(
      WsvRecord(NAME("jacobian_agenda"),
                DESCRIPTION(R"--(Pure numerical Jacobian calculation agenda.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("jacobian_do"),
      DESCRIPTION(R"--(Flag to activate (clear-sky) Jacobian calculations.
...
Needs to be 0 if cloudy-sky (Doit) Jacobians shall be calculated.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The retrieval quantities in the Jacobian matrix.
...
Usage: Quantities are added by the jacobianAdd WSMs.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The partial derivatives that are computed for the Jacobian matrix.
...
Unit:  degrees
  ...
  wsv_data.push_back(WsvRecord(
      NAME("lat_true"),
      DESCRIPTION(R"--(Latitudinal geolocation for 1D and 2D data.
...
Unit:  degrees
  ...
  wsv_data.push_back(WsvRecord(
    NAME("lbl_checked"),
      DESCRIPTION(R"--(Flag to check if the line-by-line calculations will work
...
Unit:  Boolean
  ...
  wsv_data.push_back(
      WsvRecord(NAME("line_irradiance"),
                DESCRIPTION(R"--(Irradiance as seen by a single absorption line.
...
Used internally for, e.g., NLTE effects
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Transmission as seen by a single absorption line.
...
Used internally for, e.g., NLTE effects
  ...
  wsv_data.push_back(WsvRecord(
      NAME("lo"),
      DESCRIPTION(R"--(The local oscillator frequency.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("lo_multi"),
      DESCRIPTION(R"--(Local oscillator frequencies.
...
Unit:  degrees
  ...
  wsv_data.push_back(WsvRecord(
      NAME("lon_true"),
      DESCRIPTION(R"--(Longitudinal geolocation for 1D and 2D data.
...
Unit:  degrees
  ...
  wsv_data.push_back(WsvRecord(
      NAME("main_agenda"),
      DESCRIPTION(R"--(Agenda corresponding to the entire controlfile.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("mblock_dlos"),
      DESCRIPTION(R"--(The set of angular pencil beam directions for each measurement block.
...
Unit:  degrees
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mblock_index"),
      DESCRIPTION(R"--(Measurement block index. 
...
Usage: Used internally.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_antenna"),
      DESCRIPTION(R"--(Antenna pattern description for dedicated MC calculaions.
...
Usage: Input to MCGeneral. Set by *mc_antennaSetGaussian* and similar methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_error"),
      DESCRIPTION(R"--(Error in simulated *y* when using a Monte Carlo approach.
...
Size:  [ stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Counts the number of iterations (or photons) used in the MC
...
Usage: Set by MCGeneral and other MC methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_max_iter"),
      DESCRIPTION(R"--(The maximum number of iterations allowed for Monte Carlo
calculations.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The maximum scattering order allowed for Monte Carlo
radar calculations.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_max_time"),
      DESCRIPTION(R"--(The maximum time allowed for Monte Carlo calculations.
...
Unit: s
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_min_iter"),
      DESCRIPTION(R"--(The minimum number of iterations allowed for Monte Carlo
calculations.
...
Usage: Set by MCGeneral and other MC methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_scat_order"),
      DESCRIPTION(R"--(Number of atmospheric scattering events between emission point and sensor.
...
Usage: Set by MCGeneral and other MC methods.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Rough classification of source to emission.
...
Usage: Set by MCGeneral and other MC methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_seed"),
      DESCRIPTION(R"--(The integer seed for the random number generator used by
Monte Carlo methods.
...
Usage: Set by MCSetSeed.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_std_err"),
      DESCRIPTION(R"--(Target precision (1 std. dev.) for Monte Carlo calculations.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("mc_y_tx"),
      DESCRIPTION(R"--(Normalized Stokes vector for transmittance (e.g., radar).
...
Size:  [ stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Defines an upper step length in terms of optical thickness for Monte 
Carlo calculations.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("met_amsu_data"),
      DESCRIPTION(R"--(The AMSU data set.
...
See documentation of WSM ``ybatchMetProfiles`` for more information.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("met_mm_antenna"),
      DESCRIPTION(R"--(The antenna beam width for meteorological millimeter instruments.
...
Size:  [ number of channels ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("met_mm_backend"),
      DESCRIPTION(R"--(Backend description for meteorological millimeter sensors with passbands.
...
Size: [number of channels, 4]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The polarisation for meteorological millimeter instruments.
...
Size:  [ number of channels ]
  ...
  wsv_data.push_back(
      WsvRecord(NAME("met_profile_calc_agenda"),
                DESCRIPTION(R"--(Agenda for metoffice profile calculations.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("level0_data"),
      DESCRIPTION(R"--(List of L0 data.  Can be of any type.
It is method-dependent how this is used to calibrated to L1
  ...
  wsv_data.push_back(WsvRecord(
      NAME("level0_time"),
      DESCRIPTION(R"--(List of L0 times.  Should be in UTC.
It is method-dependent how this is used to calibrated to L1
)--"),
      GROUP("ArrayOfTime")));
  ...
  wsv_data.push_back(WsvRecord(
      NAME("lm_ga_history"),
      DESCRIPTION(R"--(The series of gamma values for a Marquardt-levenberg inversion.
...
is the gamma factor for the first iteration etc.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The average molar mass of dry air.
...
An array of coefficients for effective collisions
  ...
  wsv_data.push_back(
      WsvRecord(NAME("nelem"),
                DESCRIPTION(R"--(Number of elements of a Vector or Array.
)--"),
                GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("ncols"),
      DESCRIPTION(R"--(Number of columns (elements in lowest dimension) of a Matrix or Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("nrows"),
      DESCRIPTION(R"--(Number of rows (elements in 2nd lowest dimension) of a Matrix or Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("npages"),
      DESCRIPTION(R"--(Number of elements in 3rd lowest dimension of a Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("nbooks"),
      DESCRIPTION(R"--(Number of elements in 4th lowest dimension of a Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("nshelves"),
      DESCRIPTION(R"--(Number of elements in 5th lowest dimension of a Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("nvitrines"),
      DESCRIPTION(R"--(Number of elements in 6th lowest dimension of a Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(WsvRecord(
      NAME("nlibraries"),
      DESCRIPTION(R"--(Number of elements in 7th lowest dimension of a Tensor.
)--"),
      GROUP("Index")));

  wsv_data.push_back(
      WsvRecord(NAME("nlte_do"),
                DESCRIPTION(R"--(Flag to perform Non-LTE calculations.
)--"),
                GROUP("Index"), Index{0}));

  wsv_data.push_back(WsvRecord(
      NAME("nlte_source"),
      DESCRIPTION(R"--(Variable to contain the additional source function due to NLTE effects.
...
Dimensions: [nza, naa, nf, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Basic diagnostics of an OEM type inversion.
...
are set to NaN.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("oem_errors"),
                DESCRIPTION(R"--(Errors encountered during OEM execution.
)--"),
                GROUP("ArrayOfString")));

  wsv_data.push_back(WsvRecord(
      NAME("output_file_format"),
      DESCRIPTION(R"--(Output file format.
...
*output_file_formatSetBinary*
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Identification of the data in ``particle_bulkprop_field``.
...
Dimensions: length should match book-dimension of ``particle_bulkprop_field``
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The mass of individual particles (or bulks).
...
Dimensions: [number of scattering elements, number of mass categories]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pha_mat"),
      DESCRIPTION(R"--(Ensemble averaged phase matrix.
...
Dimensions: [za_grid, aa_grid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pha_mat_doit"),
      DESCRIPTION(R"--(Ensemble averaged phase matrix for DOIT calculation.
...
Dimensions: [T,za_grid, aa_grid, za_grid, aa_grid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pha_mat_spt"),
      DESCRIPTION(R"--(Phase matrix for all individual scattering elements.
...
Dimensions: [number of scattering elements, za_grid, aa_grid, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda calculates the phase matrix for individual scattering elements.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("pha_mat_sptDOITOpt"),
      DESCRIPTION(R"--(Interpolated phase matrix.
...
- [number of scattering elements]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The sidereal rotation period of the planet.
...
Unit:   s
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Mapping of particle bulk properties to number density data.
...
See further *pnd_agenda_input* and associated variables.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The variable input to one element of *pnd_agenda_array*.
...
Dimensions: [ n_points, n_input_variables ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Temperature input to one element of *pnd_agenda_array*.
...
Dimensions: [ n_points ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Naming of all input expected by *pnd_agenda_array*.
...
Dimension: [ n_scattering_species ][ n_input_variables ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Naming of (existing or expected) data in *pnd_agenda_input*.
...
Dimension: [ n_input_variables ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pnd_data"),
      DESCRIPTION(R"--(Particle number density values for a set of points.
...
Dimensions: [ n_points, n_scattering_elements ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pnd_field"),
      DESCRIPTION(R"--(Particle number density field.
...
Size:
 ...
 ( *cloudbox_limits* [5] - *cloudbox_limits* [4]) +1 ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pnd_size_grid"),
      DESCRIPTION(R"--(The particle sizes associated with *pnd_data*.
...
Dimension: [ n_sizes ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("pnd_field_raw"),
      DESCRIPTION(R"--(The particle number density field raw data.
...
- Array[number of scattering elementst]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppath"),
      DESCRIPTION(R"--(The propagation path for one observation.
...
Usage: Primarily output from *ppath_agenda*.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("ppath_agenda"),
                DESCRIPTION(R"--(Agenda calculating complete propagation paths.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("ppath_field"),
      DESCRIPTION(R"--(An array meant to build up the necessary geometries for radiative
field calculations.
...
Size: user-defined
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to perform ray tracing inside the cloudbox.
...
Usage: For communication between modules of arts.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppath_lmax"),
      DESCRIPTION(R"--(Maximum length between points describing propagation paths.
...
Usage: Ppath methods such as ``ppath_stepGeometric``.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Ray tracing step length when determining refracted propagation paths.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppath_lstep"),
      DESCRIPTION(R"--(Length between points describing propagation paths.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppath_ltotal"),
      DESCRIPTION(R"--(Sets a maximum length of propagation paths.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppath_step"),
      DESCRIPTION(R"--(A propagation path step.
...
Members: See AUG.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("ppath_step_agenda"),
                DESCRIPTION(R"--(Agenda calculating a propagation path step.
)--"),
                GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_iy"),
      DESCRIPTION(R"--(iy-values along the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppvar_atm"),
      DESCRIPTION(R"--(Atmospheric points along the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppvar_f"),
      DESCRIPTION(R"--(Atmospheric frequency grids along the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ppvar_pnd"),
      DESCRIPTION(R"--(PND values along the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The optical depth between the sensor and each point of the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The transmittance between the sensor and each point of the propagation path.
...
Usage: Output of radiative transfer methods.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The transmittance between the points along the propagation path.
...
This is an experimental solution.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(This contains the absorption coefficients for one point in the atmosphere.
...
Unit: 1/m
  ...
  wsv_data.push_back(
      WsvRecord(NAME("propmat_clearsky_agenda_checked"),
                DESCRIPTION(R"--(OK-flag for *propmat_clearsky_agenda*.
...
Set by *propmat_clearsky_agenda_checkedCalc*.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda calculating the absorption coefficient matrices.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("propmat_clearsky_field"),
      DESCRIPTION(R"--(Gas absorption field.
...
Dimensions: [species, f_grid, ``stokes_dim``, stokes_dim, p_grid, lat_grid, lon_grid]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("psd_data"),
      DESCRIPTION(R"--(Particle size distribution values for a set of points.
...
Dimensions: [ n_points, n_scattering_elements ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("psd_size_grid"),
      DESCRIPTION(R"--(The particle sizes associated with *psd_data*.
...
Dimension: [ n_sizes ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("p_grid_orig"),
      DESCRIPTION(R"--(The original pressure grid before optimization.
...
Unit:  Pa
  ...
  wsv_data.push_back(WsvRecord(
      NAME("p_hse"),
      DESCRIPTION(R"--(Reference pressure calculation of hydrostatic equilibrium.
...
Size: [p_grid, 
  ...
  wsv_data.push_back(WsvRecord(
      NAME("range_bins"),
      DESCRIPTION(R"--(The range bins of an active instrument.
...
Unit: m or s
  ...
  wsv_data.push_back(WsvRecord(
      NAME("refr_index_air"),
      DESCRIPTION(R"--(Real part of the refractive index of air.
...
Unit: 1
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda calculating the refractive index of air.
)--"),
      GROUP("Agenda")));
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Group index of refractivity.
...
Unit: 1
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag indicating completeness and consistency of retrieval setup.
...
Unit: Boolean
  ...
  wsv_data.push_back(WsvRecord(
      NAME("retrieval_eo"),
      DESCRIPTION(R"--(The estimated error in the retrieval due to uncertainty in the observations.
...
book.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("retrieval_ss"),
      DESCRIPTION(R"--(The estimated error in the retrieval due to limited resolution of the
observation system.
...
book.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rte_alonglos_v"),
      DESCRIPTION(R"--(Velocity along the line-of-sight to consider for a RT calculation.
...
Unit: [ m/s ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rte_los"),
      DESCRIPTION(R"--(A line-of-sight for (complete) radiative transfer calculations.
...
Size:  [ 1 or 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rte_pos"),
      DESCRIPTION(R"--(A geographical position for starting radiative transfer calculations.
...
Size:  [ atmosphere_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rte_pos2"),
      DESCRIPTION(R"--(A second geographical position to define the geometry for
...
Size:  [ atmosphere_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rtp_los"),
      DESCRIPTION(R"--(Line-of-sight at a radiative transfer point.
...
Size:  [ 1 or 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rtp_pos"),
      DESCRIPTION(R"--(Position of a radiative transfer point.
...
Size:  [ atmosphere_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rtp_pressure"),
      DESCRIPTION(R"--(Pressure at a radiative transfer point.
...
Units: [ Pa ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Temperature at a radiative transfer point.
...
Units: [ K ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Switch between integration approaches for radiative transfer steps.
...
See each WSM using this varaible as input for available options.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("rtp_vmr"),
      DESCRIPTION(R"--(Absorption species abundances for radiative transfer calculations.
...
Size:  Should match abs_species.nelem()
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_data"),
      DESCRIPTION(R"--(Array of single scattering data.
...
derive it from *scat_data_raw*.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(OK-flag for *scat_data*.
...
value 1 is taken as OK.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_data_raw"),
      DESCRIPTION(R"--(Array of raw single scattering data.
...
Dimensions: [number of scattering species][number of scattering elements]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_data_mono"),
      DESCRIPTION(R"--(Monochromatic single scattering data.
...
which interpolates *scat_data* to the required frequency.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Structure for the single scattering data.
...
- SingleScatteringData 
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_lat_index"),
      DESCRIPTION(R"--(Latitude index for scattering calculations.
...
Usage:    Input to the methods *spt_calc_agenda*, *pha_mat_spt_agenda*
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_lon_index"),
      DESCRIPTION(R"--(Longitude index for scattering calculations.
...
Usage:    Input to the methods *spt_calc_agenda*, *pha_mat_spt_agenda*
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Structure for the scattering meta data.
...
Members:
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_meta"),
      DESCRIPTION(R"--(An Array of scattering meta data (*scat_meta_single*).
...
See also: *scat_meta_single*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_p_index"),
      DESCRIPTION(R"--(Pressure index for scattering calculations.
...
Usage:    Input to the methods *spt_calc_agenda*, *pha_mat_spt_agenda*
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_species"),
      DESCRIPTION(R"--(Array of Strings defining the scattering species to consider.
...
Example: [''IWC-MH97'', ''LWC-H98_STCO'', ...]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_species_a"),
      DESCRIPTION(R"--(Mass-size relationship parameter, for one scattering species.
...
See *scat_species_a* for details.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("scat_species_x"),
      DESCRIPTION(R"--(The size grid of one scattering species.
...
*abs_species* for that to be the selection.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_checked"),
      DESCRIPTION(R"--(OK-flag for sensor related variables.
...
Only the value 1 is taken as OK.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Sensor description for simple AMSU setup.
...
Size: [number of channels, 3]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_los"),
      DESCRIPTION(R"--(The sensor line-of-sight (LOS) for each measurement block.
...
Size:  [ number of measurement blocks, 1 or 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_norm"),
      DESCRIPTION(R"--(Flag if sensor response should be normalised or not (0 or 1).
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_pol"),
      DESCRIPTION(R"--(A set of polarisation response angles.
...
Size:  [ number of measurement blocks, number of channels/frequencies ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_pos"),
      DESCRIPTION(R"--(The sensor position for each measurement block.
...
Size:  [ number of measurement blocks, atmosphere_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The matrix modelling the total sensor response.
...
Dimension: See the individual ``sensor_response...`` method.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The relative azimuth angles associated with the output of
*sensor_response*.
...
Unit:  [ degrees ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("background_rad"),
      DESCRIPTION(R"--(Radiation from the background
)--"),
      GROUP("StokvecVector")));

  wsv_data.push_back(WsvRecord(
      NAME("background_transmittance"),
      DESCRIPTION(R"--(Transmittance from the background
)--"),
      GROUP("MuelmatVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_rad"),
      DESCRIPTION(R"--(Radiation along the propagation path
)--"),
      GROUP("ArrayOfStokvecVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_drad"),
      DESCRIPTION(R"--(Radiation derivative along the propagation path
)--"),
      GROUP("ArrayOfStokvecMatrix")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_propmat"),
      DESCRIPTION(R"--(Propagation matrices along the propagation path
)--"),
      GROUP("ArrayOfPropmatVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_dpropmat"),
      DESCRIPTION(R"--(Propagation derivative matrices along the propagation path
)--"),
      GROUP("ArrayOfPropmatMatrix")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_nlte"),
      DESCRIPTION(R"--(Additional NLTE along the propagation path
)--"),
      GROUP("ArrayOfStokvecVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_dnlte"),
      DESCRIPTION(R"--(Additional NLTE derivative along the propagation path
)--"),
      GROUP("ArrayOfStokvecMatrix")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_src"),
      DESCRIPTION(R"--(Source vectors along the propagation path
)--"),
      GROUP("ArrayOfStokvecVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_dsrc"),
      DESCRIPTION(R"--(Source derivative vectors along the propagation path
)--"),
      GROUP("ArrayOfStokvecMatrix")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_tramat"),
      DESCRIPTION(R"--(Transmission matrices along the propagation path
)--"),
      GROUP("ArrayOfMuelmatVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_cumtramat"),
      DESCRIPTION(R"--(Cumulative transmission matrices along the propagation path
)--"),
      GROUP("ArrayOfMuelmatVector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_dtramat"),
      DESCRIPTION(R"--(Transmission derivative matrices along the propagation path
)--"),
      GROUP("ArrayOfArrayOfMuelmatMatrix")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_distance"),
      DESCRIPTION(R"--(Layer distances along the propagation path
)--"),
      GROUP("Vector")));

  wsv_data.push_back(WsvRecord(
      NAME("ppvar_ddistance"),
      DESCRIPTION(R"--(Derivative of layer distances along the propagation path
)--"),
      GROUP("ArrayOfArrayOfVector")));

  wsv_data.push_back(WsvRecord(
      NAME("sensor_response_agenda"),
      DESCRIPTION(R"--(Agenda providing the sensor response data for a measurement block.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("sensor_response_dlos"),
      DESCRIPTION(R"--(The relative zenith and azimuth angles associated with the output of
*sensor_response*.
...
Unit:  [ degrees ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The zenith and azimuth angles associated with *sensor_response*.
...
Unit:  [ degrees ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The frequencies associated with the output of *sensor_response*.
...
Unit:  [ Hz ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The frequency grid associated with *sensor_response*.
...
Unit:  [ Hz ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The polarisation states associated with the output of
*sensor_response*.
...
Unit:  [ - ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The \"polarisation grid\" associated with *sensor_response*.
...
Unit:  [ - ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sensor_time"),
      DESCRIPTION(R"--(The time for each measurement block.
...
Size:  [ number of measurement blocks ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("sideband_mode"),
      DESCRIPTION(R"--(Description of target sideband.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Description of target sideband for a multiple LO receiver.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Description of (mixer) sideband response.
...
-  GriddedField1:
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Description of multiple (mixer) sideband responses.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Spectral irradiance field.
...
Units: W m^-2 Hz^-1
 ...
 Size: [ Nf, p_grid, lat_grid, lon_grid, 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Spectral radiance field.
...
Note:
 ...
 dimension (N_aa) are all 1.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Specific heat capacity.
...
Size: [ p_grid, lat_grid,  lon_grid]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("specular_los"),
      DESCRIPTION(R"--(The specular direction (for reflection by a flat surface).
...
Size:  [ 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda calculating single scattering properties from the amplitude matrix.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("suns_do"),
      DESCRIPTION(R"--(Flag to activate the sun(s).
)--"),
      GROUP("Index"), Index{0}));

  wsv_data.push_back(WsvRecord(
      NAME("suns"),
      DESCRIPTION(R"--(Array of Sun.
...
longitude in the sky of the planet and the type
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Rotation of the Stokes H and V directions.
...
Usage: Set by the user.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Complex refractive index of the surface, at a single point.
...
are treated.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The emission from the surface.
...
temperature but also entirerly abstract properties and types.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("surface_los"),
      DESCRIPTION(R"--(Downwelling radiation directions to consider in surface reflection.
...
Size:  [ any number, 1 or 2 ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("surface_normal"),
      DESCRIPTION(R"--(The normal vector for a point at the surface.
...
known for a single point, the normal of the surface at the position is also stored.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Name on surface properties found in ``surface_props_data``.
...
Size:  [ number of props. ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(The reflection coefficients for the directions given by
...
Dimensions: [ surface_los, f_grid, stokes_dim, stokes_dim ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda providing radiative properties of the surface.
)--"),
      GROUP("Agenda")));
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Accuracy of length to surface intersections.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Selection of algorithm for finding intersections with the surface.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      NAME("surface_skin_t"),
      DESCRIPTION(R"--(Surface skin temperature.
...
Usage:   Input to methods for *surface_rtprop_agenda*.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Surface reflectivity, for a given position and angle.
...
Dimensions: [ f_grid or 1, stokes_dim, stokes_dim]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("surface_rv_rh"),
      DESCRIPTION(R"--(Surface reflectivity, described by rv and rh (power) reflectivities.
...
Dimensions: [ f_grid or 1, 2]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Surface reflectivity, assuming it can be described as a scalar value.
...
Dimensions: [ f_grid or 1]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Classification of the surface using a type coding.
...
-  GriddedField2:
  ...
  wsv_data.push_back(
      WsvRecord(NAME("surface_type_mix"),
          DESCRIPTION(R"--(Gives the fraction of different surface types.
...
vector matches the first agenda element, and so on.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("telsem_atlases"),
      DESCRIPTION(R"--(TELSEM 2 emissivity atlases.
...
atlases, one for each month. Index 0 is January, index 11 December.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("tessem_neth"),
      DESCRIPTION(R"--(FIXMEDOC Add more documentation?
...
TESSEM2 neural network parameters for vertical polarization.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("test_agenda"),
                DESCRIPTION(R"--(A dummy agenda for testing purposes.
...
Only used for testing by developers.
  ...
  wsv_data.push_back(
      WsvRecord(NAME("test_agenda_array"),
                DESCRIPTION(R"--(Array of agenda for TestArrayOfAgenda case.
...
Only used for testing by developers.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("time"),
      DESCRIPTION(R"--(A UTC time point.
)--"),
      GROUP("Time")));

  wsv_data.push_back(WsvRecord(
      NAME("timer"),
      DESCRIPTION(R"--(Stores the starting time for time measurements.
)--"),
      GROUP("Timer")));

  wsv_data.push_back(WsvRecord(
      NAME("time_grid"),
      DESCRIPTION(R"--(A grid of times.  Should be increasing
)--"),
      GROUP("ArrayOfTime")));

  wsv_data.push_back(WsvRecord(
      NAME("time_stamps"),
      DESCRIPTION(R"--(A set of times.  Can be in random order
)--"),
      GROUP("ArrayOfTime")));

  wsv_data.push_back(WsvRecord(
      NAME("transmitter_pos"),
      DESCRIPTION(R"--(Transmitter positions.
...
Unit:  [ m, degrees, degrees ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Agenda to calculate the saturation pressure of water.
)--"),
      GROUP("Agenda")));

  wsv_data.push_back(WsvRecord(
      NAME("water_p_eq_field"),
      DESCRIPTION(R"--(The field of water saturation pressure.
...
Dimensions: [ p_grid, lat_grid, lon_grid ]
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Indicates if the wigner tables are initialized.
...
handling is otherwise offloaded to third party software...
  ...
  wsv_data.push_back(WsvRecord(
      NAME("wmrf_channels"),
      DESCRIPTION(R"--(Channel selection for WMRF fast calculation.
...
Channel 0 is the first instrument channel!
  ...
  wsv_data.push_back(WsvRecord(
      NAME("wmrf_weights"),
      DESCRIPTION(R"--(The weights for a WMRF fast calculation.
...
of monochromatic frequencies.
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Flag to determine whether XML output shall be binary or ascii.
...
Usage: Set by user.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("x"),
      DESCRIPTION(R"--(The state vector.
...
Unit:  Varies, follows unit of selected retrieval quantities.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("xa"),
      DESCRIPTION(R"--(The a priori state vector.
...
Unit:  Varies, follows unit of selected retrieval quantities.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y"),
      DESCRIPTION(R"--(The measurement vector.
...
Unit:  Undefined. Possibilities include: K, W/(m^2 Hz sr) and optical thickness.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_aux"),
      DESCRIPTION(R"--(Data auxilary to *y*.
...
Dimensions: [quantity][ element of y ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_baseline"),
      DESCRIPTION(R"--(The baseline of *y*.
...
Unit:  Same as applied for *y*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_f"),
      DESCRIPTION(R"--(The frequencies associated with *y*.
...
Unit:  [ Hz ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_geo"),
      DESCRIPTION(R"--(The geo-position assigned to each element of  *y*.
...
Unit:  [ m, deg, deg, deg, deg ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_geo_series"),
      DESCRIPTION(R"--(The geo-positioning assigned to each row of *y_series*.
...
Otherwise as *y_geo*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_geo_swath"),
      DESCRIPTION(R"--(The geo-positioning assigned to each pixel of *y_swath*.
...
Otherwise as *y_geo*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_los"),
      DESCRIPTION(R"--(The line-of-sights associated with *y*.
...
Unit:  [ degrees, degrees ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_pol"),
      DESCRIPTION(R"--(The polarisation states associated with *y*.
...
Unit:  [ - ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_pos"),
      DESCRIPTION(R"--(The sensor positions associated with *y*.
...
Unit:  [ m, deg, deg ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_series"),
      DESCRIPTION(R"--(Two-dimensional version of the measurement vector.
...
Dimesion:  [ position, channel ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("y_swath"),
      DESCRIPTION(R"--(Three-dimensional version of the measurement vector.
...
Dimesion:  [ scan, pixel, channel ]
  ...
  wsv_data.push_back(WsvRecord(
      NAME("yb"),
      DESCRIPTION(R"--(The measurement vector for a single measurement block.
...
Usage: Used internally.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ybatch"),
      DESCRIPTION(R"--(Batch of spectra.
...
Vectors have length(y)
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ybatch_aux"),
      DESCRIPTION(R"--(Data auxilary to *ybatch*.
...
Dimensions: Number of array elements equals number of batch cases,
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ybatch_index"),
      DESCRIPTION(R"--(Index of batch case.
...
*ybatch_calc_agenda*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ybatch_corr"),
      DESCRIPTION(R"--(Correction terms for *ybatch*.
...
Vectors have length depending on correction method
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(All the Jacobians associated with ybatch.
...
- [number of batch cases]
  ...
  wsv_data.push_back(
      WsvRecord(NAME("ybatch_n"),
                DESCRIPTION(R"--(Number of batch cases for *ybatchCalc*.
...
Usage: Input to *ybatchCalc*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("ybatch_start"),
      DESCRIPTION(R"--(Start index for *ybatchCalc*.
...
Usage: Input to *ybatchCalc*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("yf"),
      DESCRIPTION(R"--(A fitted measurement vector.
...
Usage: Output from inversion methods.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("za_grid"),
      DESCRIPTION(R"--(Zenith angle grid.
...
Unit:       degrees
  ...
  wsv_data.push_back(WsvRecord(
      ...
      DESCRIPTION(R"--(Zenith angle integration weights.
...
Unit:  unitless
  ...
  wsv_data.push_back(WsvRecord(
      NAME("za_index"),
      DESCRIPTION(R"--(Zenith angle index for scattering calculations.
...
Usage:    Input to the agendas *spt_calc_agenda*, *pha_mat_spt_agenda*.
  ...
  wsv_data.push_back(WsvRecord(
      NAME("z_hse_accuracy"),
      DESCRIPTION(R"--(Minimum accuracy for calculation of hydrostatic equilibrium.
...
Unit:  m
  ...
  wsv_data.push_back(WsvRecord(
      NAME("z_sensor"),
      DESCRIPTION(R"--(The altitude of the sensor.
