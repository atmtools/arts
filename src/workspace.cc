...
*/     
  ...
  wsv_data.push_back
   (WsvRecord
    ( NAME( "mblock_sensor_index" ),
      DESCRIPTION
      (
       "Identification of *sensor_response* for each measurement block.\n"
       "\n"
       "When used, this variable shall hold an index number for each\n"
       "measurement block. Typically this index identifies which element of\n"
  ...
  wsv_data.push_back
   ...
   (WsvRecord
    ( NAME( "part_species" ),
      DESCRIPTION
      (
       "*part_species* is an Array of Strings containing user defined input,\n"
       "for particle number density calculations performed by *pnd_fieldSetup*.\n"
       "\n"
 ...
 wsv_data.push_back
  ...
  wsv_data.push_back
   ...
   wsv_data.push_back
	 ...
	 "\n"
	 "Currently some of the meta data entries are not used, but were included\n"
	 "for future extensions of pnd calculations in ARTS.\n"
	 "This applies to: \"shape\", \"d_max\", \"A_proje\", \"asratio\"\n"
	 "\n"	 
	 "Usage: Set by the user.\n"
	 "\n"
	 "Dimensions/Units:\n"
   ...
   wsv_data.push_back
	 ...
	 "\n"
	 "Currently some of the meta data entries are not used, but were included for \n"
   ...
   (WsvRecord
    ( NAME( "sensor_response_array" ),
      ...
      (
        ...
        "together with *mblock_sensor_index*.)\n"
       ),
      GROUP( "ArrayOfSparse" )));
  */
