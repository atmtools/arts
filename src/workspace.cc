  ...
  wsv_data.push_back
   (WsvRecord
    ("ppath_step_agenda",
     ...
     "output to *ppath_step_agenda*. The agenda gets back *ppath_partial*\n" 
     ...
     "handled by *ppath_step_agenda*. All fields of *ppath_partial* are set\n"
     "by *ppath_step_agenda*. The field *constant* shall be set to be\n"
     "negative by the calling function. It is set to the correct value by\n"
     "*ppath_step* at the first call.\n" 
     "\n"
     ...
     "background field of *ppath_partial*. Beside this, the calling function\n"
