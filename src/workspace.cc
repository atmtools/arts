  ...
  wsv_data.push_back
   (WsvRecord
    ("ppath_step",
     ...
     "starting point and the first point in the structure. The field\n"
     "*constant* shall be set to be negative by the calling function. It is\n"
     "set to the correct value by *ppath_step* at the first call.\n" 
     "\n"
