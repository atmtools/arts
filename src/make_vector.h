/* The make_vector and make_array functions can be used to initialize
   VECTORS and ARRAYS in the source code. Usage is as simple as:

   VECTOR x        = make_vector(33.2, 17.3, 3.8);
   or 
   ARRAY<string> y = make_array<string>("ab", "cde");

   which will a VECTOR or ARRAY with the desired arguments. At the
   moment, up to 20 arguments are possible. If more are needed this
   can be easily extended.

   The DEFINITIONS have to be in this header file, otherwise templates
   don't work.  
