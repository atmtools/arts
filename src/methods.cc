...
void define_md_data_raw()
{
  ...
  md_data_raw.push_back
	...
	OUTPUT(scat_i_p_, scat_i_lat_, scat_i_lon_, ppath_, ppath_step_, i_rte_,
	       y_rte_, i_space_, ground_emission_, ground_los_, ground_refl_coeffs_,
	       mblock_index_, a_pos_, a_los_),
	INPUT(  ppath_step_, a_gp_p_, a_gp_lat_, a_gp_lon_, cloudbox_on_,
		...
		lon_grid_, z_field_, r_geoid_, z_ground_, antenna_dim_, mblock_aa_grid_),
...
md_data_raw.push_back
 ...
 md_data_raw.push_back
	...
	OUTPUT(scat_i_p_, scat_i_lat_, scat_i_lon_, scat_f_index_, a_gp_p_,
	       a_gp_lat_, a_gp_lon_, ppath_, ppath_step_, i_rte_,y_rte_, i_space_,
	       ground_emission_, ground_los_, ground_refl_coeffs_,mblock_index_,
	       a_los_, a_pos_),
	INPUT( scat_mono_agenda_, cloudbox_on_, cloudbox_limits_, atmosphere_dim_, 
	       stokes_dim_, 
		scat_za_grid_, scat_aa_grid_, f_grid_,	ppath_step_agenda_,
		rte_agenda_, i_space_agenda_, ground_refl_agenda_, p_grid_, 
		lat_grid_, lon_grid_, z_field_,r_geoid_, z_ground_, antenna_dim_,
		mblock_aa_grid_),
