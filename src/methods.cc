    ...
    ( MdRecord
      ( NAME( "pha_mat_sptFromData" ),
        ...
        INPUT(pha_mat_spt_, scat_data_raw_, scat_za_grid_, scat_aa_grid_, 
              scat_za_index_, scat_aa_index_, f_index_, f_grid_, t_value_),
        GOUTPUT(),
        GINPUT(),
        KEYWORDS(),
        TYPES())); 
  ...
  md_data_raw.push_back
    ( MdRecord
      ( NAME( "scat_data_monoCalc" ),
        ...
        INPUT( scat_data_raw_ ,f_grid_, f_index_, t_value_ ),
        GOUTPUT(),
        GINPUT(),
        KEYWORDS(),
        TYPES()));
