...
Available models:
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      DESCRIPTION(
          ...
          "equals radius times the magnitude of the Gaussian response (his product\n"
          "peaks for a radius around 0.41*FWHM). The points are distributed in polar\n"
          "angle simply by adding 0.58*2*pi (208.8 deg) from one point to next.\n"
          "There is no theoretical basis for this step in angle, just found to\n"
          "to give a distribution of the points.\n"
          "\n"
          "The method should mainly be used for *npoints* above 10-20. For lower\n"
          "*npoints*, rectangular pattern should give a more robust sampling of\n"
          "spatially.\n"
          "\n"
