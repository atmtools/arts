...
//======================================================================
  ...
  md_data.push_back
	...
	TYPES(    Index_t, Numeric_t, Index_t,     Numeric_t, Numeric_t  )));
  ...
  md_data.push_back
	...
	TYPES(    Numeric_t, Index_t,     Numeric_t, Numeric_t  )));
...
//======================================================================
  ...
  md_data.push_back
	...
	TYPES(    Index_t, Array_String_t, String_t    )));
  ...
  md_data.push_back
	...
	TYPES(    Index_t, Numeric_t, Numeric_t,  String_t, String_t  )));
