...
void define_md_data_raw() {
  ...
  md_data_raw.push_back(create_mdrecord(
    NAME("abs_hitran_relmat_dataReadHitranRelmatDataAndLines"),
      ...
      GIN_DEFAULT(NODEF, "-1", "-std::numeric_limits<Numeric>::max()", "std::numeric_limits<Numeric>::max()", "0", "VP_W"),
  ...
  */
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      GIN_TYPE("Index", "Numeric"),
      GIN_DEFAULT("1", "std::numeric_limits<Numeric>::max()"),
      GIN_DESC("Interpolation order (1=linear interpolation).",
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      GIN_DEFAULT(NODEF, "-std::numeric_limits<Numeric>::max()", "std::numeric_limits<Numeric>::max()", "", "", "None", "None", "LTE", "VP",
                 "None", "750e9", "-1"),
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      GIN_TYPE("String", "Numeric", "Numeric", "String", "String", "Index", "String",
               "String", "String", "String", "String", "Numeric", "Numeric"),
      GIN_DEFAULT(NODEF, "-std::numeric_limits<Numeric>::max()", "std::numeric_limits<Numeric>::max()", "", "", "0", "None", "None", "LTE", "VP",
                 "None", "750e9", "-1"),
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      GIN_TYPE("String", "Numeric", "Numeric", "String", "String", "String", "String",
               "String", "String", "String", "String", "Numeric", "Numeric"),
      GIN_DEFAULT(NODEF, "-std::numeric_limits<Numeric>::max()", "std::numeric_limits<Numeric>::max()", "", "", "Online", "None", "None", "LTE", "VP",
                 "None", "750e9", "-1"),
