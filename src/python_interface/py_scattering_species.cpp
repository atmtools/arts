...
void bind_phase_matrix_data_tro_gridded(py::module_ &m,
  ...
  py::class_<PMD, matpack::matpack_data<Scalar, 4>>(m, class_name.c_str())
      ...
      .def("extract_stokes_coeffs",
           &PMD::extract_stokes_coeffs)  // You can specify the new stokes_dim here
...
void bind_absorption_vector_data_tro(py::module_ &m, const std::string &name) {
  using AVD = scattering::
      AbsorptionVectorData<Scalar, scattering::Format::TRO, repr>;
...
void bind_absorption_vector_data_aro(py::module_ &m, const std::string &name) {
  using AVD = scattering::
      AbsorptionVectorData<Scalar, scattering::Format::ARO, repr>;
...
void bind_extinction_matrix_data_tro(py::module_ &m, const std::string &name) {
  using EMD = scattering::
      ExtinctionMatrixData<Scalar, scattering::Format::TRO, repr>;
...
void bind_extinction_matrix_data_aro(py::module_ &m, const std::string &name) {
  using EMD = scattering::
      ExtinctionMatrixData<Scalar, scattering::Format::ARO, repr>;
...
void bind_single_scattering_data(py::module_ &m, const std::string &name) {
  using SSDClass =
      scattering::SingleScatteringData<Scalar, format, repr>;

  py::class_<SSDClass>(m, name.c_str())
      .def(py::init<
               scattering::PhaseMatrixData<Scalar, format, repr>,
               scattering::
                   ExtinctionMatrixData<Scalar, format, repr>,
               scattering::
                   AbsorptionVectorData<Scalar, format, repr>,
...
void bind_bulk_scattering_properties(py::module_ &m, const std::string &name) {
  py::class_<scattering::BulkScatteringProperties<format, repr> >(m, name.c_str())
...
void py_scattering_species(py::module_& m) try {  //
  ...
  using BulkScatteringPropertiesTROSpectral = std::variant<
    scattering::BulkScatteringProperties<scattering::Format::TRO, scattering::Representation::Spectral>
    >;
  using BulkScatteringPropertiesTROGridded = std::variant<
    scattering::BulkScatteringProperties<scattering::Format::TRO, scattering::Representation::Gridded>
    >;
  using BulkScatteringPropertiesAROSpectral = std::variant<
    scattering::BulkScatteringProperties<scattering::Format::ARO, scattering::Representation::Spectral>
    >;
  using BulkScatteringPropertiesAROGridded = std::variant<
    scattering::BulkScatteringProperties<scattering::Format::ARO, scattering::Representation::Gridded>
    >;
  ...
  py::class_<HenyeyGreensteinScatterer>(m, "HenyeyGreensteinScatterer")
    ...
    .def("get_bulk_scattering_properties_tro_spectral",
         [](const HenyeyGreensteinScatterer& hg,
            ...
            const Vector& f_grid,
            Index l) {
           return BulkScatteringPropertiesTROSpectral{hg.get_bulk_scattering_properties_tro_spectral(atm_point, f_grid, l)};
         })
    .def("get_bulk_scattering_properties_tro_gridded",
         [](const HenyeyGreensteinScatterer& hg,
           ...
           return BulkScatteringPropertiesTROGridded{hg.get_bulk_scattering_properties_tro_gridded(atm_point, f_grid, za_grid)};
         });
  ...
  aoss
    ...
    .def("get_bulk_scattering_properties_tro_spectral",
         [](const ArrayOfScatteringSpecies& aoss,
            ...
            const Vector& f_grid,
            Index l) {
           return BulkScatteringPropertiesTROSpectral{aoss.get_bulk_scattering_properties_tro_spectral(atm_point, f_grid, l)};
         })
    .def("get_bulk_scattering_properties_tro_gridded",
         [](const ArrayOfScatteringSpecies& aoss,
            const AtmPoint& atm_point,
            const Vector& f_grid,
            std::shared_ptr<scattering::ZenithAngleGrid> za_grid) {
           return BulkScatteringPropertiesTROGridded{aoss.get_bulk_scattering_properties_tro_gridded(atm_point, f_grid, za_grid)};
         })
    .def("get_bulk_scattering_properties_aro_gridded",
         [](const ArrayOfScatteringSpecies& aoss,
           ...
           return BulkScatteringPropertiesAROGridded{aoss.get_bulk_scattering_properties_aro_gridded(atm_point, f_grid, za_inc_grid, delta_aa_grid, za_scat_grid)};
         })
    .def("get_bulk_scattering_properties_aro_spectral",
         [](const ArrayOfScatteringSpecies& aoss,
            ...
            Index l,
            Index m) {
           return BulkScatteringPropertiesAROSpectral{aoss.get_bulk_scattering_properties_aro_spectral(atm_point, f_grid, za_inc_grid, l, m)};
         });

  workspace_group_interface(aoss);

  bind_phase_matrix_data_tro_gridded<double>(m,
                                                "PhaseMatrixDataTROGridded4");
  bind_phase_matrix_data_tro_spectral<double>(m,
  ...
  bind_single_scattering_data<double, scattering::Format::TRO, scattering::Representation::Gridded>(m, "SingleScatteringDataTROGridded4");
  bind_single_scattering_data<double, scattering::Format::ARO, scattering::Representation::Gridded>(m, "SingleScatteringDataAROGridded1");
  bind_single_scattering_data<double, scattering::Format::TRO, scattering::Representation::Spectral>(m, "SingleScatteringDataTROSpectral4");
  bind_single_scattering_data<double, scattering::Format::ARO, scattering::Representation::Spectral>(m, "SingleScatteringDataAROSpectral1");

  bind_bulk_scattering_properties<scattering::Format::TRO, scattering::Representation::Gridded>(m, "BulkScatteringPropertiesTROGridded4");
