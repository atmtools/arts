...
void py_scattering(py::module_& m) try {
  ...
  ssdb.def_rw("ptype", &SingleScatteringData::ptype, "The type\n\n.. :class:`~pyarts3.arts.PType`")
      .def_rw("description", &SingleScatteringData::description, "The description\n\n.. :class:`~pyarts3.arts.String`")
      .def_rw("f_grid", &SingleScatteringData::f_grid, "The frequency grid\n\n.. :class:`~pyarts3.arts.Vector`")
      .def_rw("T_grid", &SingleScatteringData::T_grid, "The temperature grid\n\n.. :class:`~pyarts3.arts.Vector`")
      .def_rw("za_grid", &SingleScatteringData::za_grid, "The zenith grid\n\n.. :class:`~pyarts3.arts.Vector`")
      .def_rw("aa_grid", &SingleScatteringData::aa_grid, "The azimuth grid\n\n.. :class:`~pyarts3.arts.Vector`")
      .def_rw(
          "pha_mat_data", &SingleScatteringData::pha_mat_data, "The phase matrix\n\n.. :class:`~pyarts3.arts.Tensor7`")
      .def_rw("ext_mat_data",
  ...
  smdb.def_rw("description", &ScatteringMetaData::description, "The description\n\n.. :class:`~pyarts3.arts.String`")
      .def_rw("source", &ScatteringMetaData::source, "The source\n\n.. :class:`~pyarts3.arts.String`")
      .def_rw("refr_index", &ScatteringMetaData::refr_index, "The refractive index\n\n.. :class:`~pyarts3.arts.String`")
      .def_rw("mass", &ScatteringMetaData::mass, "The mass\n\n.. :class:`float`")
      .def_rw("diameter_max", &ScatteringMetaData::diameter_max, "The max diameter\n\n.. :class:`float`")
  ...
  auto a1 =
      py::bind_vector<ArrayOfScatteringMetaData, py::rv_policy::reference_internal>(m, "ArrayOfScatteringMetaData");
  ...
  vector_interface(a2);
  auto a3 =
      py::bind_vector<ArrayOfSingleScatteringData, py::rv_policy::reference_internal>(m, "ArrayOfSingleScatteringData");
