...
void py_zeeman(py::module_& m) try {
  ...
  zzma.def(py::init<Vector3, Vector2>())
      ...
      .def_ro("H", &lbl::zeeman::magnetic_angles::H, "Absolute magnetic field strength\n\n.. :class:`float`")
      .def_ro("uct", &lbl::zeeman::magnetic_angles::uct, "Angle constant\n\n.. :class:`float`")
      .def_ro("duct", &lbl::zeeman::magnetic_angles::duct, "Derivative of angle constant\n\n.. :class:`float`")
      .def_prop_ro("theta", &lbl::zeeman::magnetic_angles::theta, "Magnetic angle theta\n\n.. :class:`float`")
      .def_prop_ro("eta", &lbl::zeeman::magnetic_angles::eta, "Magnetic angle eta\n\n.. :class:`float`")
      ...
      .def_prop_ro(
          "deta_du", &lbl::zeeman::magnetic_angles::deta_du, "Derivative of eta with respect to u\n\n.. :class:`float`")
      .def_prop_ro(
          "deta_dv", &lbl::zeeman::magnetic_angles::deta_dv, "Derivative of eta with respect to v\n\n.. :class:`float`")
      .def_prop_ro(
          "deta_dw", &lbl::zeeman::magnetic_angles::deta_dw, "Derivative of eta with respect to w\n\n.. :class:`float`")
      .def("__repr__",
  ...
  zzma.def_prop_ro(
      "k",
      [](const lbl::zeeman::magnetic_angles& x) -> Vector3 { return {x.sz * x.sa, x.sz * x.ca, x.cz}; },
      "Propagation vector\n\n.. :class:`~pyarts3.arts.Vector3`");

  zzma.def_prop_ro(
      "e1",
      [](const lbl::zeeman::magnetic_angles& x) -> Vector3 { return {-x.cz * x.sa, -x.cz * x.ca, x.sz}; },
      "Propagation vector upwards projection\n\n.. :class:`~pyarts3.arts.Vector3`");

  zzma.def_prop_ro(
      "e2",
      [](const lbl::zeeman::magnetic_angles& x) -> Vector3 { return {x.ca, -x.sa, 0}; },
