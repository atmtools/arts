...
namespace Python {
template <typename FUNC, typename... in> auto vectorize(FUNC f, in&&... args) {
...
void common_ndarray(auto& c) {
  ...
  c.def("__contains__", &npcontains, "key"_a, "See :attr:`numpy.ndarray.__contains__`");

  c.def("__divmod__", &npdivmod, "value"_a, "See :attr:`numpy.ndarray.__divmod__`");

  c.def("__eq__", &npeq, "value"_a, "See :attr:`numpy.ndarray.__eq__`");

  c.def("__float__", &npfloat, "See :attr:`numpy.ndarray.__float__`");

  c.def("__floordiv__", &npfloordiv, "value"_a, "See :attr:`numpy.ndarray.__floordiv__`");

  c.def("__ge__", &npge, "value"_a, "See :attr:`numpy.ndarray.__ge__`");

  c.def("__getitem__", &npgetitem, "key"_a, "See :attr:`numpy.ndarray.__getitem__`");
  ...
  c.def("__ifloordiv__", &npifloordiv, "value"_a, "See :attr:`numpy.ndarray.__ifloordiv__`");
  ...
  c.def("__irshift__", &npirshift, "value"_a, "See :attr:`numpy.ndarray.__irshift__`");
  ...
  c.def("__lshift__", &nplshift, "value"_a, "See :attr:`numpy.ndarray.__lshift__`");

  c.def("__lt__", &nplt, "value"_a, "See :attr:`numpy.ndarray.__lt__`");

  c.def("__matmul__", &npmatmul, "value"_a, "See :attr:`numpy.ndarray.__matmul__`");
  ...
  c.def("__setitem__", &npsetitem, "key"_a, "value"_a, "See :attr:`numpy.ndarray.__setitem__`");

  c.def("__sub__", &npsub, "value"_a, "See :attr:`numpy.ndarray.__sub__`");

  c.def("__truediv__", &nptruediv, "value"_a, "See :attr:`numpy.ndarray.__truediv__`");
  ...
  c.def_prop_ro("_base", &np_base, py::keep_alive<0, 1>{}, "See :attr:`numpy.ndarray.base`.\n\n.. :class:`object`");

  // Renamed because we often have properties with the same name
  c.def_prop_ro("_data", &np_data, py::keep_alive<0, 1>{}, "See :attr:`numpy.ndarray.data`.\n\n.. :class:`object`");

  c.def_prop_ro("dtype", &npdtype, "See :attr:`numpy.ndarray.dtype`.\n\n.. :class:`object`");

  // Renamed to behave as data_ as the return type is similar
  c.def_prop_ro("_flat", &np_flat, py::keep_alive<0, 1>{}, "See :attr:`numpy.ndarray.flat`.\n\n.. :class:`object`");

  c.def_prop_ro("imag", &npimag, py::keep_alive<0, 1>{}, "See :attr:`numpy.ndarray.imag`.\n\n.. :class:`object`");
  ...
  c.def_prop_ro("real", &npreal, py::keep_alive<0, 1>{}, "See :attr:`numpy.ndarray.real`.\n\n.. :class:`object`");
  ...
  c.def("flatten", &npflatten, "order"_a = 'C', "See :attr:`numpy.ndarray.flatten`");
  ...
  c.def("diagonal", &npdiagonal, "offset"_a = 0, "axis1"_a = 0, "axis2"_a = 1, "See :attr:`numpy.ndarray.diagonal`");
  ...
  c.def("repeat", &nprepeat, "repeats"_a, "axis"_a = py::none(), "See :attr:`numpy.ndarray.repeat`");

  c.def("reshape", &npreshape, "shape"_a, "order"_a = 'C', "See :attr:`numpy.ndarray.reshape`");

  c.def("round", &npround, "decimals"_a = 0, "out"_a = py::none(), "See :attr:`numpy.ndarray.round`");

  c.def("squeeze", &npsqueeze, "axis"_a = py::none(), "See :attr:`numpy.ndarray.squeeze`");
  ...
  c.def("transpose", &nptranspose, "axes"_a, "See :attr:`numpy.ndarray.transpose`");
