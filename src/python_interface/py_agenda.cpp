...
1
  ...
  py::class_<MdRecord>(m, "MdRecord")
      ...
      .def_property_readonly("authors", &MdRecord::Authors, ":class:`~pyarts.arts.String` Name of authors of method")
      ...
      .def_property_readonly("g_out_desc", &MdRecord::GOutDescription, ":class:`~pyarts.arts.ArrayOfString` Generic output description of method")
      .def_property_readonly("g_out_types", &MdRecord::GOutType, ":class:`~pyarts.arts.ArrayOfIndex` Types of the generic output")
      .def_property_readonly("g_out_spec_types", &MdRecord::GOutSpecType, ":class:`~pyarts.arts.ArrayOfIndex` Types specialized of the generic output")
      ...
      .def_property_readonly("g_in_desc", &MdRecord::GInDescription, ":class:`~pyarts.arts.ArrayOfString` Generic input description to method")
      .def_property_readonly("g_in_types", &MdRecord::GInType, ":class:`~pyarts.arts.ArrayOfIndex` Types of the generic input")
      .def_property_readonly("g_in_spec_types", &MdRecord::GInSpecType, ":class:`~pyarts.arts.ArrayOfIndex` Types specialized of the generic input")
      ...
      .def_property_readonly("pass_workspace", &MdRecord::PassWorkspace, ":class:`~bool` Pass the workspace to the method?")
      .def_property_readonly("pass_wsv_name", &MdRecord::PassWsvNames, ":class:`~bool` Pass the workspace names to the method?")
