...
void py_path(py::module_& m) try {
  ...
  a1.def(
      "distances",
      [](const ArrayOfPropagationPathPoint& path, const Vector2& ellipsoid) { return path::distance(path, ellipsoid); },
      "ellipsoid"_a,
  ...
  a1.def(
      ...
      [](const ArrayOfPropagationPathPoint& path) {
        return Vector{std::from_range,
                      path | stdv::transform([](const PropagationPathPoint& p) { return p.altitude(); })};
      },
  ...
  a1.def(
      ...
      [](const ArrayOfPropagationPathPoint& path) {
        return Vector{std::from_range,
                      path | stdv::transform([](const PropagationPathPoint& p) { return p.latitude(); })};
      },
  ...
  a1.def(
      ...
      [](const ArrayOfPropagationPathPoint& path) {
        return Vector{std::from_range,
                      path | stdv::transform([](const PropagationPathPoint& p) { return p.longitude(); })};
      },
  ...
  a1.def(
      ...
      [](const ArrayOfPropagationPathPoint& path) {
        return Vector{std::from_range,
                      path | stdv::transform([](const PropagationPathPoint& p) { return p.zenith(); })};
      },
  ...
  a1.def(
      ...
      [](const ArrayOfPropagationPathPoint& path) {
        return Vector{std::from_range,
                      path | stdv::transform([](const PropagationPathPoint& p) { return p.azimuth(); })};
      },
      "Get all the azimuths in the path");
  a1.def(
      "to_ecef",
      [](const ArrayOfPropagationPathPoint& path, const Vector2& ellipsoid) {
        return ArrayOfVector3{std::from_range, path | stdv::transform([ellipsoid](const PropagationPathPoint& p) {
  ...
  path.def(
      ...
      [](const ArrayOfPropagationPathPoint& ray_path) -> PropagationPathPoint {
        ...
        return *stdr::min_element(
            ray_path, [](Vector3 pos1, Vector3 pos2) { return pos1[0] < pos2[0]; }, &PropagationPathPoint::pos);
      },
      "ray_path"_a,
  ...
  path.def(
      "distance",
      [](const Vector3& pos1, const Vector3& pos2, const Vector2& ell) { return path::distance(pos1, pos2, ell); },
      "pos1"_a,
      "pos2"_a,
      "ell"_a,
