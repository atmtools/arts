...
void MPM87H2OAbsModel( Matrix&           abs,       // calculated x-section
                       ...
                       const Vector&   f_grid,     // frequency vector
                       const Vector&   abs_p,      // pressure vector
                       const Vector&   abs_t,      // temperature vector
                       const Vector&   abs_vmr );      // H2O vmr profile

void MPM89H2OAbsModel( Matrix&           abs,       // calculated x-section
...
void MPM93H2OAbsModel( Matrix&           abs,
                       const Numeric     CCin,       // continuum scale factor 
                       const Numeric	 CLin,       // line strength scale factor
                       const Numeric	 CWin,       // line broadening scale factor
                       const String&     model,      // model option
...
void PWR98H2OAbsModel( Matrix&           abs,       // calculated x-section
                       const Numeric	 CCin,       // continuum scale factor 
                       const Numeric     CLin,       // line strength scale factor
                       const Numeric	 CWin,       // line broadening scale factor
                       const String&     model,      // model option
...
void CP98H2OAbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CCin,        // continuum scale factor 
                      const Numeric     CLin,        // line strength scale factor
                      const Numeric     CWin,        // line broadening scale factor
                      const String&     model,       // model option
...
void Standard_H2O_self_continuum( Matrix&           abs,        // calculated x-section
...
void Standard_H2O_foreign_continuum( Matrix&           abs,     // calculated x-section
                                     const Numeric	 C,      // model parameter
                                     const Numeric	 x,      // model parameter
                                     const String&     model,    // model option
                                     const Vector&   f_grid,   // frequency vector
...
void MaTipping_H2O_foreign_continuum( Matrix&           abs,     // calculated x-section
                                      const Numeric	 C,      // model parameter
                                      const Numeric	 x,      // model parameter
                                      const String&     model,    // model option
                                      const Vector&   f_grid,   // frequency vector
...
void MPM93_H2O_continuum( Matrix&           abs,                // calculated x-section
...
void CKD_222_self_h2o( Matrix&           abs,
                       const Numeric     Cin,
                       const String&     model,
                       const Vector&     f_grid,
                       const Vector&     abs_p,
...
void CKD_222_foreign_h2o( Matrix&           abs,
                          const Numeric     Cin,
                          const String&     model,
                          const Vector&     f_grid,
                          const Vector&     abs_p,
...
void CKD_242_self_h2o( Matrix&           abs,
                       const Numeric     Cin,
                       const String&     model,
                       const Vector&     f_grid,
                       const Vector&     abs_p,
...
void CKD24_H20( Matrix&           abs,       // calculated abs. coeff.
                ...
                const Vector&     abs_t,     // temperature vector
                const Vector&     abs_vmr,   // H2O vmr profile
                const Vector&     n2_abs );  // N2 vmr profile

void CKD_242_foreign_h2o( Matrix&           abs,
                          const Numeric     Cin,
                          const String&     model,
                          const Vector&     f_grid,
                          const Vector&     abs_p,
...
void CKD_mt_100_foreign_h2o(// WS Output:
Matrix&           abs,
// WS Input:
const Vector&     f_grid,
const Vector&     abs_p,
...
void MPM85O2AbsModel( Matrix&           abs,        // calculated x-section
                      ...
                      const Vector&   abs_p,       // pressure vector
                      const Vector&   abs_t,       // temperature vector
                      const Vector&   h2o_abs,     // H2O vmr profile
                      const Vector&   abs_vmr );       // O2 vmr profile


void MPM87O2AbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CC,          // model parameter
                      const Numeric     CL,          // model parameter
                      const Numeric     CW,          // model parameter
                      const Numeric     CO,          // model parameter
...
void MPM89O2AbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CC,          // model parameter
                      const Numeric     CL,          // model parameter
                      const Numeric     CW,          // model parameter
                      const Numeric     CO,          // model parameter
...
void MPM92O2AbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CC,          // model parameter
                      const Numeric     CL,          // model parameter
                      const Numeric     CW,          // model parameter
                      const Numeric     CO,          // model parameter
...
void MPM93O2AbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CC,          // model parameter
                      const Numeric     CL,          // model parameter
                      const Numeric     CW,          // model parameter
                      const Numeric     CO,          // model parameter
...
void PWR93O2AbsModel( Matrix&           abs,        // calculated x-section
                      const Numeric     CC,          // model parameter
                      const Numeric     CL,          // model parameter
                      const Numeric     CW,          // model parameter
                      const Numeric     CO,          // model parameter
...
void MPM93_O2_continuum( Matrix&           abs,             // calculated x-section
...
void Rosenkranz_O2_continuum( Matrix&           abs,        // calculated x-section
                              const Numeric     S0in,        // model parameter
                              const Numeric     G0in,        // model parameter
                              const Numeric     XSOin,       // model parameter
                              const Numeric     XG0in,       // model parameter
...
void CKD_mt_CIArot_n2( MatrixView         xsec,        // calculated x-section
                       ...
                       const Vector&    abs_p,       // pressure vector
                       const Vector&    abs_t,       // temperature vector
                       const Vector&    abs_vmr );       // N2 vmr profile
...
void Rosenkranz_N2_self_continuum( Matrix&         abs,         // calculated x-section
                                   const Numeric   Cin,         // model parameter
...
void Standard_N2_self_continuum(   Matrix&         abs,         // calculated x-section
                                   const Numeric   Cin,         // model parameter
                                   const Numeric   xfin,        // model parameter
                                   const Numeric   xtin,        // model parameter
...
void CKD_241_co2( MatrixView        xsec,        // calculated x-section
                  ...
                  const Vector&     abs_p,       // pressure vector
                  const Vector&     abs_t,       // temperature vector
                  const Vector&     abs_vmr );	 // CO2 vmr profile
...
void Rosenkranz_CO2_self_continuum( Matrix&         abs,        // calculated x-section
                                    const Numeric   C,          // model parameter
                                    const Numeric   x,          // model parameter
                                    const String&   model,      // model option
                                    const Vector&   f_grid,     // frequency vector
...
void Rosenkranz_CO2_foreign_continuum( Matrix&         abs,       // calculated x-section
                                       const Numeric   C,         // model parameter
                                       const Numeric   x,         // model parameter
                                       const String&   model,     // model option
                                       const Vector&   f_grid,    // frequency vector
...
void MPM93WaterDropletAbs( Matrix&           abs,      // calculated x-section
                           const Numeric     CC,       // model parameter
                           ...
                           const Vector&     abs_p,    // pressure vector
                           const Vector&     abs_t,    // temperature vector
                           const Vector&     abs_vmr); // suspended water droplet density vector

void MPM93IceCrystalAbs( Matrix&         abs,        // calculated x-section
                         const Numeric   CC,         // model parameter
                         ...
                         const Vector&   abs_p,      // pressure vector
                         const Vector&   abs_t,      // temperature vector
                         const Vector&   abs_vmr );  // suspended ice particle density vector, 

void MPM93RainExt( Matrix&         abs,         // calculated x-section
                   const Numeric   CE,          // model parameter
                   const Numeric   CA,          // model parameter
                   const Numeric   CB,          // model parameter
                   const String&   model,       // model option
                   ...
                   const Vector&   abs_p,       // pressure vector
                   const Vector&   abs_t,       // temperature vector
                   const Vector&   abs_vmr   ); // rain rate vector, 
