...
void spectral_tramat_pathFromPath(TransmittanceMatrix&               spectral_tramat_path,
  ...
  spectral_tramat_path.init(spectral_propmat_path, spectral_propmat_jac_path, r, dr, rte_option);
}
