...
class Tensor7 : public Tensor7View {
 public:
  ...
  Matrix reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : dim0 == 2 ? nshelves() : dim0 == 3 ? nbooks() : dim0 == 4 ? npages() : dim0 == 5 ? nrows() : ncols());
    Range r1(0, dim1 == 0 ? nlibraries() : dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : dim1 == 4 ? npages() : dim1 == 5 ? nrows() : ncols());
  ...
  Tensor3 reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : dim0 == 2 ? nshelves() : dim0 == 3 ? nbooks() : dim0 == 4 ? npages() : dim0 == 5 ? nrows() : ncols());
    Range r1(0, dim1 == 0 ? nlibraries() : dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : dim1 == 4 ? npages() : dim1 == 5 ? nrows() : ncols());
    Range r2(0, dim2 == 0 ? nlibraries() : dim2 == 1 ? nvitrines() : dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : dim2 == 4 ? npages() : dim2 == 5 ? nrows() : ncols());
  ...
  Tensor4 reduce_rank() {
    ...
    Range r1(0, dim1 == 0 ? nlibraries() : dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : dim1 == 4 ? npages() : dim1 == 5 ? nrows() : ncols());
    Range r2(0, dim2 == 0 ? nlibraries() : dim2 == 1 ? nvitrines() : dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : dim2 == 4 ? npages() : dim2 == 5 ? nrows() : ncols());
    Range r3(0, dim3 == 0 ? nlibraries() : dim3 == 1 ? nvitrines() : dim3 == 2 ? nshelves() : dim3 == 3 ? nbooks() : dim3 == 4 ? npages() : dim3 == 5 ? nrows() : ncols());
  ...
  Tensor5 reduce_rank() {
    ...
    Range r2(0, dim2 == 0 ? nlibraries() : dim2 == 1 ? nvitrines() : dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : dim2 == 4 ? npages() : dim2 == 5 ? nrows() : ncols());
    Range r3(0, dim3 == 0 ? nlibraries() : dim3 == 1 ? nvitrines() : dim3 == 2 ? nshelves() : dim3 == 3 ? nbooks() : dim3 == 4 ? npages() : dim3 == 5 ? nrows() : ncols());
    Range r4(0, dim4 == 0 ? nlibraries() : dim4 == 1 ? nvitrines() : dim4 == 2 ? nshelves() : dim4 == 3 ? nbooks() : dim4 == 4 ? npages() : dim4 == 5 ? nrows() : ncols());
  ...
  Tensor6 reduce_rank() {
    ...
    Range r3(0, dim3 == 0 ? nlibraries() : dim3 == 1 ? nvitrines() : dim3 == 2 ? nshelves() : dim3 == 3 ? nbooks() : dim3 == 4 ? npages() : dim3 == 5 ? nrows() : ncols());
    Range r4(0, dim4 == 0 ? nlibraries() : dim4 == 1 ? nvitrines() : dim4 == 2 ? nshelves() : dim4 == 3 ? nbooks() : dim4 == 4 ? npages() : dim4 == 5 ? nrows() : ncols());
    Range r5(0, dim5 == 0 ? nlibraries() : dim5 == 1 ? nvitrines() : dim5 == 2 ? nshelves() : dim5 == 3 ? nbooks() : dim5 == 4 ? npages() : dim5 == 5 ? nrows() : ncols());
