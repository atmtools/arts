...
class Tensor7 : public Tensor7View {
 public:
  ...
  /*! Reduce a Tensor7 to a Vector and leave this in a bad state */
  ...
  /*! Reduce a Tensor7 to a Matrix and leave this in a bad state */
  ...
  Matrix reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : dim0 == 2 ? nshelves() : dim0 == 3 ? nbooks() : dim0 == 4 ? npages() : nrows());
    Range r1(0, dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : dim1 == 4 ? npages() : dim1 == 5 ? nrows() : ncols());
  ...
  /*! Reduce a Tensor7 to a Tensor3 and leave this in a bad state */
  ...
  Tensor3 reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : dim0 == 2 ? nshelves() : dim0 == 3 ? nbooks() : npages());
    Range r1(0, dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : dim1 == 4 ? npages() : nrows());
    Range r2(0, dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : dim2 == 4 ? npages() : dim2 == 5 ? nrows() : ncols());
  ...
  /*! Reduce a Tensor7 to a Tensor4 and leave this in a bad state */
  ...
  Tensor4 reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : dim0 == 2 ? nshelves() : nbooks());
    Range r1(0, dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : dim1 == 3 ? nbooks() : npages());
    Range r2(0, dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : dim2 == 4 ? npages() : nrows());
    Range r3(0, dim3 == 3 ? nbooks() : dim3 == 4 ? npages() : dim3 == 5 ? nrows() : ncols());
  ...
  /*! Reduce a Tensor7 to a Tensor5 and leave this in a bad state */
  ...
  Tensor5 reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : dim0 == 1 ? nvitrines() : nshelves());
    Range r1(0, dim1 == 1 ? nvitrines() : dim1 == 2 ? nshelves() : nbooks());
    Range r2(0, dim2 == 2 ? nshelves() : dim2 == 3 ? nbooks() : npages());
    Range r3(0, dim3 == 3 ? nbooks() : dim3 == 4 ? npages() : nrows());
    Range r4(0, dim4 == 4 ? npages() : dim4 == 5 ? nrows() : ncols());
  ...
  /*! Reduce a Tensor7 to a Tensor6 and leave this in a bad state */
  ...
  Tensor6 reduce_rank() {
    ...
    Range r0(0, dim0 == 0 ? nlibraries() : nvitrines());
    Range r1(0, dim1 == 1 ? nvitrines() : nshelves());
    Range r2(0, dim2 == 2 ? nshelves() : nbooks());
    Range r3(0, dim3 == 3 ? nbooks() : npages());
    Range r4(0, dim4 == 4 ? npages() : nrows());
    Range r5(0, dim5 == 5 ? nrows() : ncols());
